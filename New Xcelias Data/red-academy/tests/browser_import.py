...
with tempfile.TemporaryDirectory(prefix='red-import-browser-') as tmp:
 ...
 try:
  ...
  with sync_playwright() as playwright:
   ...
   go(page,'summaries',bs['Batch 30']);expect(page.locator('h1')).to_have_text('Session attendance checklist');check('Old batch checklist is now presented as a live attendance view','Tour Day' in page.locator('body').inner_text() and page.locator('[data-checklist]').count()==0)

  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        {(takeaways.length || sourceReferences.length) ? (
          <div className="mt-8 grid gap-4 lg:grid-cols-[minmax(0,1fr)_320px]">
            ...
            {sourceReferences.length ? (
              <div className="rounded-[28px] border border-[var(--line)] bg-[rgba(181,35,50,0.12)] p-5">
        ...
        {nextChapter ? (
          <div className="mt-8 rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(181,35,50,0.08))] p-5 md:p-6">

            ...
            <div className="border-b border-white/10 p-5 md:p-6">
              ...
              <div className="mt-5 flex flex-col gap-3 md:flex-row">
                ...
                <button
                  type="button"
                  onClick={handleCopy}
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-[var(--line)] bg-[var(--panel-strong)] px-4 py-3 text-sm font-semibold text-white transition hover:bg-[rgba(181,35,50,0.18)]"
                >

...
const TRAINING_DATA = {
  ...
  propertyTypes: {
    ...
    residential: {
      apartments: [
        {
          name: "Apartment",
          description: "Standard residential unit in a building",
        },
        {
          name: "Duplex",
          description:
            "Two floors connected by internal staircase within the same unit",
        },
        {
          name: "Penthouse",
          description:
            "Luxury apartment on the top floor with premium views and amenities",
        },
        {
        ...
        },
        {
          name: "Studio",
          description:
            "Single room apartment combining living and sleeping areas",
        },
      ],
      villas: [
        {
          name: "Stand Alone",
          description:
            "Independent villa on its own plot, not attached to other units",
        },
        { name: "One Story", description: "Single level villa/bungalow" },
        {
          name: "Town House",
          description:
            "Multi-story home sharing walls with adjacent properties in a row",
        },
        {
          name: "Twin House",
          description:
            "Two houses sharing one common wall, mirror images of each other",
        },
      ],
    },
    commercial: [
      {
        name: "Shops",
        description: "Retail spaces for selling goods",
        category: "Commercial",
      },
      {
        name: "Show Room",
        description: "Large display spaces for products like cars or furniture",
        category: "Commercial",
      },
      {
        name: "Admin",
      ...
      {
        name: "Medical",
        description: "Healthcare facilities and clinics",
        category: "Medical",
      },
      {
        name: "Pharmacy",
        description: "Pharmaceutical retail spaces",
        category: "Medical",
      },
    ],
  },
    ...
    types: [
      {
        name: "Core & Shell",
        description:
          "Basic structure only - no internal finishing, bare walls and floors",
        level: 1,
      },
      {
        name: "Semi Finished",
        description:
          "Basic finishing with plastered walls, basic flooring, electrical and plumbing in place",
        level: 2,
      },
      {
        name: "Fully Finished",
        description:
          "Complete finishing with painted walls, tiles, fixtures, ready to move in",
        level: 3,
      },
      {
        name: "Fully Furnished",
        description:
          "Fully finished plus furniture, appliances, and decor included",
        level: 4,
      },
    ],
  },
  ...
  terminology: {
    ...
    terms: [
      {
        term: "RTM",
        fullForm: "Ready To Move",
        description:
          "Property that is complete and available for immediate occupancy",
      },
      {
        term: "Off-plan",
        fullForm: "Off-plan",
        description:
          "Property sold before construction is complete, bought from plans/designs",
      },
      {
        term: "A.B.C",
        fullForm: "Acknowledgment, Benefits, Commitment",
        description: "Sales technique for qualifying clients during calls",
      },
      {
        term: "Core & Shell",
        fullForm: "Core & Shell",
        description: "Basic structure with no internal finishing",
      },
      {
        term: "ROI",
        fullForm: "Return On Investment",
        description: "The profit or loss from an investment",
      },
      {
        term: "SQM",
        fullForm: "Square Meter",
        description: "Unit of area measurement for properties",
      },
      {
        term: "BUA",
        fullForm: "Built Up Area",
        description: "Total constructed area of a property",
      },
    ],
  },
  ...
  needsVsWants: {
    ...
    wants: {
      ...
      characteristics: [
        "Not tangible",
        "Is a concept",
        "Emotional or rational motivation",
      ],
      examples: [
        "Feel safe",
        "Status symbol",
  ...
  communication: {
    ...
    breakdown: [
      { type: "Words", percentage: 7, description: "The actual words you say" },
      {
        type: "Tonality",
        percentage: 38,
        description: "How you say it - tone, pitch, pace",
      },
      {
        type: "Body Language",
        percentage: 55,
        description: "Non-verbal cues, gestures, posture",
      },
    ],
  },
  ...
  callTechniques: {
    ...
    commonMistakes: [
      {
        mistake: "Stop when you should proceed",
        correct: "Continue with confidence",
      },
      {
        mistake: "Asking wrong questions like 'Is this a good time to talk?'",
        correct: "Get straight to the value proposition",
      },
      {
        mistake: "Unclear benefits",
        correct: "State clear, specific benefits",
      },
      {
        mistake: "Length of message too long",
        correct: "Keep message concise and focused",
      },
      {
        mistake: "Talking like robots (Machine talk format)",
        correct: "Sound natural and conversational",
      },
      {
        mistake: "Lack of practice & preparation",
        correct: "Practice scripts and know your material",
      },
    ],
    rapport: {
...
const TRAINING_DATA_EG = {
  propertyTypes: {
    ...
    residential: {
      apartments: [
        ...
        {
          name: "بنتهاوس",
          description: "شقة فاخرة في آخر دور بإطلالة ومميزات أعلى",
        },
      ...
      villas: [
        {
          name: "فيلا مستقلة",
          description: "فيلا على أرض مستقلة وغير متصلة بوحدات أخرى",
        },
        { name: "دور واحد", description: "فيلا/بنجلو بمستوى واحد" },
        {
          name: "تاون هاوس",
          description: "بيت متعدد الأدوار متصل بجدار مع وحدات مجاورة",
        },
    ...
    commercial: [
      ...
      {
        name: "شو روم",
        description: "مساحة عرض كبيرة لمنتجات مثل سيارات أو أثاث",
        category: "تجاري",
      },
      ...
      {
        name: "صيدلية",
        description: "مساحة بيع أدوية ومنتجات صيدلية",
        category: "طبي",
      },
    ],
  },
  ...
  finishingTypes: {
    ...
    types: [
      {
        name: "كور أند شِل",
        description: "هيكل بس من غير تشطيب داخلي — حوائط وأرضيات على الطوب.",
        level: 1,
      },
      {
        name: "نصف تشطيب",
        description:
          "تشطيب أساسي — محارة + أرضيات بسيطة + كهرباء وسباكة جاهزين.",
        level: 2,
      },
      {
        name: "تشطيب كامل",
        description:
          "تشطيب كامل — دهانات + سيراميك/أرضيات + تركيبات — جاهز للسكن.",
        level: 3,
      },
      {
        name: "تشطيب كامل + فرش",
        description: "تشطيب كامل + فرش وأجهزة وديكور شاملين.",
        level: 4,
      },
    ],
  },
  ...
  terminology: {
    ...
    terms: [
      {
        term: "جاهز للسكن",
        fullForm: "جاهز للاستلام والسكن",
        description: "عقار مكتمل ومتجهز للسكن الفوري",
      },
      {
        term: "أوف بلان",
        fullForm: "قبل الإنشاء",
        description: "عقار بيتباع قبل اكتمال البناء اعتمادًا على مخططات وتصميم",
      },
      {
        term: "أ.ب.ج",
        fullForm: "إقرار، مميزات، التزام",
        description: "تكنيك لتأهيل العميل أثناء المكالمة",
      },
      {
        term: "كور أند شِل",
        fullForm: "هيكل فقط",
        description: "أقل مستوى تشطيب: هيكل بدون تشطيب داخلي",
      },
      {
        term: "عائد الاستثمار",
        fullForm: "عائد على الاستثمار",
        description: "الربح أو الخسارة الناتجة عن الاستثمار",
      },
      {
        term: "متر مربع",
        fullForm: "وحدة مساحة",
        description: "وحدة قياس مساحة العقار",
      },
      {
        term: "مساحة مبنية",
        fullForm: "إجمالي المساحة المبنية",
        description: "إجمالي المساحة التي تم بناؤها داخل العقار",
      },
    ],
  },
  ...
  firstImpression: {
    ...
    statistic:
      "الدراسات بتقول ممكن تحتاج ٢١ تجربة كويسة متكررة لتعويض الانطباع الأول الوحش",
    redemptionCount: 21,
  },
  ...
  communication: {
    ...
    breakdown: [
      { type: "الكلام", percentage: 7, description: "الكلمات اللي بتقولها" },
      {
        type: "نبرة الصوت",
        percentage: 38,
        description: "طريقة الكلام: نبرة، طبقة، سرعة",
      },
      {
        type: "لغة الجسد",
        percentage: 55,
        description: "إشارات غير لفظية: حركة، وضعية، تعبيرات",
      },
    ],
  },
  ...
  callTechniques: {
    ...
    commonMistakes: [
      ...
      {
        mistake: 'تسأل سؤال غلط زي "ينفع أتكلم دلوقتي؟"',
        correct: "ادخل على القيمة مباشرة",
      },
      ...
      {
        mistake: "قلة تدريب وتحضير",
        correct: "اتدرّب على السكريبت واعرف المادة كويس",
      },
    ],
    rapport: {
...
const getTrainingData = (lang) =>
  lang === "eg" ? TRAINING_DATA_EG : TRAINING_DATA;
...
const UI_STRINGS = {
  en: {
    appTitle: "Xcelias",
    appSubtitle:
      "A premium real estate training game with 35+ interactive drills",
...
const EG_EXACT_MAP = {
  ...
  "Basic structure only - no internal finishing, bare walls and floors":
    "هيكل بس من غير تشطيب داخلي — حوائط وأرضيات على الطوب.",
  "Basic finishing with plastered walls, basic flooring, electrical and plumbing in place":
    "تشطيب أساسي — محارة + أرضيات بسيطة + كهرباء وسباكة جاهزين.",
  "Complete finishing with painted walls, tiles, fixtures, ready to move in":
    "تشطيب كامل — دهانات + سيراميك/أرضيات + تركيبات — جاهز للسكن.",
  "Fully finished plus furniture, appliances, and decor included":
    "تشطيب كامل + فرش وأجهزة وديكور شاملين.",
};
...
const EG_SENTENCE_MAP = {
  ...
  "Most resales are RTM (Ready To Move), not Off-plan. Off-plan properties are typically primary sales from developers.":
    "معظم الريسيل بيكون جاهز للسكن، مش أوف بلان. الأوف بلان غالبًا بيكون برايمري من الديفيلوبر.",
  "Most primary properties are Off-plan.": "معظم البرايمري بيكون أوف بلان.",
  "Correct! Most primary properties are Off-plan, meaning they are sold before construction is complete.":
    "صح! معظم البرايمري أوف بلان يعني بيتباع قبل ما البناء يخلص.",
  "Brokers have more walk out than developers.":
    "البروكر عنده نسبة انسحاب أكتر من المطوّر.",
  "Developers have more walk out. Brokers have less walk out because they offer consultancy and diverse projects.":
    "المطوّر عنده نسبة انسحاب أعلى. البروكر أقل عشان بيقدّم استشارة وشغله على مشاريع متنوعة.",
  "A Duplex has two floors connected by an internal staircase.":
    "الدوبلكس دورين متصلين بسلم داخلي.",
  "Correct! A Duplex is a unit with two floors connected by an internal staircase.":
    "صح! الدوبلكس وحدة بدورين متصلين بسلم داخلي.",
  "You should have more than 7 points of interest on your body.":
    "ينفع يبقى عندك أكتر من ٧ نقاط لافتة في لبسك/شكلِك.",
  "You shouldn't have more than 7 points of interest. More than seven points could be too overwhelming for the eyes.":
    "المفروض مايزيدوش عن ٧ نقاط. أكتر من كده بيبقى مُشتّت للعين.",
  "It takes 21 good experiences to make up for a bad first impression.":
    "بيحتاج ٢١ تجربة كويسة عشان تعوّض انطباع أول وحش.",
  "Correct! Studies show it can take 21 repeated good experiences to make up for a bad first impression.":
    "صح! الدراسات بتقول ممكن تحتاج ٢١ تجربة كويسة متكررة لتعويض الانطباع الأول الوحش.",
  "Words account for 55% of communication retention.":
    "الكلام مسؤول عن ٥٥٪ من تأثير التواصل.",
  "Words account for only 7%. Body Language accounts for 55% of communication retention.":
    "الكلام بس حوالي ٧٪. لغة الجسد حوالي ٥٥٪ من تأثير التواصل.",
  "Tonality accounts for 38% of communication retention.":
    "نبرة الصوت مسؤولة عن ٣٨٪ من تأثير التواصل.",
  "Correct! Tonality accounts for 38% of how communication is retained.":
    "صح! نبرة الصوت حوالي ٣٨٪ من تأثير التواصل.",
  "A.B.C stands for Always Be Closing.":
    "تقنية أ.ب.ج معناها: دايمًا اقفل البيع.",
  "A.B.C stands for Acknowledgment, Benefits, Commitment - a technique for qualifying clients during calls.":
    "أ.ب.ج معناها: إقرار، مميزات، التزام — تكنيك لتأهيل العميل أثناء المكالمة.",
  "Core & Shell means the property is fully furnished.":
    "كور أند شِل يعني الوحدة مفروشة بالكامل.",
  "Core & Shell is the most basic finishing - only the structure with no internal finishing, bare walls and floors.":
    "كور أند شِل أقل مستوى تشطيب — هيكل بس من غير تشطيب داخلي.",
  "Brokers work on diverse projects.": "البروكر بيشتغل على مشاريع متنوعة.",
  "Correct! Brokers work on diverse projects while developers work only on their own projects.":
    "صح! البروكر شغله على مشاريع متنوعة، إنما الديفيلوبر على مشاريعه بس.",
  "Resale properties are typically bought with installments.":
    "الريسيل عادة بيتشترى بالتقسيط.",
  "Resale properties typically require cash payment. Primary/developer properties offer installment options.":
    "الريسيل غالبًا كاش. البرايمري/الديفيلوبر بيكون فيه اختيارات تقسيط.",
  "A Penthouse is located on the ground floor.":
    "البنتهاوس بيكون في الدور الأرضي.",
  "A Penthouse is a luxury apartment on the TOP floor with premium views and amenities.":
    "البنتهاوس شقة فاخرة في آخر دور (فوق) بإطلالة ومميزات أعلى.",
  "Building rapport means changing yourself completely.":
    "بناء الألفة يعني تغيّر نفسك بالكامل.",
  "It's not about changing yourself, it's about ADAPTING yourself & your style to be like the other person.":
    "الموضوع مش إنك تغيّر نفسك؛ الموضوع إنك تتأقلم في ستايلك عشان يبقى قريب من الشخص اللي قدامك.",
  "Needs are tangible requirements that clients ask for.":
    "الاحتياجات هي حاجات ملموسة العميل بيطلبها.",
  "Correct! Needs are everything that clients say or ask for - tangible, specific, measurable requirements.":
    "صح! الاحتياجات هي كل اللي العميل بيقوله/بيطلبه: حاجات ملموسة ومحددة وقابلة للقياس.",

  // Market Awareness Check
  "Who has MORE awareness with the market?": "مين وعيه بالسوق أعلى؟",
  "Brokers have more market awareness because they work across diverse projects and the entire market.":
    "البروكر وعيه بالسوق أعلى عشان شغله على مشاريع كتير ومن كذا ديفيلوبر.",
  "Who experiences MORE walk out?": "مين عنده نسبة انسحاب أكتر؟",
  "Developer sales teams experience more walk out compared to brokers.":
    "تيم مبيعات المطوّر بيواجه انسحاب أكتر مقارنة بالبروكر.",
  "Who works on DIVERSE projects?": "مين بيشتغل على مشاريع متنوعة؟",
  "Brokers work on diverse projects from multiple developers.":
    "البروكر بيشتغل على مشاريع متنوعة من أكتر من ديفيلوبر.",
  "Who provides CONSULTANCY services?": "مين بيقدّم استشارة؟",
  "Brokers provide consultancy services, while developers focus on sales.":
    "البروكر دوره استشاري، إنما الديفيلوبر مركز على البيع.",
  "Who calls with regards to OPPORTUNITY?": "مين بيتصل بخصوص فرصة؟",
  "Brokers call about opportunities since they represent multiple projects.":
    "البروكر بيتصل بخصوص فرص لأنه بيمثّل مشاريع كتير.",
  "Who calls with regards to TYPE?": "مين بيتصل بخصوص نوع الوحدة؟",
  "Developers call about specific unit types available in their projects.":
    "الديفيلوبر بيتصل بخصوص أنواع وحدات محددة موجودة في مشاريعه.",
};
...
const egTranslateText = (text, kind) => {
  ...
  if (m1)
    return `أنهي نوع تشطيب الوصف بتاعه: "${egTranslateText(m1[1], "desc")}"؟`;

  const m2 = s.match(/^What does "([\s\S]+)" stand for\?$/);
  if (m2) return `اختصار "${m2[1]}" معناه إيه؟`;

  const m3 = s.match(
    /^Which unit type matches this description: "([\s\S]+)"\?$/,
  );
  if (m3)
    return `أنهي نوع وحدة ينطبق عليه الوصف ده: "${egTranslateText(m3[1], "desc")}"؟`;

  const m4 = s.match(/^A (.+) is: ([\s\S]+)$/);
  if (m4)
    return `يعني إيه ${egTranslateTerm(m4[1])}؟ — ${egTranslateText(m4[2], "desc")}`;

  const m5 = s.match(/^(.+) stands for "(.+)" - ([\s\S]+)$/);
  if (m5)
    return `${m5[1]} اختصار لـ "${m5[2]}" — ${egTranslateText(m5[3], "desc")}`;
...
const styles = {
  ...
  header: {
    ...
    padding: "18px 22px",
    background:
      "linear-gradient(135deg, rgba(20,20,35,0.92), rgba(18,18,30,0.88))",
    borderRadius: "18px",
    marginBottom: "30px",
  ...
  card: {
    background:
      "linear-gradient(180deg, rgba(22,22,38,0.94), rgba(18,18,32,0.90))",
    borderRadius: "22px",
    padding: "30px",
    border: `1px solid ${RM_THEME.border}`,
    marginBottom: "20px",
  ...
  optionBtn: {
    ...
    cursor: "pointer",
    transition:
      "transform 0.18s cubic-bezier(0.34,1.56,0.64,1), border-color 0.2s ease, box-shadow 0.2s ease",
    textAlign: "left",
    width: "100%",
    marginBottom: "12px",
    boxShadow:
  ...
  correctBtn: {
    background:
      "linear-gradient(145deg, rgba(16,185,129,0.22), rgba(5,150,105,0.15))",
    borderColor: "#10b981",
    color: "#6ee7b7",
  ...
  incorrectBtn: {
    background:
      "linear-gradient(145deg, rgba(239,68,68,0.22), rgba(185,28,28,0.15))",
    borderColor: "#ef4444",
    color: "#fca5a5",
...
const BackgroundFX = () => {
  const { fxIntensity, reduceMotion, backgroundEnabled, projectorMode } =
    useUI();
  ...
  useEffect(() => {
    ...
    const seed = () => {
      ...
      const count = Math.min(
        24,
        Math.max(6, Math.floor(base * clamp(fxIntensity, 0.6, 1.5))),
      );
      const pts = [];
      for (let i = 0; i < count; i++) {
        pts.push({
...
const getRedRank = (score) => {
  ...
  return (
    [...RED_RANKS].reverse().find((rank) => normalizedScore >= rank.minScore) ||
    RED_RANKS[0]
  );
};
...
const getHeatState = (streak) => {
  ...
  if (normalizedStreak >= 10)
    return { en: "Overdrive", eg: "أوفر درايف", accent: RM_THEME.red };
  if (normalizedStreak >= 6)
    return { en: "Hot", eg: "سخن", accent: RM_THEME.amber };
  if (normalizedStreak >= 3)
    return { en: "Warm", eg: "مُسخّن", accent: RM_THEME.green };
...
const formatUnlockText = (lang, rule) => {
  ...
  if (rule.minScore)
    chunks.push(
      lang === "eg" ? `${rule.minScore}+ نقطة` : `${rule.minScore}+ score`,
    );
  if (rule.minPlayedActivities)
    chunks.push(
      lang === "eg"
        ? `${rule.minPlayedActivities}+ أنشطة متجربة`
        : `${rule.minPlayedActivities}+ activities played`,
    );
  if (rule.minMasteredActivities)
    chunks.push(
      lang === "eg"
        ? `${rule.minMasteredActivities}+ أنشطة متقنة`
        : `${rule.minMasteredActivities}+ mastered activities`,
    );
  return chunks.join(lang === "eg" ? " • " : " • ");
};

const getActivityUnlockState = (
  activityId,
  academyStats,
  globalScore,
  lang,
  ...
  const scoreRatio = rule.minScore
    ? Math.min(1, globalScore / rule.minScore)
    : 1;
  const playedRatio = rule.minPlayedActivities
    ? Math.min(
        1,
        (academyStats.playedActivities || 0) / rule.minPlayedActivities,
      )
    : 1;
  const masteredRatio = rule.minMasteredActivities
    ? Math.min(
        1,
        (academyStats.masteredActivities || 0) / rule.minMasteredActivities,
      )
    : 1;
  const unlocked =
  ...
  return {
    ...
    completionRatio: Math.round(
      ((scoreRatio + playedRatio + masteredRatio) / 3) * 100,
    ),
  };
};
  ...
  const progressToNextRank = nextRank
    ? Math.max(
        ...
        Math.min(
          100,
          Math.round(
            ((globalScore - rank.minScore) /
              Math.max(1, nextRank.minScore - rank.minScore)) *
              100,
          ),
        ),
      )
    ...
    >
      <div
        style={{
          display: "grid",
          gridTemplateColumns:
            "minmax(260px, 1.35fr) repeat(auto-fit, minmax(150px, 0.85fr))",
          gap: 12,
          alignItems: "stretch",
        }}
      >
        ...
        >
          ...
          >
            <span style={{ ...styles.badge, ...styles.badgeBlue }}>
              {lang === "eg" ? "رتبة Xcelias" : "Xcelias Rank"}
            </span>
            <span style={{ color: rank.accent, fontWeight: 900, fontSize: 13 }}>
              {lang === "eg" ? rank.eg : rank.en}
            </span>
          </div>
          <div style={{ fontSize: 24, fontWeight: 900, marginBottom: 6 }}>
            {currentActivity
              ? lang === "eg"
                ? `دلوقتي: ${currentActivity.name}`
                : `Now Playing: ${currentActivity.name}`
              : lang === "eg"
                ? "غرفة تشغيل Xcelias"
                : "Xcelias Command Run"}
          </div>
          ...
          <div style={{ ...styles.progressBar, marginBottom: 8 }}>
            <div
              style={{
                ...
                background: `linear-gradient(90deg, ${rank.accent}, rgba(255,255,255,0.7))`,
              }}
            />
          </div>
        ...
        <div style={styles.scoreItem}>
          ...
          <span
            style={{ ...styles.scoreValue, color: heat.accent, fontSize: 24 }}
          >
            {lang === "eg" ? heat.eg : heat.en}
          </span>
          <span style={{ color: RM_THEME.faint, fontSize: 12, marginTop: 4 }}>
            {lang === "eg" ? `${globalStreak} ستريك` : `${globalStreak} streak`}
          </span>
        </div>

        <div style={styles.scoreItem}>
          <span style={styles.scoreLabel}>
            {lang === "eg" ? "المتقن" : "Mastered"}
          </span>
          <span style={styles.scoreValue}>
            {academyStats.masteredActivities}
          </span>
          <span style={{ color: RM_THEME.faint, fontSize: 12, marginTop: 4 }}>
            {lang === "eg"
              ? `من ${academyStats.playedActivities} متجرب`
              : `${academyStats.playedActivities} played`}
          </span>
        </div>

        <div style={styles.scoreItem}>
          <span style={styles.scoreLabel}>
            {lang === "eg" ? "ضغط المراجعة" : "Review Pressure"}
          </span>
          <span
            style={{
              ...styles.scoreValue,
              color:
                academyStats.reviewCount > 0 ? RM_THEME.red : RM_THEME.green,
            }}
          >
            {academyStats.reviewCount}
          </span>
          <span style={{ color: RM_THEME.faint, fontSize: 12, marginTop: 4 }}>
            {lang === "eg" ? "مسارات محتاجة رجوع" : "lanes need attention"}
          </span>
        </div>
      </div>
    </div>
        ...
        <div>
          ...
          >
            <span style={{ ...styles.badge, ...styles.badgeRed }}>
              {lang === "eg" ? "ترقية جديدة" : "Promotion Unlocked"}
            </span>
            <span style={{ color: rank.accent, fontWeight: 900 }}>
              {lang === "eg" ? rank.eg : rank.en}
            </span>
          </div>
          ...
          <div style={{ color: RM_THEME.muted, lineHeight: 1.55 }}>
            {nextRank
              ...
              : lang === "eg"
                ? "أعلى رتبة في Xcelias اتفتحت."
                : "You have unlocked the top Xcelias rank."}
          </div>
        </div>
        <button onClick={onClose} style={styles.secondaryBtn}>
          {lang === "eg" ? "إقفال" : "Dismiss"}
        </button>
      </div>
    </div>
  );
  ...
  return (
    <div
      style={{
        ...
        border: `1px solid ${RM_THEME.border}`,
        background:
          "linear-gradient(135deg, rgba(0,212,255,0.14), rgba(255,59,59,0.10))",
        boxShadow: "0 18px 50px rgba(0,0,0,0.28)",
      }}
      className="animate-bounceIn"
    >
      ...
      >
        <div>
          ...
          >
            <span style={{ ...styles.badge, ...styles.badgeBlue }}>
              {lang === "eg" ? "مود جديد" : "New Mode Unlocked"}
            </span>
            <span style={{ ...styles.badge, ...styles.badgeGreen }}>
              {unlockNotice.modeLabel}
            </span>
          </div>
          <div style={{ fontSize: 22, fontWeight: 900, marginBottom: 6 }}>
            {unlockNotice.name}
          ...
          <div style={{ color: RM_THEME.muted, lineHeight: 1.55 }}>
            {unlockNotice.requirementText}
          </div>
        </div>
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          <button onClick={onLaunch} style={styles.primaryBtn}>
            {lang === "eg" ? "افتحه" : "Launch It"}
          </button>
          <button onClick={onClose} style={styles.secondaryBtn}>
            {lang === "eg" ? "لاحقًا" : "Later"}
          </button>
        </div>
      </div>
    </div>
  ...
  return (
    <div
      style={{
        ...
        border: `1px solid ${RM_THEME.border}`,
        background:
          "linear-gradient(135deg, rgba(34,197,94,0.14), rgba(255,176,32,0.12))",
        boxShadow: "0 18px 50px rgba(0,0,0,0.28)",
      }}
      className="animate-bounceIn"
    >
      ...
      >
        <div>
          ...
          >
            <span style={{ ...styles.badge, ...styles.badgeGreen }}>
              {lang === "eg" ? "مكافأة Xcelias Ops" : "Xcelias Ops Reward"}
            </span>
            <span style={{ color: RM_THEME.amber, fontWeight: 900 }}>
              +{rewardNotice.points}
            </span>
          </div>
          <div style={{ fontSize: 22, fontWeight: 900, marginBottom: 6 }}>
          ...
          <div style={{ color: RM_THEME.muted, lineHeight: 1.55 }}>
            {lang === "eg"
              ? `أضفنا ${rewardNotice.points} نقطة للران الحالي.`
              : `${rewardNotice.points} points were added to your run.`}
          </div>
        </div>
        <button onClick={onClose} style={styles.secondaryBtn}>
          {lang === "eg" ? "تمام" : "Nice"}
...
const Feedback = ({ isCorrect, message, explanation }) => {
  ...
  return (
    <div
      className={`game-feedback ${isCorrect ? "game-feedback--correct" : "game-feedback--incorrect"}`}
    >
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            <div
              style={{
                ...
                height: 38,
                borderRadius: 12,
                background: `linear-gradient(135deg, ${RM_THEME.cyan}, ${RM_THEME.violet})`,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                fontWeight: 900,
        ...
        >
          ...
          >
            ...
            <div style={{ display: "grid", gap: 10, marginTop: 12 }}>
              ...
              <div
                style={{ color: RM_THEME.muted, fontSize: 13, lineHeight: 1.6 }}
              >
                {tone === "eg"
          ...
          >
            ...
            <div style={{ marginTop: 12 }}>
              ...
              >
                <span>Chill</span>
                <strong style={{ color: RM_THEME.text }}>
                  {fxIntensity.toFixed(2)}x
                </strong>
                <span>Insane</span>
              </div>
          ...
          >
            ...
            <div
              style={{
                marginTop: 14,
                paddingTop: 14,
                borderTop: `1px solid ${RM_THEME.border}`,
                display: "flex",
                alignItems: "center",
                justifyContent: "space-between",
                gap: 10,
            ...
            >
              <div>
                ...
                <div
                  style={{ color: RM_THEME.muted, fontSize: 12, marginTop: 4 }}
                >
                  {s.projectorHint}
                </div>
              </div>
              <button
                ...
                style={{
                  ...
                  padding: "10px 12px",
                  borderRadius: 12,
                  borderColor: projectorMode
                    ? "rgba(0,212,255,0.55)"
                    : RM_THEME.border,
                  background: projectorMode
                    ? "rgba(0,212,255,0.10)"
                    : "rgba(255,255,255,0.06)",
                }}
              >
...
const RapidFireMCQ = ({ onBack, updateScore }) => {
    ...
    TD.finishingTypes.types.forEach((type) => {
      ...
      allQuestions.push({
        ...
        options: shuffleArray([
          type.name,
          ...getRandomItems([...wrongAnswers, ...extraWrong], 3),
        ]),
        explanation:
          lang === "eg"
  ...
  if (questions.length === 0)
    return <div>{lang === "eg" ? "جاري التحميل…" : "Loading..."}</div>;
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      <h2 style={styles.questionText}>
        {toneifyText(lang, q.question, "question")}
      </h2>
          ...
          {currentQ < questions.length - 1 ? (
            ...
            <div style={{ textAlign: "center", marginTop: "30px" }}>
              <h3 style={{ fontSize: "24px", marginBottom: "10px" }}>
                {lang === "eg" ? "🎉 خلّصت النشاط!" : "🎉 Activity Complete!"}
              </h3>
              <p>
                {lang === "eg" ? "النتيجة النهائية:" : "Final Score:"}{" "}
...
const TrueFalseSpeedRun = ({ onBack, updateScore }) => {
  ...
  useEffect(() => {
    const tfQuestions = [
      {
        statement: "Most resales are Off-plan.",
        answer: false,
        explanation:
          "Most resales are RTM (Ready To Move), not Off-plan. Off-plan properties are typically primary sales from developers.",
      },
      {
        statement: "Most primary properties are Off-plan.",
        answer: true,
        explanation:
          "Correct! Most primary properties are Off-plan, meaning they are sold before construction is complete.",
      },
      {
        statement: "Brokers have more walk out than developers.",
        answer: false,
        explanation:
          "Developers have more walk out. Brokers have less walk out because they offer consultancy and diverse projects.",
      },
      ...
      {
        statement: "Words account for 55% of communication retention.",
        answer: false,
        explanation:
          "Words account for only 7%. Body Language accounts for 55% of communication retention.",
      },
      {
        statement: "Tonality accounts for 38% of communication retention.",
        answer: true,
        explanation:
          "Correct! Tonality accounts for 38% of how communication is retained.",
      },
      {
        statement: "A.B.C stands for Always Be Closing.",
        answer: false,
        explanation:
          "A.B.C stands for Acknowledgment, Benefits, Commitment - a technique for qualifying clients during calls.",
      },
      {
        statement: "Core & Shell means the property is fully furnished.",
        answer: false,
        explanation:
          "Core & Shell is the most basic finishing - only the structure with no internal finishing, bare walls and floors.",
      },
      {
        statement: "Brokers work on diverse projects.",
        answer: true,
        explanation:
          "Correct! Brokers work on diverse projects while developers work only on their own projects.",
      },
      {
        statement: "Resale properties are typically bought with installments.",
        answer: false,
        explanation:
          "Resale properties typically require cash payment. Primary/developer properties offer installment options.",
      },
      {
        statement: "A Penthouse is located on the ground floor.",
        answer: false,
        explanation:
          "A Penthouse is a luxury apartment on the TOP floor with premium views and amenities.",
      },
      {
        statement: "Building rapport means changing yourself completely.",
        answer: false,
        explanation:
          "It's not about changing yourself, it's about ADAPTING yourself & your style to be like the other person.",
      },
      {
        statement: "Needs are tangible requirements that clients ask for.",
        answer: true,
        explanation:
          "Correct! Needs are everything that clients say or ask for - tangible, specific, measurable requirements.",
      },
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      <h2 style={styles.questionText}>
        {toneifyText(lang, q.statement, "question")}
      </h2>
        ...
        <>
          ...
          {currentQ < questions.length - 1 ? (
            ...
            <div style={{ textAlign: "center", marginTop: "30px" }}>
              <h3>
                {lang === "eg" ? "🎉 خلّصت النشاط!" : "🎉 Activity Complete!"}{" "}
                {lang === "eg" ? "السكور:" : "Score:"} {localScore}/
                {questions.length * 10}
              </h3>
              <button
                onClick={onBack}
...
const DefinitionMatching = ({ onBack, updateScore }) => {
  ...
  useEffect(() => {
    const allItems = [
      ...TD.propertyTypes.residential.apartments.map((u) => ({
        term: u.name,
        definition: u.description,
      })),
      ...TD.finishingTypes.types.map((f) => ({
        term: f.name,
  ...
  const shuffledDefinitions = useMemo(
    () => shuffleArray(items.map((i) => i.definition)),
    [items],
  );
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        <span style={{ ...styles.badge, ...styles.badgeBlue }}>
          {s.activityNames.matching}
        </span>
        <div style={styles.scoreItem}>
          <span style={styles.scoreLabel}>
            {lang === "eg" ? "اتطابق" : "Matched"}
          </span>
          <span style={styles.scoreValue}>
      ...
      <p style={{ marginBottom: "20px", color: "rgba(255,255,255,0.7)" }}>
        {lang === "eg"
          ? "اختار المصطلح… وبعدها اختار التعريف الصح."
      ...
      <div style={styles.grid2}>
        ...
        <div>
          <h4 style={{ marginBottom: "15px", color: "#4299e1" }}>
            {lang === "eg" ? "تعريفات" : "Definitions"}
          </h4>
      ...
      {showResults && (
        <div style={{ marginTop: "20px", textAlign: "center" }}>
          <h3 style={{ fontSize: "24px", marginBottom: "10px" }}>
            {lang === "eg" ? "النتيجة:" : "Score:"} {localScore}/
            {items.length * 15} (
            {Math.round((localScore / (items.length * 15)) * 100)}%)
          </h3>
          <button
            onClick={resetGame}
            style={{ ...styles.primaryBtn, marginRight: "10px" }}
          >
            {lang === "eg" ? "جرّب تاني" : "Try Again"}
          </button>
  ...
  useEffect(() => {
    const oddQuestions = [
      ...
      },
      {
        ...
        oddOne: "Admin",
        explanation:
          "Admin is a commercial property type, not a residential apartment.",
      },
      {
        ...
        explanation:
          "Service Apartment is an apartment type, not a villa type.",
      },
      {
      ...
      },
      {
        ...
        explanation:
          "Mirroring tone is a GOOD technique for building rapport, not a mistake.",
      },
      {
        ...
        explanation:
          "Working on their own projects is a Developer characteristic, not Broker.",
      },
      {
        ...
        explanation:
          "Cash payment only is typical of Resale, not Primary sales.",
      },
    ];

    const formattedQuestions = shuffleArray(oddQuestions)
      .slice(0, 8)
      .map((q) => ({
        ...q,
      ...
      {showFeedback && (
        <>
          ...
          {currentQ < questions.length - 1 ? (
            ...
            <div style={{ textAlign: "center", marginTop: "30px" }}>
              <h3>
                🎉 Activity Complete! Score: {localScore}/
                {questions.length * 15}
              </h3>
              <button
                onClick={onBack}
...
const FillInBlanks = ({ onBack, updateScore }) => {
  ...
  useEffect(() => {
    const blankQuestions = [
      {
        sentence:
          "_____ are everything that clients say or ask for - tangible requirements.",
        answer: "Needs",
        options: ["Needs", "Wants", "Motives", "Benefits"],
      },
      {
        sentence:
          "_____ are the reasons behind client requests - can be emotional or rational.",
        answer: "Wants",
        options: ["Wants", "Needs", "Skills", "Features"],
      },
      {
        sentence:
          "The A.B.C technique stands for Acknowledgment, _____, Commitment.",
        answer: "Benefits",
        options: ["Benefits", "Business", "Building", "Buying"],
      },
      {
        sentence:
          "You shouldn't have more than _____ points of interest on your body.",
        answer: "7",
        options: ["7", "5", "10", "3"],
      },
      {
        sentence:
          "It takes _____ repeated good experiences to make up for a bad first impression.",
        answer: "21",
        options: ["21", "10", "15", "30"],
      },
      {
        sentence:
          "Body Language accounts for _____% of how communication is retained.",
        answer: "55",
        options: ["55", "38", "7", "45"],
      },
      {
      ...
      {
        sentence:
          "_____ properties are typically bought with cash payment from clients.",
        answer: "Resale",
    ...
    setQuestions(
      shuffleArray(blankQuestions).map((q) => ({
        ...q,
...
const AcronymDecoder = ({ onBack, updateScore }) => {
  ...
  useEffect(() => {
    const acronymQuestions = [
      ...
      {
        acronym: "A.B.C",
        answer: "Acknowledgment, Benefits, Commitment",
        options: [
          "Acknowledgment, Benefits, Commitment",
          "Always Be Closing",
          "Attractive Building Complex",
          "Active Buyer Connection",
        ],
      },
      {
        acronym: "BUA",
        ...
        options: [
          "Built Up Area",
          "Building Usage Area",
          "Buyer Unit Assessment",
          "Basic Unit Allocation",
        ],
      },
      {
        acronym: "SQM",
    ...
    setQuestions(
      shuffleArray(acronymQuestions).map((q) => ({
        ...q,
        options: shuffleArray(q.options),
      })),
    );
...
const HierarchySorter = ({ onBack, updateScore }) => {
  ...
  const challenges = [
    {
      ...
      explanation:
        "Core & Shell is the most basic (just structure), then Semi Finished (basic finishing), Fully Finished (ready to move in), and Fully Furnished (includes furniture).",
    },
    {
      ...
      explanation:
        "Words account for 7%, Tonality for 38%, and Body Language for 55% of communication retention.",
    },
  ];
  ...
  const checkAnswer = () => {
    const isCorrect =
      ...
      JSON.stringify(challenges[currentChallenge].correctOrder);
    if (isCorrect) {
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      <p style={{ color: "rgba(255,255,255,0.6)", marginBottom: "20px" }}>
        Use arrows to reorder the items
      </p>
        ...
        {userOrder.map((item, idx) => (
          <div
            ...
            style={{
              ...
              borderRadius: "10px",
              border: showFeedback
                ? challenge.correctOrder[idx] === item
                  ? "2px solid #48bb78"
                  : "2px solid #f56565"
          ...
          >
            <span
              style={{ fontSize: "18px", fontWeight: "600", minWidth: "30px" }}
            >
              {idx + 1}.
            </span>
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...styles.secondaryBtn,
                    padding: "5px 10px",
                    opacity: idx === userOrder.length - 1 ? 0.3 : 1,
                  }}
                >
                  ↓
                </button>
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        ...
        <p style={{ marginTop: "15px", color: "rgba(255,255,255,0.6)" }}>
          ...
          <strong style={{ color: "#fff" }}>
            {lang === "eg"
              ? `${scenario.count} إكسسوارات`
              : `${scenario.count} accessories`}
          </strong>
        </p>
      </div>
      ...
      <p style={styles.questionText}>
        {lang === "eg"
          ? "اللبس ده مطابق للقاعدة ولا لا؟"
          : "Does this outfit PASS or FAIL the dress code?"}
      </p>
      ...
      {showFeedback && (
        <>
          <Feedback
            isCorrect={selected === scenario.shouldPass}
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        ...
        <p style={{ fontSize: "20px", marginTop: "15px", lineHeight: "1.6" }}>
          "{toneifyText(lang, q.description, "body")}"
        </p>
      </div>

      <h3 style={{ marginBottom: "20px" }}>
        {lang === "eg" ? "ده أنهي نوع وحدة؟" : "What type of unit is this?"}
      </h3>
...
const FinishingVisualizer = ({ onBack, updateScore }) => {
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      <h3 style={{ marginBottom: "20px" }}>
        Match this to the correct finishing type:
      </h3>
      ...
      <div style={styles.grid2}>
        {allOptions.map((option, idx) => (
          <button
            key={idx}
            onClick={() => handleAnswer(option)}
            className={optionClass(idx, selected, q.name, showFeedback, option)}
            style={{ textAlign: "center", padding: "20px" }}
          >
            {option}
          </button>
...
const SortingHat = ({ onBack, updateScore }) => {
  ...
  useEffect(() => {
    const sortingQuestions = [
      {
        statement: "Working on diverse projects",
        answer: "Broker",
        explanation:
          "Brokers work on diverse projects across multiple developers.",
      },
      {
        statement: "Less walk out",
        answer: "Broker",
        explanation:
          "Brokers have less walk out because they provide consultancy services.",
      },
      {
        statement: "More awareness with the market",
        answer: "Broker",
        explanation:
          "Brokers have more market awareness due to working across the industry.",
      },
      {
        statement: "Calling with regards to opportunity",
        answer: "Broker",
        explanation:
          "Brokers call about opportunities since they represent multiple projects.",
      },
      {
        statement: "Working on their projects",
        answer: "Developer",
        explanation: "Developers work exclusively on their own projects.",
      },
      {
        statement: "More walk out",
        answer: "Developer",
        explanation: "Developer sales teams have more walk out.",
      },
      {
        statement: "Less awareness with the market",
        answer: "Developer",
        explanation:
          "Developers focus on their own projects, so have less overall market awareness.",
      },
      {
        statement: "Calling with regards to type",
        answer: "Developer",
        explanation:
          "Developers call about specific unit types in their projects.",
      },
      {
        statement: "Consultancy role",
        answer: "Broker",
        explanation: "Brokers provide consultancy services to clients.",
      },
      {
        statement: "Sales role",
        answer: "Developer",
        explanation: "Developer teams have a direct sales role.",
      },
    ];
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        {lang === "eg"
          ? "اختار السايد الصح بسرعة!"
          : "Swipe this characteristic to the correct side!"}
      </p>
...
const ProConMatrix = ({ onBack, updateScore }) => {
  ...
  useEffect(() => {
    const matrixQuestions = [
      {
        feature: "Cash payment required",
        answer: "Resale",
        explanation:
          "Resale properties typically require cash payment since you're buying from another client.",
      },
      {
        feature: "Installment options available",
        answer: "Primary",
        explanation:
          "Primary sales from developers typically offer installment payment plans.",
      },
      {
        feature: "Most properties are RTM (Ready To Move)",
        answer: "Resale",
        explanation:
          "Most resale properties are RTM - they're already completed and ready for occupancy.",
      },
      {
        feature: "Most properties are Off-plan",
        answer: "Primary",
        explanation:
          "Most primary properties are Off-plan - sold before construction is complete.",
      },
      {
        feature: "Buy from client",
        answer: "Resale",
        explanation:
          "Resale means buying from another client/owner, not directly from developer.",
      },
      {
        feature: "Buy from developer",
        answer: "Primary",
        explanation:
          "Primary sales are purchases made directly from the developer.",
      },
      {
        feature: "Property already constructed",
        answer: "Resale",
        explanation:
          "Resale properties are typically already built since they were previously owned.",
      },
      {
        feature: "Can customize before completion",
        answer: "Primary",
        explanation:
          "Off-plan primary purchases may allow customization during construction.",
      },
    ];
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      <p style={{ textAlign: "center", marginBottom: "20px" }}>
        Is this typical of PRIMARY or RESALE?
      </p>
      ...
      {showFeedback && (
        <>
          ...
          {currentQ < questions.length - 1 ? (
            ...
            <div style={{ textAlign: "center", marginTop: "30px" }}>
              <h3>
                🎉 Score: {localScore}/{questions.length * 12}
              </h3>
              <button
                onClick={onBack}
                style={{ ...styles.primaryBtn, marginTop: "20px" }}
...
const MarketAwarenessCheck = ({ onBack, updateScore }) => {
  ...
  useEffect(() => {
    const awarenessQuestions = [
      {
        question: "Who has MORE awareness with the market?",
        answer: "Broker",
        explanation:
          "Brokers have more market awareness because they work across diverse projects and the entire market.",
      },
      {
        question: "Who experiences MORE walk out?",
        answer: "Developer",
        explanation:
          "Developer sales teams experience more walk out compared to brokers.",
      },
      {
        question: "Who works on DIVERSE projects?",
        answer: "Broker",
        explanation:
          "Brokers work on diverse projects from multiple developers.",
      },
      {
        question: "Who provides CONSULTANCY services?",
        answer: "Broker",
        explanation:
          "Brokers provide consultancy services, while developers focus on sales.",
      },
      {
        question: "Who calls with regards to OPPORTUNITY?",
        answer: "Broker",
        explanation:
          "Brokers call about opportunities since they represent multiple projects.",
      },
      {
        question: "Who calls with regards to TYPE?",
        answer: "Developer",
        explanation:
          "Developers call about specific unit types available in their projects.",
      },
    ...
    <div style={styles.card} className="animate-fadeIn">
      ...
      <div style={styles.grid2}>
        ...
        >
          <span style={{ fontSize: "50px" }}>👔</span>
          <div
            style={{ marginTop: "15px", fontSize: "20px", fontWeight: "700" }}
          >
            {lang === "eg" ? "بروكر" : "BROKER"}
          </div>
        </button>
...
const MotiveDetective = ({ onBack, updateScore }) => {
  ...
  useEffect(() => {
    const motiveQuestions = [
      {
        scenario:
          "Client says: 'I want a home where my family feels safe and protected.'",
        answer: "Emotional",
        motive: "Safety/Security",
        explanation:
          "Feeling 'safe' is an emotional need - it's about comfort and peace of mind, not tangible features.",
      },
      {
        scenario: "Client says: 'I need good ROI within 5 years.'",
        answer: "Rational",
        motive: "Investment Return",
        explanation:
          "ROI is a rational, measurable, financial goal - purely logical decision-making.",
      },
      {
        scenario: "Client says: 'I want my neighbors to respect me.'",
        answer: "Emotional",
        motive: "Status/Prestige",
        explanation:
          "Seeking respect and status is an emotional need driven by feelings of self-worth.",
      },
      {
        scenario: "Client says: 'The unit must be at least 200 sqm.'",
        answer: "Rational",
        motive: "Size Requirement",
        explanation:
          "A specific size requirement is a tangible, measurable need - rational and practical.",
      },
      {
        scenario: "Client says: 'I've always dreamed of a penthouse.'",
        answer: "Emotional",
        motive: "Dream/Aspiration",
        explanation:
          "Dreams and aspirations are emotionally driven - this is about fulfilling a personal vision.",
      },
      {
        scenario:
          "Client says: 'It needs to be close to my children's school.'",
        answer: "Rational",
        motive: "Location/Convenience",
        explanation:
          "Proximity to school is a practical, logical requirement based on convenience.",
      },
      {
        scenario: "Client says: 'I want to feel proud when guests visit.'",
        answer: "Emotional",
        motive: "Pride/Status",
        explanation: "Pride and impression on others are emotional drivers.",
      },
      {
        scenario: "Client says: 'The monthly payment must not exceed 20,000.'",
        answer: "Rational",
        motive: "Budget Constraint",
        explanation:
          "Budget limits are practical, measurable constraints - purely rational.",
      },
      {
        scenario: "Client says: 'I want somewhere I can finally call my own.'",
        answer: "Emotional",
        motive: "Ownership Pride",
        explanation:
          "The feeling of ownership and belonging is deeply emotional.",
      },
      {
        scenario: "Client says: 'Must have 3 bedrooms minimum.'",
        answer: "Rational",
        motive: "Space Requirement",
        explanation:
          "Number of bedrooms is a specific, tangible requirement - rational.",
      },
    ];
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      <p style={{ textAlign: "center", marginBottom: "20px" }}>
        Is this an EMOTIONAL or RATIONAL motive?
      </p>
      ...
      {showFeedback && (
        <>
          ...
          {currentQ < questions.length - 1 ? (
            ...
            <div style={{ textAlign: "center", marginTop: "30px" }}>
              <h3>
                🎉 Score: {localScore}/{questions.length * 10}
              </h3>
              <button
                onClick={onBack}
                style={{ ...styles.primaryBtn, marginTop: "20px" }}
    ...
    const allItems = [
      {
        text: "3 bedrooms",
        category: "Needs",
        explanation: "Tangible requirement",
      },
      {
        text: "Near metro station",
        category: "Needs",
        explanation: "Specific location request",
      },
      {
        text: "Budget under 3M",
        category: "Needs",
        explanation: "Measurable constraint",
      },
      {
        text: "Ground floor unit",
        category: "Needs",
        explanation: "Specific requirement",
      },
      {
        text: "Feel safe",
        category: "Wants",
        explanation: "Emotional concept",
      },
      {
        text: "Status symbol",
        category: "Wants",
        explanation: "Emotional motivation",
      },
      {
        text: "Peace of mind",
        category: "Wants",
        explanation: "Feeling, not tangible",
      },
      {
        text: "Pride of ownership",
        category: "Wants",
        explanation: "Emotional driver",
      },
      {
        text: "Parking space",
        category: "Needs",
      ...
      {
        text: "Investment security",
        category: "Wants",
        explanation: "Conceptual/emotional",
      },
    ];
    ...
    <div style={styles.card} className="animate-fadeIn">
      ...
      {currentItem && !showResults && (
        <div
          style={{
            background:
              "linear-gradient(135deg, rgba(229,62,62,0.2), rgba(229,62,62,0.1))",
            padding: "40px",
            borderRadius: "16px",
            marginBottom: "30px",
            textAlign: "center",
        ...
        >
          ...
          <h2 style={{ fontSize: "28px", marginTop: "15px" }}>
            "{currentItem.text}"
          </h2>
        </div>
      )}
    ...
    steps: [
      {
        ...
        explanation:
          "Asking 'Why New Cairo?' digs deeper into their motivation - understanding the reason behind the location choice.",
        response:
          "Client: 'My kids go to school there, and I want them closer.'",
      },
      {
        question:
          "Client mentioned kids' school. What's the next 'Why' question?",
        options: [
        ...
        explanation:
          "Understanding what 'closer' means to them reveals the emotional motivation - safety, family time, convenience.",
        response:
          "Client: 'I want to spend more quality time with them. Currently, their commute is 2 hours.'",
      },
      {
        question:
          "The emotional motive is becoming clear. What question solidifies understanding?",
        options: [
          {
            text: "How would having more family time make you feel?",
            correct: true,
          },
        ...
        explanation:
          "This question confirms the emotional driver - family bonding, being a present parent. This is the WANT behind the NEED.",
        response:
          "Client: 'It would mean everything. I feel like I'm missing their childhood.'",
      },
    ],
  };
        ...
        <>
          ...
          {currentStep < scenario.steps.length - 1 && selected?.correct ? (
            ...
            <div style={{ textAlign: "center", marginTop: "30px" }}>
              ...
              <p style={{ color: "rgba(255,255,255,0.7)", marginTop: "10px" }}>
                You uncovered the emotional motive: Family connection & being
...
const CommunicationDecoder = ({ onBack, updateScore }) => {
  ...
  useEffect(() => {
    const decoderQuestions = [
      {
        scenario:
          "Agent says 'This is a GREAT opportunity!' but sounds monotone and bored.",
        error: "Tonality",
        percentage: 38,
        explanation:
          "The words are positive, but the tonality (38%) doesn't match. Enthusiasm must come through in HOW you say it.",
      },
      {
        scenario:
          "Agent is explaining benefits but keeps looking at their phone and slouching.",
        error: "Body Language",
        percentage: 55,
        explanation:
          "Body language accounts for 55% of communication. Looking at phone and slouching shows disinterest.",
      },
      {
        scenario:
          "Agent says 'This unit is, um, like, kind of okay I guess' while smiling confidently.",
        error: "Words",
        percentage: 7,
        explanation:
          "The words (7%) are weak and non-committal. Even with good delivery, the actual words matter.",
      },
      {
        scenario:
          "Agent speaks with great enthusiasm but uses crossed arms and backs away from client.",
        error: "Body Language",
        percentage: 55,
        explanation:
          "Crossed arms and backing away are defensive body language (55%), contradicting verbal enthusiasm.",
      },
      {
        scenario:
          "Agent reads script perfectly but speaks in a fast, robotic, rushed manner.",
        error: "Tonality",
        percentage: 38,
        explanation:
          "Robotic delivery is a tonality problem (38%). The pace and natural flow of speech matters.",
      },
      {
        scenario:
          "Agent maintains eye contact and open posture but says 'I dunno if this is worth it.'",
        error: "Words",
        percentage: 7,
        explanation:
          "Words matter (7%)! Saying 'I dunno' and questioning value undermines the entire pitch.",
      },
      {
        scenario:
          "Agent speaks clearly and uses good words, but yawns repeatedly during presentation.",
        error: "Body Language",
        percentage: 55,
        explanation:
          "Yawning is body language (55%) that signals boredom or lack of interest to the client.",
      },
      {
        scenario:
          "Agent whispers the key benefits so quietly the client keeps asking 'what?'",
        error: "Tonality",
        percentage: 38,
        explanation:
          "Volume is part of tonality (38%). Speaking too quietly prevents the message from being heard.",
      },
    ];
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        <span
          style={{ ...styles.badge, fontSize: "14px", padding: "8px 15px" }}
        >
          Words: 7%
        </span>
        <span
      ...
      <p style={{ textAlign: "center", marginBottom: "20px" }}>
        Where is the communication ERROR?
      </p>
    ...
    const buzzerQuestions = [
      {
        scripts: [
          {
            text: "Hi! I noticed you were looking at properties in New Cairo - that's such a vibrant area!",
            robot: false,
          },
          {
            text: "Good morning. I am calling to inform you about available units. Please listen.",
            robot: true,
          },
          {
            text: "Hey, I've got something exciting that might interest you based on what you mentioned!",
            robot: false,
          },
        ],
        explanation:
          "Script 2 is robot talk - it's impersonal, commanding ('please listen'), and lacks warmth or personalization.",
      },
      {
        scripts: [
          {
            text: "Thank you for your time. I will now proceed to explain the payment options.",
            robot: true,
          },
          {
            text: "So about the payment - there's actually some really flexible options I think you'll love!",
            robot: false,
          },
          {
            text: "Let me walk you through how we can make this work for your budget.",
            robot: false,
          },
        ],
        explanation:
          "'Proceed to explain' is robotic language. Natural conversation doesn't announce what you're about to do.",
      },
      {
        scripts: [
          {
            text: "I understand that's a concern - a lot of my clients felt the same way initially.",
            robot: false,
          },
          {
            text: "Your concern has been noted. Moving to the next point.",
            robot: true,
          },
          {
            text: "That's a really valid point! Here's what I'd suggest...",
            robot: false,
          },
        ],
        explanation:
          "'Your concern has been noted' sounds like a customer service bot, not a helpful human advisor.",
      },
      {
        scripts: [
          {
            text: "Please hold while I transfer your inquiry to the relevant department.",
            robot: true,
          },
          {
            text: "Let me connect you with someone who specializes in exactly what you're looking for.",
            robot: false,
          },
          {
            text: "I know just the person to help with that - give me one sec!",
            robot: false,
          },
        ],
        explanation:
          "Formal, impersonal language like 'transfer your inquiry to the relevant department' is classic robot talk.",
      },
    ];
    ...
    <div style={styles.card} className="animate-fadeIn">
      ...
      <div style={{ textAlign: "center", marginBottom: "25px" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.7)" }}>
          Which script sounds like "machine talk format"?
        </p>
      </div>
    ...
    const mirrorQuestions = [
      {
        ...
        correct:
          "Match their pace - speak slowly, softly, with thoughtful pauses",
        wrong: "Speed up to show enthusiasm and energy",
        explanation:
          "Mirror the same tone/volume. Speaking fast to a slow speaker creates disconnect.",
      },
      {
        ...
        explanation:
          "We like people who are like us. Match their excitement to build rapport.",
      },
      {
        ...
        explanation:
          "Speaking the same language means adapting to their style, not changing them.",
      },
      {
        scenario:
          "Client is a numbers person, asking about ROI and appreciation rates.",
        correct: "Lead with data, statistics, and financial analysis",
        wrong: "Focus on how the property will make them feel",
        explanation:
          "Understand where they come from - this client wants rational, data-driven conversation.",
      },
      {
        ...
        explanation:
          "Rapport means adapting yourself. If they're playful, being rigid creates disconnect.",
      },
      {
        ...
        explanation:
          "Mirror their reserved nature. Overwhelming quiet people pushes them away.",
      },
    ];
      ...
      {showFeedback && (
        <>
          ...
          {currentQ < questions.length - 1 ? (
            ...
            <div style={{ textAlign: "center", marginTop: "30px" }}>
              <h3>
                🎉 Score: {localScore}/{questions.length * 15}
              </h3>
              <button
                onClick={onBack}
                style={{ ...styles.primaryBtn, marginTop: "20px" }}
    ...
    <div style={styles.card} className="animate-fadeIn">
      ...
      <div style={{ textAlign: "center", marginBottom: "30px" }}>
        ...
        <h2 style={{ marginTop: "15px" }}>
          {lang === "eg"
            ? "رتّب تقنية أ.ب.ج صح!"
            : "Unscramble the A.B.C Technique!"}
        </h2>
        <p style={{ color: "rgba(255,255,255,0.7)" }}>
          {lang === "eg"
            ? "اضغط على العناصر بالترتيب الصح"
        ...
        {[0, 1, 2].map((idx) => (
          <div
            ...
            style={{
              width: "150px",
              padding: "20px",
              background: userOrder[idx]
                ? "rgba(229,62,62,0.2)"
                : "rgba(255,255,255,0.05)",
              borderRadius: "12px",
              textAlign: "center",
              border: showResult
                ? userOrder[idx] === correctOrder[idx]
                  ? "2px solid #48bb78"
                  : "2px solid #f56565"
...
const MistakeSniper = ({ onBack, updateScore }) => {
  ...
  useEffect(() => {
    const mistakeQuestionsEn = [
      {
        ...
        mistakeIndex: 1,
        explanation:
          "'Is this a good time to talk?' is a common mistake! It gives the client an easy way to end the call. Get straight to the value proposition instead.",
      },
      {
        transcript: [
        ...
        mistakeIndex: 1,
        explanation:
          "Length of message is a mistake! Long monologues lose the client's attention. Keep messages concise and engage the client.",
      },
      {
        transcript: [
        ...
        mistakeIndex: 2,
        explanation:
          "Stop when you should proceed! Don't give up at first resistance. The presentation says 'Don't stop when you should proceed.'",
      },
      {
        transcript: [
        ...
        mistakeIndex: 0,
        explanation:
          "Unclear benefits! 'Features' and 'things' are vague. Be specific about what benefits the client will receive.",
      },
      {
        transcript: [
        ...
        mistakeIndex: -1,
        explanation:
          "This is actually a GOOD call! Personalized, benefit-focused, and references the client's stated needs. No mistakes here!",
      },
    ];
    ...
    const mistakeQuestionsEg = [
      {
        ...
        mistakeIndex: 1,
        explanation:
          'سؤال "ينفع أتكلم دلوقتي؟" غالبًا غلطة لأنه بيدي للعميل مخرج يقفل المكالمة بسهولة. ادخل على القيمة على طول.',
      },
      {
        transcript: [
        ...
        mistakeIndex: 1,
        explanation:
          "طول الرسالة غلطة. المونولوجات الطويلة بتضيّع تركيز العميل. خليك مختصر وادّي مساحة تفاعل.",
      },
      {
        transcript: [
        ...
        mistakeIndex: 2,
        explanation:
          "هنا بتقف وانت المفروض تكمل. متستسلمش من أول اعتراض؛ من المبادئ: متوقفش وانت لازم تكمل.",
      },
      {
        transcript: [
        ...
        mistakeIndex: 0,
        explanation:
          'المميزات مش واضحة. كلام زي "مميزات" و"حاجات" عام جدًا. قول ميزة محددة وتأثيرها على العميل.',
      },
      {
        transcript: [
        ...
        mistakeIndex: -1,
        explanation:
          "دي مكالمة كويسة فعلًا: شخصية، مركّزة على الفايدة، وبتربط بكلام العميل. مفيش غلط هنا.",
      },
    ];
    ...
    setStreak(0);
    setQuestions(
      shuffleArray(lang === "eg" ? mistakeQuestionsEg : mistakeQuestionsEn),
    );
  }, [lang]);
  ...
  if (questions.length === 0)
    return <div>{lang === "eg" ? "جارٍ التحميل…" : "Loading..."}</div>;
    ...
    <div style={styles.card} className="animate-fadeIn">
      ...
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        ...
        <h2 style={{ marginTop: "10px" }}>
          {lang === "eg"
            ? "فين الغلطة في نص المكالمة؟"
            : "Find the MISTAKE in this call transcript!"}
        </h2>
        <p style={{ color: "rgba(255,255,255,0.7)" }}>
          {lang === "eg"
            ? 'اضغط على السطر الغلط (أو اختار "مفيش غلط" لو كله تمام)'
            : 'Click the line with the error (or "No Mistakes" if it\'s clean)'}
        </p>
      </div>
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        >
          ✓{" "}
          {lang === "eg"
            ? "مفيش غلط — المكالمة تمام"
            : "No Mistakes - This call is clean!"}
        </button>
      </div>
      ...
      {showFeedback && (
        <>
          <Feedback
            isCorrect={selected === q.mistakeIndex}
            explanation={q.explanation}
          />
          {currentQ < questions.length - 1 ? (
            <NextButton onClick={nextQuestion} />
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        ...
        <h2 style={{ marginTop: "10px" }}>
          {lang === "eg"
            ? "طلّع الأربع عناصر الأساسية من طلب العميل!"
            : "Extract the 4 Key Request Items!"}
        </h2>
      </div>
          ...
          <div key={field} style={{ marginBottom: "15px" }}>
            ...
            <input
              ...
              style={{
                ...
                borderRadius: "8px",
                border: showResult
                  ? story.answers[field].some((a) =>
                      answers[field].toLowerCase().includes(a.toLowerCase()),
                    )
                    ? "2px solid #48bb78"
                    : "2px solid #f56565"
            ...
            {showResult && (
              ...
              >
                {lang === "eg" ? "إجابات مقبولة:" : "Acceptable:"}{" "}
                {story.answers[field].join(" / ")}
              </div>
            )}
          </div>
        ))}
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        <span style={{ ...styles.badge, ...styles.badgeRed }}>
          👮{" "}
          {ui.activityNames.dresspolice ||
            (lang === "eg" ? "شرطة اللبس" : "Dress Code Police")}
        </span>
        <ScorePanel
          score={localScore}
          streak={streak}
      ...
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.6)" }}>
          Remember: Maximum 7 points of interest allowed
        </p>
      </div>
        ...
        <>
          <div style={{ marginBottom: "20px" }}>
            <label style={{ display: "block", marginBottom: "10px" }}>
              How many accessories did you count?
            </label>
            <input
              type="number"
              min="1"
          ...
          <div style={{ marginBottom: "20px" }}>
            <label style={{ display: "block", marginBottom: "10px" }}>
              Does this VIOLATE the Rule of 7?
            </label>
            <div style={styles.grid2}>
              <button
      ...
      {showResult && (
        <>
          ...
          >
            <p>
              <strong>Actual count:</strong> {scenario.count} accessories
            </p>
            <p>
              <strong>Your count:</strong> {userCount}{" "}
              {parseInt(userCount) === scenario.count ? "✅" : "❌"}
            </p>
            <p>
              <strong>Verdict:</strong>{" "}
              {scenario.isViolation
                ? "VIOLATION (more than 7)"
                : "Acceptable (7 or fewer)"}
            </p>
            <p>
              <strong>Your verdict:</strong>{" "}
              {userVerdict ? "Violation" : "Acceptable"}{" "}
              {userVerdict === scenario.isViolation ? "✅" : "❌"}
            </p>
          </div>
          ...
          {currentIdx < scenarios.length - 1 ? (
            ...
            <div style={{ textAlign: "center", marginTop: "20px" }}>
              <h3>
                🎉 Score: {localScore}/{scenarios.length * 15}
              </h3>
              <button
                onClick={onBack}
                style={{ ...styles.primaryBtn, marginTop: "20px" }}
    ...
    const scenarios =
      lang === "eg"
        ? [
            {
              description:
                "وكيلة سارة: بتتكلم بثقة بس كانت بتقاطع العميل كتير. فاهمة تفاصيل الوحدة كويس بس مش عارفة ترد على أسئلة عن المنطقة. مظهرها محترم، بس كانت بتبص في تليفونها أثناء المقابلة ومتابعتش بعد المقابلة.",
              expectedRatings: {
                ثقة: 4,
                "تواصل قوي": 2,
                معرفة: 3,
            ...
            {
              description:
                "وكيل عمر: سمع احتياجات العميل كويس وسأل أسئلة متابعة ممتازة. عدّل عرضه لما لاحظ إن العميل مهتم أكتر بالعائد الاستثماري. كان عنده صعوبة يشرح شروط الدفع بوضوح. دايمًا في معاده ومجهّز. وقدر يحدد مع العميل ميعاد معاينة.",
              expectedRatings: {
                ثقة: 4,
                "تواصل قوي": 5,
                معرفة: 3,
        ...
        : [
            {
              description:
                "Agent Sarah: Spoke confidently but interrupted the client multiple times. Knew the property details well but couldn't answer questions about the neighborhood. Dressed professionally. Kept checking her phone during the meeting. Didn't follow up after the meeting.",
              expectedRatings: {
                Confidence: 4,
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        <span style={{ fontSize: "40px" }}>🎯</span>
        <h2 style={{ marginTop: "10px" }}>
          {lang === "eg" ? "قيّم مهارات الوكيل" : "Rate this Agent's Skills"}
        </h2>
        <p style={{ color: "rgba(255,255,255,0.6)" }}>
          {lang === "eg"
            ? "بناءً على السيناريو: قيّم كل مهارة من ١ لـ ٥"
            : "Based on the scenario, rate each skill from 1-5"}
        </p>
      </div>
              ...
              {showResult && (
                <span
                  style={{
                    ...
                    color:
                      Math.abs(
                        ratings[skill] - scenario.expectedRatings[skill],
                      ) <= 1
                        ? "#48bb78"
                        : "#f56565",
                  }}
                >
                  {lang === "eg"
                    ? `(المتوقع: ${scenario.expectedRatings[skill]})`
                    : `(Expected: ${scenario.expectedRatings[skill]})`}
                </span>
              )}
            </div>
          </div>
          ...
          <p style={{ color: "rgba(255,255,255,0.7)", marginTop: "10px" }}>
            {lang === "eg"
              ? localScore >= 80
                ...
                : localScore >= 60
                  ? "شغل كويس!"
                  : "كمّل تمرين على ملاحظة التفاصيل!"
              : localScore >= 80
...
const FirstImpressionTrial = ({ onBack, updateScore }) => {
  ...
  useEffect(() => {
    const impressionQuestionsEn = [
      {
        opening:
          "Hey, so like, I got your number from somewhere and wanted to talk about some property stuff maybe?",
        isGood: false,
        explanation:
          "Unprofessional opening - vague, uncertain, and doesn't inspire confidence.",
      },
      {
        opening:
          "Good morning! I'm reaching out because I noticed you're interested in properties in New Cairo - I specialize in that area and have some opportunities I think you'd love.",
        isGood: true,
        explanation:
          "Professional, specific, shows research, and immediately provides value.",
      },
      {
        opening:
          "Hi, is this Ahmed? Great! Listen, you NEED to buy this property RIGHT NOW because it's selling fast!",
        isGood: false,
        explanation: "Too pushy and aggressive. Creates pressure, not trust.",
      },
      {
        opening:
          "Hello, I hope I'm not bothering you. Sorry to call. I know you're probably busy...",
        isGood: false,
        explanation:
          "Apologetic and lacks confidence. First impressions need assurance, not uncertainty.",
      },
      {
        opening:
          "Good afternoon! Based on your interest in investment properties, I've put together some options that match your criteria. Do you have a few minutes to discuss?",
        isGood: true,
        explanation:
          "Confident, personalized, respectful of their time, and offers clear value.",
      },
    ];
    ...
    const impressionQuestionsEg = [
      {
        opening:
          "ألو… أنا جبت رقمك من مكان كده وحبيت أكلمك في موضوع عقارات يعني…",
        isGood: false,
        explanation: "افتتاحية غير احترافية: كلام عام ومتلخبط ومش بيدي ثقة.",
      },
      {
        opening:
          "صباح الخير! بكلمك عشان لاحظت اهتمامك بوحدات في القاهرة الجديدة — أنا متخصص هناك وعندي كام اختيار مناسبين ليك.",
        isGood: true,
        explanation:
          "احترافي ومحدد وبيوضح إنك فاهم طلبه وبتقدم قيمة من أول ثانية.",
      },
      {
        opening: "ألو يا أستاذ… لازم تشتري دلوقتي حالًا عشان الوحدة بتطير!",
        isGood: false,
        explanation:
          "ضغط وهجوم بدري بيكسر الثقة. الانطباع الأول محتاج هدوء وثقة مش تهديد.",
      },
      {
      ...
      {
        opening:
          "مساء الخير! بناءً على اهتمامك بالاستثمار، جهّزتلك اختيارات على نفس معاييرك. ينفع ناخد دقيقتين نتكلم؟",
        isGood: true,
    ...
    setQuestions(
      shuffleArray(
        lang === "eg" ? impressionQuestionsEg : impressionQuestionsEn,
      ),
    );
  }, [lang]);
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        <h2>
          {lang === "eg"
            ? "بسرعة! الانطباع الأول كويس ولا وحش؟"
            : "Quick! Good or Bad First Impression?"}
        </h2>
        <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "14px" }}>
          {lang === "eg"
            ? `فاكر: ${TD.firstImpression.quote}`
          ...
          {selected === null && (
            <div style={{ ...styles.feedbackIncorrect, textAlign: "center" }}>
              ...
              <p style={{ marginTop: "10px" }}>
                {lang === "eg"
                  ? "الوقت خلص! الانطباع الأول بييجي بسرعة!"
                  : "Time's up! First impressions happen fast!"}
              </p>
            </div>
          )}
          <Feedback
...
const ObjectionDeflector = ({ onBack, updateScore }) => {
  ...
  useEffect(() => {
    const objectionQuestionsEn = [
      {
        objection:
          "I only want Resale properties - I need to move in immediately.",
        responses: [
          {
            text: "I understand the urgency! While resales are RTM, they require full cash. With primary, you could get better payment terms and find an RTM unit from a developer's ready stock.",
            correct: true,
          },
          {
            text: "Resale is a bad idea. You should only buy from developers.",
            correct: false,
          },
          {
            text: "Okay, I only have primary properties, so I can't help you.",
            correct: false,
          },
          {
            text: "Let me check if we have any resales available.",
            correct: false,
          },
        ],
        explanation:
          "Acknowledge their need (RTM/urgency), but present the benefits of primary (payment terms) while offering a solution (ready stock from developers).",
      },
      {
        objection:
          "Why should I use a broker? I can go directly to the developer.",
        responses: [
          { text: "Developers don't know what they're doing.", correct: false },
          { text: "We're cheaper than developers.", correct: false },
          {
            text: "Great question! As a broker, I offer consultancy across diverse projects, giving you more market awareness and opportunities. Developers are limited to their own projects.",
            correct: true,
          },
          { text: "Fine, go to the developer then.", correct: false },
        ],
        explanation:
          "Brokers offer: consultancy (not just sales), diverse projects, more market awareness, and less walk out. These are the key differentiators from the presentation.",
      },
      {
        ...
        responses: [
          ...
          {
            text: "Perfect! Primary properties from developers offer installment plans, not just cash. Most primary units are off-plan with flexible payment terms.",
            correct: true,
          },
          { text: "Try to get a loan.", correct: false },
          {
            text: "Resale is the only good option, so you need to find cash.",
            correct: false,
          },
        ],
        explanation:
          "Primary sales from developers offer installment options, unlike resale which requires cash. This is a key differentiator from the presentation.",
      },
      {
        objection:
          "I'm worried about buying off-plan - what if it's never finished?",
        responses: [
          {
            text: "That's a valid concern. I work with established developers with strong track records. Plus, primary off-plan offers better prices and payment flexibility compared to RTM resales.",
            correct: true,
          },
        ...
        explanation:
          "Acknowledge the concern, then address it with facts (track record) while presenting the benefits of off-plan (price, payment terms).",
      },
    ];
    ...
    const objectionQuestionsEg = [
      {
        ...
        responses: [
          {
            text: "فاهم استعجالك. الريسيل غالبًا جاهز للسكن بس بيحتاج كاش. في البرايمري ممكن تلاقي جاهز استلام من مخزون المطوّر وبنظام سداد أحسن.",
            correct: true,
          },
          {
            text: "الريسيل فكرة وحشة. لازم تشتري من مطوّر وبس.",
            correct: false,
          },
        ...
        explanation:
          "إقرار بالاستعجال + حل عملي: جاهز استلام من المطوّر مع ميزة السداد في البرايمري.",
      },
      {
        ...
        responses: [
          ...
          {
            text: "سؤال مهم. أنا كبروكر بقدملك استشارة عبر مشاريع كتير، وده بيديك وعي سوق وفرص أكتر. المطوّر محدود في مشروعه بس.",
            correct: true,
          },
          { text: "خلاص روح للمطوّر.", correct: false },
        ],
        explanation:
          "ميزة البروكر: استشارة + مشاريع متنوعة + وعي سوق + فرص أكتر (وده من أساسيات المادة).",
      },
      {
        ...
        responses: [
          ...
          {
            text: "تمام جدًا. البرايمري من المطوّر بيبقى بأقساط ونُظم سداد، ومش لازم كاش زي الريسيل.",
            correct: true,
          },
      ...
      },
      {
        ...
        responses: [
          {
            text: "قلقك طبيعي. بنشتغل مع مطوّرين ليهم سابقة أعمال قوية. وكمان الأوف بلان بيبقى سعره أحسن ومرن في السداد مقارنة بالجاهز.",
            correct: true,
          },
        ...
        explanation:
          "إقرار بالقلق + طمأنة مبنية على سابقة أعمال + عرض فوائد الأوف بلان (سعر/سداد).",
      },
    ];
    ...
    setStreak(0);
    setQuestions(
      shuffleArray(lang === "eg" ? objectionQuestionsEg : objectionQuestionsEn),
    );
  }, [lang]);
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      <h3 style={{ marginBottom: "20px" }}>
        {lang === "eg" ? "اختار أفضل رد:" : "Choose the best response:"}
      </h3>
    ...
    const leadOptionsEn = [
      {
        type: "Broker Lead",
        description:
          "Client referred by a broker, already qualified, looking for specific units",
        walkOut: "Low",
        priority: 1,
        reason:
          "Brokers have less walk out and provide consultancy - leads are pre-qualified",
      },
      {
        ...
        priority: 3,
        reason:
          "Developers have more walk out - these clients may just be browsing",
      },
      {
        type: "Resale Buyer",
        ...
        priority: 2,
        reason:
          "Cash buyers are serious, but resale process can have complications",
      },
    ];
    ...
    const leadOptionsEg = [
      {
        ...
        priority: 1,
        reason:
          "ليدز البروكر عادة نسبة الانسحاب أقل وبيكون في استشارة وتأهيل مسبق.",
      },
      {
        ...
        priority: 3,
        reason:
          "ليدز المطوّر غالبًا نسبة الانسحاب أعلى لأن ناس كتير بتبقى بتشوف وبس.",
      },
      {
        type: "مشتري ريسيل",
        ...
        priority: 2,
        reason:
          "الكاش بيبقى جاد، بس الريسيل ممكن يبقى فيه تفاصيل/تعقيدات أكتر.",
      },
    ];
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        ...
        <h2 style={{ marginTop: "10px" }}>
          {lang === "eg"
            ? "رتّب الليدز حسب احتمالية القفل"
            : "Rank Leads by Likelihood to Close"}
        </h2>
        <p style={{ color: "rgba(255,255,255,0.6)" }}>
          {lang === "eg"
      ...
      <div style={{ marginBottom: "20px" }}>
        <h4 style={{ marginBottom: "10px" }}>
          {lang === "eg" ? "الليدز المتاحة:" : "Available Leads:"}
        </h4>
        <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
          {leads
            .filter((l) => !ranking.includes(l))
            .map((lead, idx) => (
              <button
                key={idx}
      ...
      <div style={{ marginBottom: "20px" }}>
        <h4 style={{ marginBottom: "10px" }}>
          {lang === "eg"
            ? "ترتيبك (من الأكثر للأقل):"
            : "Your Ranking (Most → Least Likely):"}
        </h4>
        {[1, 2, 3].map((position) => (
          <div
            key={position}
            style={{
              ...
              marginBottom: "10px",
              border:
                showResult && ranking[position - 1]
                  ? ranking[position - 1].priority === position
                    ? "2px solid #48bb78"
                    : "2px solid #f56565"
...
const RequestFormBuilder = ({ onBack, updateScore }) => {
  ...
  const checkForm = () => {
    let score = 0;
    const correctCount = selectedFields.filter((f) =>
      requiredFields.includes(f),
    ).length;
    const incorrectCount = selectedFields.filter(
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        ...
        <h2 style={{ marginTop: "10px" }}>
          {lang === "eg"
            ? "ابني فورم كواليـفاي مظبوط للعميل"
            : "Build the Perfect Client Qualification Form"}
        </h2>
        <p style={{ color: "rgba(255,255,255,0.6)" }}>
          {lang === "eg"
      ...
      >
        <h4 style={{ marginBottom: "15px" }}>
          📋{" "}
          {lang === "eg"
            ? "فورم الكواليـفاي بتاعك:"
            : "Your Qualification Form:"}
        </h4>
        {selectedFields.length === 0 ? (
          <p style={{ color: "rgba(255,255,255,0.4)" }}>
            {lang === "eg"
              ? "اضغط على الخانات فوق عشان تضيفها للفورم…"
              : "Click fields above to add them to your form..."}
          </p>
        ) : (
...
const ColdCallSimulator = ({ onBack, updateScore }) => {
  ...
  const scenarioEn = {
    intro:
      "You're about to make a cold call to a potential client who expressed interest in New Cairo properties online.",
    steps: [
      {
        ...
        options: [
          {
            ...
            correct: false,
            feedback:
              "Wrong question! This gives them an easy out. Don't stop when you should proceed!",
          },
          {
            text: "Good morning! This is [Name] from Xcelias. I noticed your interest in New Cairo properties - I have something exciting to share!",
            correct: true,
            feedback:
              "Perfect! Confident, introduces yourself, and leads with value.",
          },
        ],
      },
      {
        ...
        options: [
          {
            text: "Oh, sorry to bother you then. I'll call back another time. Goodbye.",
            correct: false,
            feedback:
              "Don't stop when you should proceed! You gave up too easily.",
          },
          {
            text: "I completely understand - this will only take 30 seconds. I found a property that matches exactly what you were looking for. Can I share one quick detail?",
            correct: true,
            feedback:
              "Great recovery! You acknowledged their time, kept it brief, and created curiosity.",
          },
        ],
      },
      {
        ...
        options: [
          {
            text: "*Proceeds to explain every feature of the property for 5 minutes*",
            correct: false,
            feedback:
              "Length of message! They said make it quick. Keep it concise!",
          },
          {
            text: "There's a 3-bedroom in New Cairo, fully finished, within your budget, available in 6 months. Would you like to see it this weekend?",
            correct: true,
            feedback:
              "Excellent! Covered the 4 key points (unit type, finishing, budget, delivery) and asked for commitment.",
          },
        ],
      },
      {
        situation:
          "Client: 'That does sound interesting. But I've been burned before by brokers...'",
        options: [
          {
            text: "I understand that concern - a lot of my clients felt the same initially. What I offer is consultancy, not just sales. I work across many projects to find what's truly right for you.",
            correct: true,
            feedback:
              "Perfect rapport building and addressing the objection by highlighting broker advantages!",
          },
          {
            text: "Well, I'm not like other brokers. Trust me.",
            correct: false,
            feedback:
              "This doesn't build rapport or address the concern with substance.",
          },
        ],
      },
    ],
  ...
  const scenarioEg = {
    intro:
      "إنت داخل تعمل كولد كول لعميل كان مهتم بوحدات في القاهرة الجديدة أونلاين.",
    steps: [
      {
        situation: 'التليفون بيرن… العميل: "ألو؟"',
        options: [
          {
            text: "ألو، ينفع أتكلم دلوقتي؟",
            correct: false,
            feedback:
              "ده سؤال بيدي للعميل مخرج سهل يقفل. ادخل على القيمة على طول.",
          },
          {
            text: "صباح الخير! معاك [الاسم] من Xcelias. لاحظت اهتمامك بالقاهرة الجديدة — عندي حاجة مناسبة جدًا أحب أقولك عليها بسرعة.",
            correct: true,
            feedback: "ممتاز: تعريف سريع + ثقة + قيمة واضحة.",
          },
        ],
      },
      {
        ...
        options: [
          {
            text: "تمام آسف على الإزعاج، هكلمك مرة تانية. مع السلامة.",
            correct: false,
            feedback:
              "متوقفش وانت لازم تكمل. استأذنه في ٣٠ ثانية وادّيه سبب يسمع.",
          },
          {
            text: "تمام جدًا — مش هاخد غير ٣٠ ثانية. عندي وحدة مطابقة للِّي كنت بتدور عليه. ينفع أقولك تفصيلة واحدة؟",
            correct: true,
            feedback: "حلو: احترمت وقته + اختصرت + عملت فضول.",
          },
        ],
      },
      {
        ...
        options: [
          {
            text: "*يقعد يشرح كل تفصيلة ٥ دقايق متواصل*",
            correct: false,
            feedback: "طول الرسالة غلطة. هو قال بسرعة — خليك مختصر ومباشر.",
          },
          {
            text: "عندي ٣ غرف في القاهرة الجديدة، تشطيب كامل، في حدود ميزانيتك، والاستلام كمان ٦ شهور. تحب نعمل معاينة الويك إند؟",
            correct: true,
            feedback: "ممتاز: غطّيت أهم نقاط الطلب وطلبت التزام بخطوة.",
          },
        ],
      },
      {
        ...
        options: [
          {
            text: "فاهم جدًا. كتير من العملاء كانوا حاسين كده. أنا دوري استشارة مش بيع وبس — بشتغل على مشاريع مختلفة عشان أطلعلك الأنسب فعلًا.",
            correct: true,
            feedback: "ده رد قوي: إقرار + بناء ثقة + توضيح قيمة البروكر.",
          },
          {
            text: "أنا مش زي باقي البروكرز… صدّقني.",
            correct: false,
            feedback: "رد عام ومش بيبني ثقة ولا بيقدم دليل.",
          },
        ],
      },
    ],
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        <span style={{ ...styles.badge, ...styles.badgeRed }}>
          📞 {ui.activityNames.coldcall}
        </span>
        <ScorePanel
          score={localScore}
          streak={0}
          totalQuestions={scenario.steps.length}
      ...
      {!gameOver ? (
        <>
          ...
          >
            <span style={{ fontSize: "50px" }}>📱</span>
            <p
              style={{ fontSize: "18px", marginTop: "15px", lineHeight: "1.6" }}
            >
          ...
          {lastChoice && (
            <div
              style={{
                ...
                borderRadius: "8px",
                marginBottom: "20px",
                background: lastChoice.correct
                  ? "rgba(72,187,120,0.2)"
                  : "rgba(245,101,101,0.2)",
                border: lastChoice.correct
                  ? "1px solid #48bb78"
                  : "1px solid #f56565",
              }}
            >
        ...
        <div style={{ textAlign: "center" }}>
          <span style={{ fontSize: "80px" }}>
            {localScore >= 75 ? "🏆" : localScore >= 50 ? "👍" : "📚"}
          </span>
          <h2 style={{ marginTop: "20px" }}>
            {lang === "eg" ? "المكالمة خلصت!" : "Call Complete!"}
          </h2>
          ...
          <p style={{ color: "rgba(255,255,255,0.7)", marginTop: "15px" }}>
            {localScore >= 75
              ? lang === "eg"
                ? "تقنية ممتازة! عديت الاعتراضات وقفلت بشكل قوي."
                : "Excellent call technique! You navigated objections and closed strong."
              : localScore >= 50
                ? lang === "eg"
                  ? "شغل كويس! راجع الغلطات الشائعة عشان تتحسّن."
                  : "Good effort! Review the common mistakes to improve."
                : lang === "eg"
                  ? "كمّل تدريب! فاكر: متوقفش وانت لازم تكمل."
                  : "Keep practicing! Remember: Don't stop when you should proceed."}
          </p>
          <button
            onClick={onBack}
            style={{ ...styles.primaryBtn, marginTop: "20px" }}
...
const TwentyOneExperiences = ({ onBack, updateScore }) => {
  ...
  const timeTaken =
    endTime && startTime ? ((endTime - startTime) / 1000).toFixed(1) : null;
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        <span style={{ ...styles.badge, ...styles.badgeGreen }}>
          🔄 {ui.activityNames["21exp"]}
        </span>
        <div style={styles.scoreItem}>
          <span style={styles.scoreLabel}>
            {lang === "eg" ? "ضغطات" : "Clicks"}
          </span>
          <span style={styles.scoreValue}>
            {clicks}/{TARGET}
          </span>
      ...
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        <p style={{ fontSize: "18px", color: "rgba(255,255,255,0.9)" }}>
          🙁{" "}
          {lang === "eg"
            ? "يا نهار… عملت انطباع أول وحش…"
            : "Oh no! You made a bad first impression..."}
        </p>
        <p style={{ color: "rgba(255,255,255,0.7)", marginTop: "10px" }}>
          {lang === "eg"
      ...
      {clicks < TARGET ? (
        ...
        <div style={{ textAlign: "center", padding: "50px" }}>
          ...
          <h2 style={{ marginTop: "20px" }}>
            {lang === "eg" ? "تمام… اتصلّحت!" : "Redemption Complete!"}
          </h2>
...
const RealEstateBingo = ({ onBack, updateScore }) => {
  ...
  const allTermsEn = [
    ...
    {
      term: "21 Experiences",
      definition: "Good experiences to fix bad impression",
    },
    ...
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        {currentCall ? (
          ...
          <p>
            {lang === "eg"
              ? 'اضغط "نادِي اللي بعده" عشان تبدأ!'
      ...
      {gameWon && (
        <div style={{ textAlign: "center", marginTop: "30px" }}>
          ...
          <p style={{ marginTop: "10px" }}>
            {lang === "eg"
              ? `النتيجة النهائية: ${localScore + 100}`
              : `Final Score: ${localScore + 100}`}
          </p>
          <button
            onClick={onBack}
            style={{ ...styles.primaryBtn, marginTop: "20px" }}
...
const SalesmanCrossword = ({ onBack, updateScore }) => {
  ...
  const handleGuess = () => {
    ...
    const guess =
      lang === "eg" ? normalizeEg(input) : input.toUpperCase().trim();
    const wordObj =
      lang === "eg"
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        <span style={{ ...styles.badge, ...styles.badgeBlue }}>
          🔤 {ui.activityNames.crossword}
        </span>
        <div style={styles.scoreItem}>
          <span style={styles.scoreLabel}>
            {lang === "eg" ? "اتلاقى" : "Found"}
          </span>
          <span style={styles.scoreValue}>
      ...
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        <h2>
          {lang === "eg"
            ? "اعرف مصطلحات العقار!"
            : "Find the Real Estate Terms!"}
        </h2>
        <p style={{ color: "rgba(255,255,255,0.6)" }}>
          {lang === "eg"
            ? "استخدم التلميحات وخمّن كل كلمة"
            : "Use the hints to guess each word"}
        </p>
      </div>
      ...
      >
        {words.map((wordObj, idx) => (
          <div
            ...
            style={{
              padding: "15px",
              background: found.includes(wordObj.word)
                ? "rgba(72,187,120,0.2)"
                : "rgba(255,255,255,0.05)",
              borderRadius: "8px",
              border: found.includes(wordObj.word)
                ? "1px solid #48bb78"
                : "1px solid rgba(255,255,255,0.1)",
            }}
          >
            <div style={{ fontWeight: "600", marginBottom: "5px" }}>
              {found.includes(wordObj.word)
                ? wordObj.word
      ...
      {isComplete && (
        <div style={{ textAlign: "center", marginTop: "30px" }}>
          <span style={{ fontSize: "60px" }}>🏆</span>
          <h2 style={{ marginTop: "10px" }}>
            {lang === "eg" ? "كده لقيت كل الكلمات!" : "All Words Found!"}
          </h2>
          <p>
            {lang === "eg" ? `النتيجة: ${localScore}` : `Score: ${localScore}`}
          </p>
          <button
            onClick={onBack}
            style={{ ...styles.primaryBtn, marginTop: "20px" }}
...
const FinalExam = ({ onBack, updateScore }) => {
  ...
  useEffect(() => {
    ...
    const tfQuestions =
      lang === "eg"
        ? [
            {
              q: "البروكر عنده نسبة انسحاب أكتر من المطوّر.",
              a: false,
              e: "البروكر عادة نسبة الانسحاب عنده أقل.",
            },
            {
              q: "معظم الريسيل بيكون جاهز للسكن.",
              a: true,
              e: "الريسيل غالبًا جاهز للسكن.",
            },
            {
              q: "لغة الجسد مسؤولة عن ٥٥٪ من تأثير التواصل.",
              a: true,
              e: "قاعدة ٧-٣٨-٥٥: لغة الجسد = ٥٥٪.",
            },
            {
              q: "ممكن تلبس لحد ١٠ إكسسوارات.",
              a: false,
              e: "قاعدة ٧: الحد الأقصى ٧ نقاط لافتة.",
            },
            {
              q: "الاحتياجات هي دوافع عاطفية.",
              a: false,
              e: "الاحتياجات ملموسة. الرغبات ممكن تكون عاطفية.",
            },
            {
              q: "تقنية أ.ب.ج معناها: دايمًا اقفل البيع.",
              a: false,
              e: "أ.ب.ج = إقرار، مميزات، التزام.",
            },
            {
              q: "ممكن تحتاج ٢١ تجربة كويسة لتعويض انطباع أول وحش.",
              a: true,
              e: "الدراسات بتقول ٢١ تجربة كويسة متكررة.",
            },
            {
              q: "المطوّر وعيه بالسوق أعلى من البروكر.",
              a: false,
              e: "البروكر وعيه بالسوق أعلى.",
            },
            {
              q: "معظم البرايمري بيكون أوف بلان.",
              a: true,
              e: "البرايمري غالبًا قبل الإنشاء.",
            },
            {
              q: "نبرة الصوت مسؤولة عن ٧٪ من تأثير التواصل.",
              a: false,
              e: "نبرة الصوت = ٣٨٪. الكلام = ٧٪.",
            },
          ]
        : [
            {
              q: "Brokers have more walk out than developers.",
              a: false,
              e: "Brokers have LESS walk out.",
            },
            {
              q: "Most resales are RTM.",
              a: true,
              e: "Most resales are RTM (Ready To Move).",
            },
            {
              q: "Body language accounts for 55% of communication.",
              a: true,
              e: "7-38-55 rule: Body language = 55%.",
            },
            {
              q: "You can have up to 10 accessories.",
              a: false,
              e: "Rule of 7: Maximum 7 accessories.",
            },
            {
              q: "Needs are emotional concepts.",
              a: false,
              e: "Needs are tangible requirements. Wants are emotional.",
            },
            {
              q: "A.B.C means Always Be Closing.",
              a: false,
              e: "A.B.C = Acknowledgment, Benefits, Commitment.",
            },
            {
              q: "It takes 21 good experiences to fix a bad first impression.",
              a: true,
              e: "Studies show 21 repeated good experiences needed.",
            },
            {
              q: "Developers have more market awareness.",
              a: false,
              e: "BROKERS have more market awareness.",
            },
            {
              q: "Primary properties are usually Off-plan.",
              a: true,
              e: "Most primary properties are Off-plan.",
            },
            {
              q: "Tonality accounts for 7% of communication.",
              a: false,
              e: "Tonality = 38%. Words = 7%.",
            },
          ];
    ...
    allUnits.forEach((unit) => {
      allQuestions.push({
        ...
        options: shuffleArray([
          unit.name,
          ...getRandomItems(
            allUnits.filter((u) => u.name !== unit.name).map((u) => u.name),
            3,
          ),
        ]),
  ...
  const handleAnswer = (answer) => {
    ...
    const isCorrect =
      answer === questions[currentQ].correct ||
  ...
  if (questions.length === 0)
    return (
      <div>{lang === "eg" ? "جاري تجهيز الامتحان…" : "Loading exam..."}</div>
    );
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        <div>
          <span style={{ ...styles.badge, ...styles.badgeRed }}>
            📝 {s.activityNames.exam}
          </span>
          <span
            style={{ ...styles.badge, ...styles.badgeBlue, marginLeft: "10px" }}
          >
            {toneifyText(lang, q.category, "label")}
          </span>
        </div>
        <ScorePanel
          score={localScore}
        ...
        <>
          ...
          {!isLastQuestion ? (
            ...
            <div style={{ textAlign: "center", marginTop: "30px" }}>
              ...
              <h3 style={{ marginTop: "10px" }}>
                Final Score: {localScore}/{questions.length * 5}
              </h3>
              <p style={{ marginTop: "10px", color: "rgba(255,255,255,0.7)" }}>
                {localScore >= questions.length * 4
                  ? "🏆 Outstanding! You're an Xcelias expert!"
                  : localScore >= questions.length * 3
                    ? "👏 Great job! Keep refining your knowledge."
                    : localScore >= questions.length * 2
...
const buildRandomQuestion = (lang = "en") => {
  ...
  questionBuilders.push(() => {
    ...
    const distractors = getRandomItems(
      units.filter((u) => u.name !== correct.name),
      3,
    );
  ...
  questionBuilders.push(() => {
    ...
    return {
      ...
      prompt:
        lang === "eg"
          ? "أنهي تشطيب أكمل؟"
          : `Which finishing level is MORE complete?`,
      options,
  ...
  questionBuilders.push(() => {
    ...
    const options =
      lang === "eg" ? ["بروكر", "مطوّر"] : ["Broker", "Developer"];
    return {
      category: lang === "eg" ? "بروكر ولا مطوّر" : "Broker vs Developer",
      prompt:
        lang === "eg" ? `“${pair.trait}” يخص:` : `“${pair.trait}” belongs to:`,
      options,
      correctIndex: options.indexOf(pair.correct),
      explanation: (
        lang === "eg" ? pair.correct === "بروكر" : pair.correct === "Broker"
      )
        ? lang === "eg"
  ...
  questionBuilders.push(() => {
    ...
    const pair = getRandomItem([
      {
        trait: primaryTrait,
        correct: lang === "eg" ? TD.primaryVsResale.primary.name : "Primary",
      },
      {
        trait: resaleTrait,
        correct:
          lang === "eg" ? TD.primaryVsResale.resale.name : "Resale (Secondary)",
      },
    ]);
    const options =
      lang === "eg"
    ...
    return {
      ...
      prompt:
        lang === "eg" ? `“${pair.trait}” يخص:` : `“${pair.trait}” describes:`,
      options,
      correctIndex: options.indexOf(pair.correct),
      explanation: (
        lang === "eg"
          ? pair.correct === TD.primaryVsResale.primary.name
          : pair.correct === "Primary"
      )
        ? lang === "eg"
  ...
  questionBuilders.push(() => {
    ...
    return {
      ...
      prompt:
        lang === "eg"
          ? `صلّح الغلطة دي: “${item.mistake}”`
          : `Fix this mistake: “${item.mistake}”`,
      options,
      correctIndex: options.indexOf(correct),
      explanation:
        lang === "eg" ? `الصح: ${correct}.` : `Correct approach: ${correct}.`,
    };
  });
    ...
    return (
      <div style={styles.card} className="animate-fadeIn">
        ...
        >
          <button
            onClick={startGame}
            style={{ ...styles.primaryBtn, padding: "18px 34px", fontSize: 18 }}
          >
            🚀 Start Battle
          </button>
        </div>
    ...
    return (
      <div style={styles.card} className="animate-fadeIn">
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ ...styles.stageTitle, marginTop: 10 }}>
            Winner: {teamNames[winnerIdx]}
          </div>
          <div style={{ marginTop: 12, color: RM_THEME.muted }}>
            Final standings
          </div>
        </div>
        ...
        >
          <button onClick={() => setPhase("setup")} style={styles.secondaryBtn}>
            ↩️ New Setup
          </button>
    ...
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        ...
        <div style={{ marginTop: 10, color: RM_THEME.muted, fontSize: 14 }}>
          {buzzedTeam === null
            ? "First team to BUZZ gets the shot."
            : `Answering: ${teamNames[buzzedTeam]} • ${timeLeft}s`}
        </div>
      </div>
      ...
      {buzzedTeam === null && (
        <div
          style={{
            display: "grid",
            gridTemplateColumns: `repeat(${teamCount}, minmax(180px, 1fr))`,
            gap: 12,
            marginBottom: 14,
          }}
        >
          {activeTeams.map((i) => (
            <button
              ...
              style={{
                textAlign: "center",
                padding: "22px 16px",
                opacity: attempted.includes(i) ? 0.4 : 1,
              }}
            >
              <div style={{ fontSize: 34, marginBottom: 6 }}>🔔</div>
              <div style={{ fontWeight: 900 }}>{teamNames[i]}</div>
              <div
                style={{ marginTop: 6, fontSize: 12, color: RM_THEME.faint }}
              >
                {attempted.includes(i) ? "Attempt used" : "BUZZ"}
              </div>
            </button>
          ))}
        </div>
      ...
      <div style={{ marginTop: 14 }}>
        ...
        >
          ...
          <button
            ...
            style={{ ...styles.secondaryBtn, padding: "12px 16px" }}
          >
            Finish Early
          </button>
        </div>
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        ...
        >
          <span style={{ ...styles.badge, ...styles.badgeBlue }}>
            🎛️ {ui.activityNames.facilitator}
          </span>
          <span style={{ ...styles.badge, ...styles.badgeGreen }}>
            {lang === "eg" ? "مناسب للبروجكتور" : "Projector Friendly"}
          </span>
        </div>
        <div style={{ ...styles.pill, gap: 12 }}>
          <span style={{ color: RM_THEME.muted }}>
            {lang === "eg" ? "المؤقّت" : "Timer"}
          </span>
      ...
      <div style={{ textAlign: "center", marginBottom: 18 }}>
        ...
        <div style={{ ...styles.stageTitle, fontSize: 36, marginTop: 8 }}>
          {card.title}
        </div>
        <div style={{ ...styles.stageSubtitle, maxWidth: 920 }}>
          {card.prompt}
        </div>
      </div>
      ...
      {!reveal ? (
        ...
        >
          <button
            ...
            style={{ ...styles.primaryBtn, padding: "16px 30px" }}
          >
            👁️ {lang === "eg" ? "اظهر دليل المُدرّب" : "Reveal Coach Guide"}
          </button>
          <button onClick={next} style={styles.secondaryBtn}>
            {lang === "eg" ? "الكارت اللي بعده →" : "Next Card →"}
          </button>
        </div>
      ) : (
        <div
          style={{
            ...
            border: `1px solid ${RM_THEME.border}`,
            background:
              "linear-gradient(135deg, rgba(0,212,255,0.10), rgba(255,59,59,0.10))",
          }}
        >
          <h3 style={{ marginBottom: 10 }}>
            {lang === "eg" ? "دليل المُدرّب" : "Coach Guide"}
          </h3>
          <div style={{ color: RM_THEME.muted, lineHeight: 1.7 }}>
            <div>
              <strong>{lang === "eg" ? "أ.ب.ج" : "A.B.C"}:</strong>{" "}
              {card.guide.abc.join(" → ")}
            </div>
            <div>
              <strong>{lang === "eg" ? "إشارة الألفة" : "Rapport cue"}:</strong>{" "}
              {card.guide.rapport}
            </div>
            <div>
              <strong>
                {lang === "eg" ? "تذكير التواصل" : "Communication reminder"}:
              </strong>{" "}
              {card.guide.reminder}
            </div>
            <div style={{ marginTop: 8, color: RM_THEME.faint }}>
              {card.guide.note}
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              {lang === "eg" ? "اخفي الدليل" : "Hide Guide"}
            </button>
          </div>
        </div>
      )}
...
const ConsensusClash = ({ onBack, updateScore }) => {
  ...
  const revealNow = () => {
    setReveal(true);
    const correctTeams = Object.values(votes).filter(
      (v) => v === correctIdx,
    ).length;
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        ...
        <div style={{ marginTop: 10, color: RM_THEME.muted, fontSize: 14 }}>
          Each team votes. Then reveal the distribution.
        </div>
      </div>
          ...
          >
            ...
            {choices.map((c, idx) => (
              <button
                ...
                style={{ marginBottom: 10, padding: 14, borderRadius: 14 }}
              >
                {c}
              </button>
            ))}
      ...
      >
        ...
        {!reveal ? (
          ...
          >
            <button onClick={revealNow} style={styles.primaryBtn}>
              Reveal Answer
            </button>
            <button onClick={next} style={styles.secondaryBtn}>
              Next Prompt →
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        ...
        >
          <span style={{ ...styles.badge, ...styles.badgeRed }}>
            🛟 {UI_STRINGS[lang].activityNames.reviewrescue}
          </span>
          <span style={{ ...styles.badge, ...styles.badgeBlue }}>
            {lang === "eg" ? "أضعف النقاط" : "Weak Areas"}
          </span>
        </div>
        <ScorePanel
          score={localScore}
              ...
              >
                {targets.map((target) => (
                  ...
                  >
                    ...
                    <button
                      onClick={() => academyContext?.launchActivity?.(target)}
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        ...
        >
          <span style={{ ...styles.badge, ...styles.badgeGreen }}>
            ⚡ {UI_STRINGS[lang].activityNames.academysprint}
          </span>
          <span style={{ ...styles.badge, ...styles.badgeBlue }}>
            {lang === "eg" ? "ميكس سريع" : "Mixed Pressure Round"}
          </span>
        </div>
        <ScorePanel
          score={localScore}
          ...
          {!isLast ? (
            ...
            <div style={{ textAlign: "center", marginTop: 20 }}>
              ...
              <h3 style={{ marginTop: 10 }}>
                {lang === "eg"
                  ? `خلصت السبرينت! ${localScore} نقطة`
                  : `Sprint complete! ${localScore} points`}
              </h3>
              <p style={{ color: RM_THEME.muted, marginTop: 8 }}>
                {lang === "eg"
                  ? "الجولة دي ممتازة للتسخين أو قبل الامتحان النهائي."
                  : "Use this as a warm-up lap or a sharp pre-exam pressure round."}
              </p>
            </div>
          )}
        </>
      ...
      return [
        {
          ...
          correctIndex: 1,
          explanation:
            "أفضل رد يعترف بالاعتراض ثم يربط السعر بالقيمة/العائد أو بخيارات مناسبة بدل الدفاع أو الإغلاق العدائي.",
        },
        {
          ...
          correctIndex: 2,
          explanation:
            "الرد الأقوى يعترف إن المقارنة منطقية ويعيد قيادة القرار بمعايير تقييم ذكية بدل الدفاع أو الانسحاب.",
        },
        {
          ...
          correctIndex: 1,
          explanation:
            "أفضل رد يفتح استكشاف المعايير الحقيقية وراء الاعتراض بدل الضغط أو التعميم.",
        },
      ];
    }
    ...
    return [
      {
        ...
        correctIndex: 1,
        explanation:
          "The strongest response acknowledges the objection, then reframes around value, ROI, and fit rather than defending or becoming rigid.",
      },
      {
        ...
        correctIndex: 2,
        explanation:
          "The best response validates comparison, then reclaims the conversation by offering decision criteria instead of surrendering control.",
      },
      {
        ...
        correctIndex: 1,
        explanation:
          "The best line explores the underlying criteria behind the objection instead of pushing, generalizing, or withdrawing.",
      },
    ];
  }, [lang]);
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        ...
        >
          <span style={{ ...styles.badge, ...styles.badgeRed }}>
            🥊 {UI_STRINGS[lang].activityNames.objectionduel}
          </span>
          <span style={{ ...styles.badge, ...styles.badgeBlue }}>
            {lang === "eg"
              ? `الجولة لطرف ${roundSide}`
              : `Round for Side ${roundSide}`}
          </span>
        </div>
        <ScorePanel
          score={localScore}
      ...
      <div
        style={{
          ...
          border: `1px solid ${RM_THEME.border}`,
          background:
            "linear-gradient(135deg, rgba(255,59,59,0.12), rgba(0,212,255,0.08))",
          marginBottom: 18,
        }}
      >
        <div
        ...
        <div style={{ marginTop: 10, color: RM_THEME.muted }}>
          {scenario.prompt}
        </div>
      </div>
      ...
      {showFeedback && (
        <>
          <Feedback
            isCorrect={selected === scenario.correctIndex}
            explanation={scenario.explanation}
          />
          {!isLast ? (
            <NextButton
              onClick={next}
              label={lang === "eg" ? "بدّل الدور →" : "Swap Role →"}
            />
          ) : (
            <div
              style={{
...
const CallFlowBuilder = ({ onBack, updateScore }) => {
  ...
  const challenge = useMemo(() => {
    if (lang === "eg") {
      return {
        ...
        explanation:
          "المكالمة القوية تمشي من فتح قوي إلى فهم، ثم تأهيل، ثم ربط بالقيمة، ثم التزام واضح.",
      };
    }
    return {
      ...
      explanation:
        "A strong call moves from opening, to understanding, to qualification, to value linkage, to commitment.",
    };
  }, [lang]);
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        <span style={{ ...styles.badge, ...styles.badgeGreen }}>
          🧭 {UI_STRINGS[lang].activityNames.callflow}
        </span>
        <div style={styles.pill}>
          {lang === "eg" ? "كووتش مود" : "Coach Mode"}
        </div>
      </div>
      ...
      >
        ...
        >
          <h3 style={{ marginBottom: 12 }}>
            {lang === "eg" ? "اختياراتك" : "Your Order"}
          </h3>
          {chosen.length === 0 && (
            <div style={{ color: RM_THEME.muted }}>
              {lang === "eg"
                ? "ابدأ اختار من العمود التاني."
                : "Start picking from the right column."}
            </div>
          )}
          {chosen.map((step, idx) => (
            <div
        ...
        >
          <h3 style={{ marginBottom: 12 }}>
            {lang === "eg" ? "الخطوات المتاحة" : "Available Steps"}
          </h3>
          {available.map((step) => (
            <button
              key={step}
      ...
      >
        <button
          onClick={check}
          disabled={chosen.length !== challenge.steps.length || checked}
          style={styles.primaryBtn}
        >
...
const CoachDebriefConsole = ({ onBack, academyContext }) => {
  ...
  const academyStats = academyContext?.academyStats || {
    playedActivities: 0,
  ...
  const recentAccuracy = recentWindow.length
    ? Math.round(
        (recentWindow.filter((session) => session.isCorrect).length /
          recentWindow.length) *
          100,
      )
    : 0;
  const recentPoints = recentWindow.reduce(
    (sum, session) => sum + session.points,
    0,
  );

  const laneSignals = [...categorySummaries]
    .filter(
      (category) => category.playedCount > 0 || category.activities.length > 0,
    )
    .sort((left, right) => left.mastery - right.mastery)
    .slice(0, 4);

  const recommendedWarmup = recentSessions.length
    ? (academyContext?.activityInsights || []).find(
        (activity) => activity.id === "reviewrescue",
      ) || recommendedActivity
    : (academyContext?.activityInsights || []).find(
        (activity) => activity.id === "academysprint",
      ) || recommendedActivity;
  ...
  return (
    <div style={styles.card} className="animate-fadeIn">
      ...
      >
        ...
        >
          <span style={{ ...styles.badge, ...styles.badgeBlue }}>
            🧑‍🏫 {UI_STRINGS[lang].activityNames.debrief}
          </span>
          <span style={{ ...styles.badge, ...styles.badgeGreen }}>
            {lang === "eg" ? "إدارة الجلسة" : "Session Intelligence"}
          </span>
        </div>
        <div style={styles.pill}>
          {lang === "eg"
            ? `آخر ${recentWindow.length || 0} نتائج`
            : `Last ${recentWindow.length || 0} results`}
        </div>
      </div>

      <div style={{ textAlign: "center", marginBottom: 20 }}>
        <div style={styles.stageTitle}>
          {lang === "eg" ? "ديبريف سريع للمدرب" : "Fast Coach Debrief"}
        </div>
        <div style={styles.stageSubtitle}>
          {lang === "eg"
      ...
      >
        ...
        >
          <h3 style={{ marginBottom: 12 }}>
            {lang === "eg" ? "قرارات سريعة للمدرب" : "Coach Decisions"}
          </h3>
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div>
              ...
              <div
                style={{ color: RM_THEME.muted, fontSize: 13, marginTop: 4 }}
              >
                {recentSessions.length
                  ? lang === "eg"
                    ? "ابدأ بمراجعة واسترجاع سريع قبل التدريب الأعمق."
                    : "Open with a retrieval-based warm-up before deeper coaching."
                  : lang === "eg"
                    ? "ابدأ بجولة baseline سريعة عشان تبني صورة واضحة."
                    : "Open with a baseline sprint to create a clean starting picture."}
              </div>
            </div>
            <div>
              <div
              ...
              >
                {lang === "eg" ? "درّل أساسي" : "Primary Drill"}
              </div>
              <div style={{ fontWeight: 900, marginTop: 4 }}>
                {coachingPriority
                  ? coachingPriority.name
                  : lang === "eg"
                    ? "كروت المُيسّر"
                    : "Facilitator Deck"}
              </div>
            ...
            <div>
              ...
              >
                {lang === "eg" ? "إقفال الجلسة" : "Session Close"}
              </div>
              <div style={{ fontWeight: 900, marginTop: 4 }}>
                {weakestCategory?.suggested
                  ? weakestCategory.suggested.name
                  : recommendedActivity?.name ||
                    (lang === "eg" ? "الامتحان النهائي" : "Final Exam")}
              </div>
              <div
                style={{ color: RM_THEME.muted, fontSize: 13, marginTop: 4 }}
              >
        ...
        >
          <h3 style={{ marginBottom: 12 }}>
            {lang === "eg" ? "إشارات المسارات" : "Lane Signals"}
          </h3>
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div
              style={{
            ...
            >
              <div style={{ color: RM_THEME.faint, fontSize: 12 }}>
                {lang === "eg" ? "أضعف مسار" : "Weakest Lane"}
              </div>
              <div style={{ fontWeight: 900, marginTop: 4 }}>
                {weakestCategory ? weakestCategory.title : "—"}
              </div>
              <div
                style={{ color: RM_THEME.muted, fontSize: 13, marginTop: 4 }}
              >
                {weakestCategory
                  ? `${weakestCategory.mastery}%`
                  : lang === "eg"
                    ? "ابدأ لعب عشان يبان"
                    : "Play to unlock"}
              </div>
            ...
            >
              <div style={{ color: RM_THEME.faint, fontSize: 12 }}>
                {lang === "eg" ? "أقوى مسار" : "Strongest Lane"}
              </div>
              <div style={{ fontWeight: 900, marginTop: 4 }}>
                {strongestCategory ? strongestCategory.title : "—"}
              </div>
              <div
                style={{ color: RM_THEME.muted, fontSize: 13, marginTop: 4 }}
              >
                {strongestCategory
                  ? `${strongestCategory.mastery}%`
                  : lang === "eg"
                    ? "مفيش baseline لسه"
                    : "No baseline yet"}
              </div>
      ...
      >
        ...
        >
          <h3>
            {lang === "eg" ? "Heatmap سريع للمسارات" : "Quick Lane Heatmap"}
          </h3>
          <span style={{ color: RM_THEME.faint, fontSize: 12 }}>
            {lang === "eg" ? "من الأقل للأعلى" : "Lowest to highest"}
          </span>
        </div>
        <div
          style={{
            ...
            >
              ...
              >
                ...
                <span
                  style={{
                    color:
                      category.mastery < 72 ? RM_THEME.red : RM_THEME.green,
                    fontWeight: 800,
                  }}
                >
                  {category.mastery}%
          ...
          {recentWindow.map((session) => (
            ...
            >
              ...
              >
                ...
                <span
                  style={{
                    color: session.isCorrect ? RM_THEME.green : RM_THEME.red,
                    fontWeight: 800,
                  }}
                >
                  {session.isCorrect ? "+" : ""}
      ...
      >
        {recommendedWarmup && (
          <button
            onClick={() => academyContext?.launchActivity?.(recommendedWarmup)}
            style={styles.primaryBtn}
          >
        ...
        {coachingPriority && (
          <button
            onClick={() => academyContext?.launchActivity?.(coachingPriority)}
            style={styles.secondaryBtn}
          >
        ...
        {weakestCategory?.suggested && (
          <button
            onClick={() =>
              academyContext?.launchActivity?.(weakestCategory.suggested)
            }
            style={styles.secondaryBtn}
          >
...
const formatLastPlayed = (lang, timestamp) => {
  ...
  if (diffHours < 24)
    return lang === "eg" ? `من ${diffHours} س` : `${diffHours}h ago`;
  if (diffDays < 7)
    return lang === "eg" ? `من ${diffDays} يوم` : `${diffDays}d ago`;
...
const CLIENT_MATCH_DATA = [
  {
    id: 1,
    name: { en: "The El-Sayed Family", eg: "عيلة السيد" },
    emoji: "👨‍👩‍👧‍👦",
    profile: {
      en: "Budget: 3M EGP • Family of 5 • Wants garden & privacy",
      eg: "ميزانية: ٣م • عيلة ٥ أفراد • عايزين جنينة وخصوصية",
    },
    bestMatch: "Twin House",
    reason: {
      en: "Shared wall saves cost, private garden, family-sized",
      eg: "حيط مشترك بيوفّر في التكلفة وفيها جنينة",
    },
    options: ["Twin House", "Penthouse", "Studio", "Admin"],
  },
  {
    id: 2,
    name: { en: "Eng. Ramy", eg: "م. رامي" },
    emoji: "👨‍💼",
    profile: {
      en: "Budget: 800K EGP • Single • Investment-focused, wants rental income",
      eg: "ميزانية: ٨٠٠ك • أعزب • استثمار، عايز إيجار",
    },
    bestMatch: "Studio",
    reason: {
      en: "Low cost, high rental demand, easy to manage",
      eg: "سعر منخفض، طلب إيجار عالي، سهل التأجير",
    },
    options: ["Studio", "Stand Alone", "Town House", "Twin House"],
  },
  {
    id: 3,
    name: { en: "Dr. Hana", eg: "د. هنا" },
    emoji: "👩‍⚕️",
    profile: {
      en: "Budget: 5M EGP+ • Professional • Wants luxury & top-floor prestige",
      eg: "ميزانية: +٥م • متخصصة • عايزة فخامة وبريستيج",
    },
    bestMatch: "Penthouse",
    reason: {
      en: "Top floor luxury, prestige views, matches professional image",
      eg: "أعلى دور بتشطيب فاخر، يناسب شخصية بروفيشنال",
    },
    options: ["Penthouse", "Apartment", "Studio", "Duplex"],
  },
  {
    id: 4,
    name: { en: "Mr. Karim", eg: "أ. كريم" },
    emoji: "🧔",
    profile: {
      en: "Budget: 2.5M EGP • Couple • Wants two-floor layout for privacy",
      eg: "ميزانية: ٢.٥م • محتاج شقة على دورين لفراغات منفصلة",
    },
    bestMatch: "Duplex",
    reason: {
      en: "Two-level living with internal staircase, unique layout",
      eg: "حياة على دورين بسلم داخلي، تصميم مختلف",
    },
    options: ["Duplex", "Town House", "Studio", "Admin"],
  },
  {
    id: 5,
    name: { en: "Startup Office", eg: "مكاتب ستارت-أب" },
    emoji: "🏢",
    profile: {
      en: "Commercial • Needs offices for 20 staff, branding important",
      eg: "تجاري • مكاتب لـ٢٠ موظف والبراند مهم",
    },
    bestMatch: "Admin",
    reason: {
      en: "Administrative offices, professional image for corporate use",
      eg: "وحدات إدارية، صورة احترافية للشركة",
    },
    options: ["Admin", "Studio", "Penthouse", "Apartment"],
  },
  {
    id: 6,
    name: { en: "Osama & Family", eg: "أسامة وعيلته" },
    emoji: "👪",
    profile: {
      en: "Budget: 4M EGP • Family of 3 • Row home in compound, community feel",
      eg: "ميزانية: ٤م • يريد بيت في صف ضمن كمباوند",
    },
    bestMatch: "Town House",
    reason: {
      en: "Row home in compound, community-oriented, multi-story",
      eg: "تاون هاوس في كمباوند، كوميونيتي، أدوار متعددة",
    },
    options: ["Town House", "Penthouse", "Studio", "Duplex"],
  },
  {
    id: 7,
    name: { en: "Retail Brand X", eg: "براند تجاري X" },
    emoji: "🛍️",
    profile: {
      en: "Commercial • Storefront on ground floor, high foot traffic",
      eg: "تجاري • واجهة محل في دور أرضي بمرور عالي",
    },
    bestMatch: "Shops",
    reason: {
      en: "Ground floor shop with high street visibility",
      eg: "محل أرضي مرئية عالية ومرور ناس كتير",
    },
    options: ["Shops", "Admin", "Apartment", "Stand Alone"],
  },
  {
    id: 8,
    name: { en: "Newlyweds", eg: "العرسان الجدد" },
    emoji: "💑",
    profile: {
      en: "Budget: 1.5M EGP • Couple, first home, small & cozy",
      eg: "ميزانية: ١.٥م • عرسان جدد، أول بيت صغير ومريح",
    },
    bestMatch: "Apartment",
    reason: {
      en: "Standard apartment, right size for two, affordable entry",
      eg: "شقة عادية، مناسبة لاثنين، مدخل معقول في السعر",
    },
    options: ["Apartment", "Stand Alone", "Twin House", "Penthouse"],
  },
  {
    id: 9,
    name: { en: "Mr. Hassan", eg: "أ. حسن" },
    emoji: "🤵",
    profile: {
      en: "Budget: 8M EGP+ • Wealthy • Max privacy, large plot, no shared walls",
      eg: "ميزانية: +٨م • عايز خصوصية قصوى وأرض كبيرة",
    },
    bestMatch: "Stand Alone",
    reason: {
      en: "Standalone villa on own plot, no neighbors on any side",
      eg: "فيلا مستقلة على قطعة أرض خاصة كاملة",
    },
    options: ["Stand Alone", "Twin House", "Town House", "Penthouse"],
  },
  {
    id: 10,
    name: { en: "Medical Center", eg: "مركز طبي" },
    emoji: "🏥",
    profile: {
      en: "Commercial • Clinic space, regulated, accessible location",
      eg: "تجاري • عيادة أو مركز طبي، موقع سهل الوصول",
    },
    bestMatch: "Medical",
    reason: {
      en: "Medical unit designed for clinics and health centers",
      eg: "وحدة طبية مصممة للعيادات والمراكز الصحية",
    },
    options: ["Medical", "Admin", "Studio", "Shops"],
  },
];
...
const ClientMatch = ({ onBack, updateScore }) => {
    ...
    return (
      ...
      >
        ...
        <h2 style={{ fontSize: 28, marginBottom: 10 }}>
          {lang === "eg" ? "خلصت اللعبة!" : "Game Complete!"}
        </h2>
        <div
          style={{
            fontSize: 48,
        ...
        >
          {correct}/{CLIENT_MATCH_DATA.length}
        </div>
        <p style={{ color: RM_THEME.muted, marginBottom: 24, fontSize: 15 }}>
          {lang === "eg" ? `مجموع النقط: ${pts}` : `Total Score: ${pts}`}
        </p>
        <p
          style={{
            color: RM_THEME.muted,
        ...
        >
          {pct >= 80
            ? lang === "eg"
              ? "ممتاز! فاهم احتياجات العميل كويس."
              : "Excellent! You nail client-to-unit matching."
            : pct >= 60
              ? lang === "eg"
                ? "كويس، بس راجع أنواع الوحدات التجارية."
                : "Good — review commercial unit types."
              : lang === "eg"
                ? "راجع أنواع الوحدات وتعريفاتها."
                : "Review unit types and their definitions."}
        </p>
        <div
          style={{
            display: "flex",
  ...
  return (
    <div
      className="animate-fadeIn"
      style={{ maxWidth: 560, margin: "0 auto", padding: "0 16px 60px" }}
    >
      <div
        style={{
          display: "flex",
      ...
      >
        <button
          onClick={onBack}
          style={{ ...styles.secondaryBtn, padding: "8px 14px", fontSize: 13 }}
        >
          ← {lang === "eg" ? "رجوع" : "Back"}
        </button>
        <div style={{ display: "flex", gap: 14, alignItems: "center" }}>
          <span
            style={{ color: RM_THEME.amber, fontWeight: 800, fontSize: 14 }}
          >
            {lang === "eg"
              ? `جولة ${round + 1}/${CLIENT_MATCH_DATA.length}`
              : `Round ${round + 1}/${CLIENT_MATCH_DATA.length}`}
          </span>
      ...
      >
        ...
        <h2 style={{ fontSize: 20, marginBottom: 8 }}>
          {lang === "eg" ? cur.name.eg : cur.name.en}
        </h2>
        <p style={{ color: RM_THEME.muted, fontSize: 14, lineHeight: 1.6 }}>
          {lang === "eg" ? cur.profile.eg : cur.profile.en}
        </p>
        <div
          style={{
            marginTop: 14,
        ...
        >
          <span
            style={{ color: RM_THEME.amber, fontWeight: 800, fontSize: 13 }}
          >
            ⏱ {timeLeft}s
          </span>
        </div>
      ...
      >
        {lang === "eg"
          ? "👇 اختار أنسب نوع وحدة لهذا العميل"
          : "👇 Pick the best unit type for this client"}
      </p>
      <div
        style={{
          display: "grid",
      ...
      >
        {opts.map((opt) => {
          const isCor = opt === cur.bestMatch,
            isSel = opt === selected;
          let bg = "rgba(255,255,255,0.05)",
            border = RM_THEME.border;
          if (feedback) {
            if (isCor) {
              bg = "rgba(80,250,123,0.12)";
              border = RM_THEME.green;
            } else if (isSel && !isCor) {
      ...
      {feedback && (
        <div
          ...
          style={{
            ...
            border: `1px solid ${feedback.correct ? RM_THEME.green : "#f56565"}`,
          }}
        >
          <div style={{ fontWeight: 800, fontSize: 16, marginBottom: 6 }}>
            {feedback.timeout
              ...
              : feedback.correct
                ? lang === "eg"
                  ? `✅ صح! +${feedback.award}`
                  : `✅ Correct! +${feedback.award} pts`
                : lang === "eg"
                  ? "❌ غلط!"
                  : "❌ Wrong!"}
          </div>
          <p style={{ color: RM_THEME.muted, fontSize: 13, lineHeight: 1.5 }}>
            <strong>{lang === "eg" ? "الأنسب: " : "Best match: "}</strong>
            {cur.bestMatch} — {lang === "eg" ? cur.reason.eg : cur.reason.en}
          </p>
          <button
            onClick={next}
            style={{
          ...
          >
            {round + 1 >= CLIENT_MATCH_DATA.length
              ? lang === "eg"
                ? "شوف النتيجة"
                : "Results"
              : lang === "eg"
...
const OBJECTION_BLITZ_DATA = [
  {
    obj: { en: "The price is too expensive!", eg: "غالي جداً!" },
    opts: {
      en: [
        {
          t: "I understand. Let me show you the payment plan — 10% down over 7 years. Could that work?",
          c: true,
        },
        { t: "It's not that expensive for this area.", c: false },
        { t: "Maybe look at smaller units if budget is tight.", c: false },
      ],
      eg: [
        {
          t: "أنا فاهم. خليني أوريلك خطة التقسيط — ١٠٪ مقدم على ٧ سنين. يناسبك؟",
          c: true,
        },
        { t: "مش غالي على المنطقة دي.", c: false },
        { t: "ممكن تبص على وحدات أصغر لو الميزانية ضيقة.", c: false },
      ],
    },
  },
  {
    obj: { en: "I need to think about it.", eg: "محتاج أفكر." },
    opts: {
      en: [
        {
          t: "Absolutely. FYI there are 2 other buyers interested. Want to reserve it and decide in 48h?",
          c: true,
        },
        { t: "Take your time, call me whenever.", c: false },
        { t: "What exactly do you need to think about?", c: false },
      ],
      eg: [
        {
          t: "طبعاً. على علمك فيه مشترين تانيين. تحجزها وتفكر ٤٨ ساعة؟",
          c: true,
        },
        { t: "تمام، خد وقتك وكلمني.", c: false },
        { t: "في إيه بالذات هتفكر فيه؟", c: false },
      ],
    },
  },
  {
    obj: { en: "The location isn't convenient.", eg: "الموقع مش مناسب." },
    opts: {
      en: [
        {
          t: "I hear you. Which area works best for you? I may have options there, or we can review the commute.",
          c: true,
        },
        {
          t: "The location is actually great, all amenities are close.",
          c: false,
        },
        {
          t: "Many clients felt that at first but ended up loving it.",
          c: false,
        },
      ],
      eg: [
        {
          t: "فاهم. أنهي منطقة أنسب؟ ممكن يكون عندي بديل أو نشوف خط السير مع بعض.",
          c: true,
        },
        { t: "الموقع في الحقيقة ممتاز، كل حاجة قريبة.", c: false },
        { t: "كتير عملاء أحسوا كده في الأول وبعدين حبّوه.", c: false },
      ],
    },
  },
  {
    obj: {
      en: "I want to see it finished before buying.",
      eg: "عايز أشوفه خلص أول.",
    },
    opts: {
      en: [
        {
          t: "Valid concern. Buying now locks in today's price — by delivery it'll be 30-40% higher. Want to see the model unit?",
          c: true,
        },
        { t: "We can't guarantee what it'll look like finished.", c: false },
        { t: "Most investors buy off-plan, it's normal.", c: false },
      ],
      eg: [
        {
          t: "قلقك منطقي. الشراء دلوقتي يقفل سعر اليوم — لما يخلص السعر هيعلى ٣٠-٤٠٪. تيجي تشوف وحدة نموذج؟",
          c: true,
        },
        { t: "ما نقدرش نضمن هيبقى إزاي لما يخلص.", c: false },
        { t: "معظم المستثمرين بيشتروا أوف-بلان، ده طبيعي.", c: false },
      ],
    },
  },
  {
    obj: {
      en: "Your competitor has a lower price.",
      eg: "المنافس عنده سعر أرخص.",
    },
    opts: {
      en: [
        {
          t: "Good point. Let's compare finishing spec, developer track record, and facilities — price alone doesn't tell the full story.",
          c: true,
        },
        { t: "Their quality honestly isn't as good as ours.", c: false },
        { t: "If it's cheaper maybe it's better for you.", c: false },
      ],
      eg: [
        {
          t: "نقطة كويسة. بس خليني أريلك الفرق في التشطيب وسمعة المطوّر والمرافق. السعر وحده مش بيقول الحكاية كلها.",
          c: true,
        },
        { t: "جودتهم مش بالمستوى ده بصراحة.", c: false },
        { t: "لو أرخص يمكن يكون الأنسب ليك.", c: false },
      ],
    },
  },
  {
    obj: { en: "I don't have cash right now.", eg: "مش عندي كاش دلوقتي." },
    opts: {
      en: [
        {
          t: "No problem at all — most clients use installment plans. With just 10% down you secure the unit. Want me to walk you through it?",
          c: true,
        },
        { t: "You'll need at least some cash to proceed.", c: false },
        { t: "We have mortgage options but they're complicated.", c: false },
      ],
      eg: [
        {
          t: "مفيش مشكلة، معظم عملائنا بيشتروا بالتقسيط. بـ١٠٪ بس تضمن الوحدة. أشرحلك الخطة؟",
          c: true,
        },
        { t: "هتحتاج شوية كاش على الأقل.", c: false },
        { t: "عندنا تمويل بنكي بس معقد شوية.", c: false },
      ],
    },
  },
  {
    obj: { en: "Is the developer trustworthy?", eg: "المطوّر موثوق؟" },
    opts: {
      en: [
        {
          t: "Great question. They've delivered 12 projects on time in 20 years. Want to visit a completed project nearby?",
          c: true,
        },
        { t: "Yes, they're one of the best, everyone knows them.", c: false },
        { t: "I personally vouch for them, don't worry.", c: false },
      ],
      eg: [
        {
          t: "سؤال ممتاز. سلّموا ١٢ مشروع في مواعيدهم على ٢٠ سنة. تيجي تزور مشروع جاهز قريب؟",
          c: true,
        },
        { t: "آه من أحسن الناس، كلهم يعرفوهم.", c: false },
        { t: "أنا شخصيًا بضمنهم، متقلقش.", c: false },
      ],
    },
  },
  {
    obj: {
      en: "I want my family involved before deciding.",
      eg: "عايز أشرك عيلتي الأول.",
    },
    opts: {
      en: [
        {
          t: "Absolutely — family decisions are the most important. Can we schedule a meeting with them this week?",
          c: true,
        },
        { t: "It's a great deal, your family will love it.", c: false },
        {
          t: "Most investment decisions are individual, you can tell them later.",
          c: false,
        },
      ],
      eg: [
        {
          t: "طبعاً قرارات العيلة هي الأهم. نعمل موعد معاهم الأسبوع ده؟",
          c: true,
        },
        { t: "فرصة رائعة عيلتك هتحبها.", c: false },
        { t: "القرارات دي عادةً فردية، تقدر تقولهم بعدين.", c: false },
      ],
    },
  },
  {
    obj: { en: "The finishing quality looks weak.", eg: "التشطيب يبان ضعيف." },
    opts: {
      en: [
        {
          t: "Your observation matters. Let me show you the exact specs — brands used, material grade, and warranty. Want to visit a delivered unit?",
          c: true,
        },
        { t: "It's standard for this price range.", c: false },
        { t: "The price reflects the finishing quality.", c: false },
      ],
      eg: [
        {
          t: "ملاحظتك مهمة. خليني أوريلك المواصفات الدقيقة — الماركات والخامات والضمان. تيجي تزور وحدة مسلمة؟",
          c: true,
        },
        { t: "ده طبيعي للسعر ده.", c: false },
        { t: "السعر بيعكس مستوى التشطيب.", c: false },
      ],
    },
  },
  {
    obj: { en: "I'll wait for prices to drop.", eg: "هستنى الأسعار ترخص." },
    opts: {
      en: [
        {
          t: "I understand. But in Egypt's market prices have risen 25-35% annually for years. Waiting typically costs more — want to see the price history?",
          c: true,
        },
        { t: "Prices might drop, it's possible.", c: false },
        {
          t: "That's your choice, let me know if you change your mind.",
          c: false,
        },
      ],
      eg: [
        {
          t: "فاهم المنطق. بس في سوق مصر أسعار ترتفع ٢٥-٣٥٪ سنويًا. الانتظار عادةً بيكلف أكتر — تشوف تاريخ الأسعار؟",
          c: true,
        },
        { t: "ممكن ترخص، محتمل.", c: false },
        { t: "ده قرارك، كلمني لو غيّرت رأيك.", c: false },
      ],
    },
  },
  {
    obj: { en: "The unit is too small.", eg: "الوحدة صغيرة." },
    opts: {
      en: [
        {
          t: "Tell me more — what size do you actually need and how many rooms? I want to show you the right options.",
          c: true,
        },
        { t: "It's the standard size for this tower.", c: false },
        { t: "Small spaces can feel bigger with good design.", c: false },
      ],
      eg: [
        {
          t: "قولي أكتر — إيه المساحة اللي محتاجها وكام أوضة؟ عايز أوريلك الأنسب.",
          c: true,
        },
        { t: "دي المساحة المعيارية للبرج ده.", c: false },
        { t: "المساحات الصغيرة ممكن تتصمم تحس فيها بالاتساع.", c: false },
      ],
    },
  },
  {
    ...
    opts: {
      en: [
        {
          t: "That's completely fine. What would help you feel ready — is there missing info, or shall I follow up when you've had time?",
          c: true,
        },
        { t: "We have a limited offer today only.", c: false },
        { t: "What's stopping you from deciding now?", c: false },
      ],
      eg: [
        {
          t: "ده تمام. إيه اللي هيخليك جاهز — في معلومة ناقصة ولا نتابع بعد ما تفكر؟",
          c: true,
        },
        { t: "عندنا عرض محدود النهارده بس.", c: false },
        { t: "إيه اللي بيمنعك تقرر دلوقتي؟", c: false },
      ],
    },
  },
];
...
const ObjectionBlitz = ({ onBack, updateScore }) => {
  ...
  if (gameOver) {
    ...
    return (
      ...
      >
        ...
        <h2 style={{ fontSize: 28, marginBottom: 10 }}>
          {lang === "eg" ? "انتهت الجولات!" : "All Rounds Done!"}
        </h2>
        <div
          style={{
            fontSize: 48,
        ...
        >
          {correct}/{OBJECTION_BLITZ_DATA.length}
        </div>
        <p style={{ color: RM_THEME.muted, marginBottom: 28, fontSize: 15 }}>
          {lang === "eg" ? `نقط: ${score}` : `Score: ${score}`} • {pct}%
        </p>
        <p
          style={{
            color: RM_THEME.muted,
        ...
        >
          {pct >= 80
            ? lang === "eg"
              ? "محترف في رد الاعتراضات! أ.ب.ج في دمك."
              : "Objection pro! A.B.C. is in your blood."
            : lang === "eg"
              ? "راجع تقنية أ.ب.ج وردود الاعتراضات."
              : "Review A.B.C. objection handling technique."}
        </p>
        <div
          style={{
            display: "flex",
  ...
  return (
    <div
      className="animate-fadeIn"
      style={{ maxWidth: 600, margin: "0 auto", padding: "0 16px 60px" }}
    >
      <div
        style={{
          display: "flex",
      ...
      >
        ...
        >
          {streak >= 2 && (
            <span style={{ color: RM_THEME.amber, fontWeight: 800 }}>
              🔥 ×{streak}
            </span>
          )}
          <span style={{ fontWeight: 800, fontSize: 14 }}>
            {lang === "eg"
              ? `${round + 1}/${OBJECTION_BLITZ_DATA.length} جولة`
              : `${round + 1}/${OBJECTION_BLITZ_DATA.length}`}
          </span>
      ...
      <div
        style={{
          ...
          background:
            "linear-gradient(135deg, rgba(245,101,101,0.1), rgba(245,101,101,0.04))",
        }}
      >
        ...
        <h2 style={{ fontSize: 22, lineHeight: 1.4, fontWeight: 900 }}>
          "{lang === "eg" ? cur.obj.eg : cur.obj.en}"
        </h2>
        <div style={{ marginTop: 12, color: RM_THEME.amber, fontWeight: 800 }}>
          ⏱ {timeLeft}s
        </div>
      </div>
      <p
      ...
      >
        {lang === "eg"
          ? "👇 اختار أفضل رد باستخدام أ.ب.ج"
          : "👇 Pick the best A.B.C. response"}
      </p>
      <div
        style={{
          display: "flex",
      ...
      {feedback && (
        ...
        >
          <div style={{ fontWeight: 800, marginBottom: 8 }}>
            {feedback.timeout
              ...
              : feedback.correct
                ? lang === "eg"
                  ? `✅ صح! +${feedback.award}`
                  : `✅ Great! +${feedback.award} pts`
                : lang === "eg"
                  ? "❌ مش الأفضل."
                  : "❌ Not the best approach."}
            {feedback.correct && feedback.newStreak >= 2 && (
              <span style={{ color: RM_THEME.amber, marginLeft: 10 }}>
                🔥×{feedback.newStreak}
              </span>
            )}
          </div>
          <button
            onClick={next}
            style={{ ...styles.primaryBtn, padding: "10px 18px", fontSize: 14 }}
          >
            {round + 1 >= OBJECTION_BLITZ_DATA.length
              ? lang === "eg"
                ? "النتائج"
...
const PQ_NODES = {
  start: {
    scene: {
      en: "📞 Your phone rings. Hot lead — Mr. Naser, referred by a colleague. He's looking for a unit in the New Capital. This is your shot.",
      eg: "📞 موبايلك يرن. ليد حلو — أ. ناصر، جاي بتوصية. بيدور على وحدة في العاصمة الإدارية. دي فرصتك.",
    },
    choices: [
      {
        en: "Start with small talk to build rapport first",
        eg: "ابدأ بكلام خفيف لتبني ألفة أول",
        next: "qualify_warm",
        interest: +10,
        pts: 15,
        c: true,
      ...
      {
        en: "Jump straight into pitching your best project",
        eg: "اتكلم مباشرة عن أحسن مشروع عندك",
        next: "qualify_cold",
        interest: -10,
        pts: 0,
        c: false,
      ...
      {
        en: "Ask immediately for a budget figure",
        eg: "اسأل على الميزانية على طول",
        next: "qualify_budget_early",
        interest: -5,
        pts: 5,
        c: false,
      },
  ...
  qualify_warm: {
    scene: {
      en: "Mr. Naser relaxes. He's been looking 6 months and is frustrated. You have his attention. Qualify him now.",
      eg: "أ. ناصر استرخى. بيدور من ٦ شهور وزهق. عنده انتباهك. كوّالفيه دلوقتي.",
    },
    choices: [
      {
        en: '"What\'s driving your search — investment or to live in it?"',
        eg: '"إيه اللي بيقودك — استثمار ولا سكن مع عيلتك؟"',
        next: "present",
        interest: +15,
        pts: 20,
        c: true,
      ...
      {
        en: '"How much exactly is your budget?"',
        eg: '"كام بالظبط ميزانيتك؟"',
        next: "present_budget",
        interest: +0,
        pts: 8,
        c: false,
      ...
      {
        en: '"Have you seen other projects before?"',
        eg: '"اتفرجت على مشاريع تانية قبل كده؟"',
        next: "present",
        interest: +5,
        pts: 10,
        c: false,
  ...
  qualify_cold: {
    scene: {
      en: 'Mr. Naser sounds put off. "Wait — what exactly are you offering?" You\'ve lost ground. Recover fast.',
      eg: 'أ. ناصر مش مبسوط. "استنى — إيه بالظبط اللي بتعرضه؟" خسرت شوية. تعافى.',
    },
    choices: [
      {
        en: "Apologize and ask about his needs first",
        eg: "اعتذر واسأل عن احتياجاته قبل أي حاجة",
        next: "present",
        interest: +5,
        pts: 10,
        c: true,
      ...
      {
        en: 'Continue pitching — "It\'s the best in the capital!"',
        eg: 'كمّل البيتش — "ده الأحسن في العاصمة!"',
        next: "objection",
        interest: -15,
        pts: 0,
        c: false,
  ...
  qualify_budget_early: {
    scene: {
      en: "He pauses. \"Why do you need that first? Can't you show me options without a number?\" He's defensive.",
      eg: 'وقف. "ليه محتاجها الأول؟ مش تقدر توريني خيارات بدون رقم؟" عنده دفاعية.',
    },
    choices: [
      {
        en: '"Of course! Tell me — investment or own use?"',
        eg: '"طبعاً! قولي — استثمار ولا استخدام شخصي؟"',
        next: "present",
        interest: +5,
        pts: 12,
        c: true,
      ...
      {
        en: 'Press again: "I just need a rough budget range"',
        eg: 'اضغط تاني: "محتاج بس رنج تقريبي"',
        next: "objection",
        interest: -20,
        pts: 0,
        c: false,
  ...
  present_budget: {
    scene: {
      en: "He gives a range. You present 3 units by budget only. He listens politely but seems unmoved. You missed his real motivation.",
      eg: "أعطالك رنج. عرضت ٣ وحدات بناءً على الميزانية بس. بيسمعك بأدب بس مش مندفع. تجاهلت دوافعه الحقيقية.",
    },
    choices: [
      {
        en: '"Before we continue — investment or for you to live in?"',
        eg: '"قبل ما نكمل — استثمار ولا سكن شخصي؟"',
        next: "objection",
        interest: +10,
        pts: 15,
        c: true,
      ...
      {
        en: "Continue detailing all the units anyway",
        eg: "كمّل تفاصيل الوحدات على أي حال",
        next: "objection",
        interest: -5,
        pts: 0,
        c: false,
  ...
  present: {
    scene: {
      en: "He's investment-focused, budget 3-5M EGP. You have: Studio (high ROI, low entry) vs Twin House (lifestyle, medium ROI). Which do you lead with?",
      eg: "هدفه استثمار، ميزانية ٣-٥م. عندك: استوديو (عائد عالي، سعر أقل) أو توين هاوس (لايف ستايل، عائد معتدل). بتبدأ بإيه؟",
    },
    choices: [
      {
        en: 'Present the Studio — "High rental yield, your money works from day one"',
        eg: 'اعرض الاستوديو — "عائد إيجاري عالي، فلوسك تشتغل من اليوم الأول"',
        next: "objection",
        interest: +20,
        pts: 25,
        c: true,
      ...
      {
        en: 'Present the Twin House — "Great family lifestyle with private garden"',
        eg: 'اعرض التوين هاوس — "لايف ستايل عيلي رائع بجنينة خاصة"',
        next: "objection",
        interest: -5,
        pts: 5,
        c: false,
      ...
      {
        en: "Present both equally without a clear recommendation",
        eg: "اعرض الاتنين بدون توصية واضحة",
        next: "objection",
        interest: +5,
        pts: 10,
        c: false,
  ...
  objection: {
    scene: {
      en: '"The Studio is interesting but the price per sqm seems high vs other compounds I\'ve seen."',
      eg: '"الاستوديو مثير للاهتمام بس سعر المتر عالي مقارنة بكمباوندات تانية شوفتها."',
    },
    choices: [
      {
        en: '"Great point. Let me show you the 5-year ROI — this compound delivers 18% annually. The price is the entry, the return is the game."',
        eg: '"نقطة ممتازة. خليني أوريلك العائد على ٥ سنين — الكمباوند ده بيوصل ١٨٪ سنويًا. السعر هو المدخل، العائد هو اللعبة."',
        next: "close",
        interest: +20,
        pts: 30,
        c: true,
      ...
      {
        en: '"The other compounds don\'t have our facilities or track record."',
        eg: '"الكمباوندات التانية ملهاش مرافقنا ولا سمعتنا."',
        next: "close",
        interest: -5,
        pts: 5,
        c: false,
      ...
      {
        en: '"Let me try to get you a small discount."',
        eg: '"هحاول أجبلك خصم صغير."',
        next: "close",
        interest: +5,
        pts: 8,
        c: false,
  ...
  close: {
    scene: {
      en: 'Mr. Naser is intrigued. "Okay, I like the numbers. What do I need to do to reserve it?" This is THE moment.',
      eg: 'أ. ناصر مهتم. "تمام، يعجبني الأرقام. إيه اللي محتاج أعمله عشان أحجز؟" دي اللحظة.',
    },
    choices: [
      {
        en: '"Just 1% token — 50K EGP — to lock this price today. I\'ll send the contract now. Shall I?"',
        eg: '"بس ١٪ حجز — ٥٠ ألف — تقفل السعر النهارده. هبعتلك العقد دلوقتي. تمام؟"',
        next: "win",
        interest: +25,
        pts: 40,
        c: true,
      ...
      {
        en: "Explain all the paperwork in detail before asking for a decision",
        eg: "اشرح كل الأوراق بالتفصيل قبل ما تطلب قرار",
        next: "partial",
        interest: -10,
        pts: 10,
        c: false,
      ...
      {
        en: '"Take your time, call me when you\'re ready."',
        eg: '"خد وقتك، كلمني لما تبقى جاهز."',
        next: "lose",
        interest: -30,
        pts: 0,
        c: false,
  ...
  win: {
    scene: {
      en: "🏆 Mr. Naser says YES. Deal closed! He transfers the token that evening. Your manager congratulates you. Perfect sales call.",
      eg: "🏆 أ. ناصر قال آه! صفقة مقفولة! حوّل المقدم المساء. مديرك بيبارك عليك. كول مثالي!",
    },
    choices: [],
    ending: "win",
  },
  partial: {
    scene: {
      en: "⭐ Mr. Naser says he'll 'think about it.' He never calls back. You got close but didn't close with confidence.",
      eg: "⭐ أ. ناصر قال هيفكر. وما رجعش يكلمك. اقتربت بس ما أغلقتش بثقة.",
    },
    choices: [],
    ending: "partial",
  },
  lose: {
    scene: {
      en: "📉 Mr. Naser went with another broker who called him the next day and closed confidently. You missed it.",
      eg: "📉 أ. ناصر راح مع بروكر تاني اتصل بيه النهارده التالي وأغلق بثقة. فاتتك الصفقة.",
    },
    choices: [],
    ending: "lose",
  },
...
const PropertyQuest = ({ onBack, updateScore }) => {
  ...
  const handleChoice = (choice) => {
    const newInterest = Math.min(
      100,
      Math.max(0, interest + (choice.interest || 0)),
    );
  ...
  const endings = {
    win: {
      ...
      title: { en: "Deal Closed!", eg: "صفقة مقفولة!" },
      tip: {
        en: "You built rapport, qualified well, matched the right unit, and handled objections like a pro — that's how deals close!",
        eg: "بنيت ألفة، كوّالفيت صح، عارضت الأنسب، وردّيت على الاعتراض باحتراف — هكذا تتقفل الصفقات!",
      },
    },
    partial: {
      emoji: "⭐",
      color: RM_THEME.amber,
      title: { en: "So Close...", eg: "اقتربت..." },
      tip: {
        en: "Your approach was solid but you didn't close with confidence. Practice assertive closing and A.B.C.",
        eg: "خطواتك كانت كويسة بس ما أغلقتش بثقة. تمرّن على الإغلاق الحازم وأ.ب.ج.",
      },
    },
    lose: {
      emoji: "📉",
      color: "#f56565",
      title: { en: "Missed It", eg: "فاتت الصفقة" },
      tip: {
        en: "Review rapport-building, client-need qualification, and closing technique.",
        eg: "راجع بناء الثقة، تحديد احتياج العميل، وأسلوب الإغلاق.",
      },
    },
    lost: {
      emoji: "📵",
      color: "#f56565",
      title: { en: "Client Hung Up!", eg: "العميل قطع!" },
      tip: {
        en: "The client lost interest — work on rapport and pacing before pressing.",
        eg: "العميل فقد الاهتمام — اشتغل على الألفة والتدرّج قبل الضغط.",
      },
    },
  };
  ...
  if (gameOver) {
    ...
    return (
      ...
      >
        ...
        <h2 style={{ fontSize: 28, marginBottom: 8, color: ed.color }}>
          {lang === "eg" ? ed.title.eg : ed.title.en}
        </h2>
        {curNode && (
          <p
            style={{
          ...
          >
            {lang === "eg" ? curNode.scene.eg : curNode.scene.en}
          </p>
        )}
        <div
          style={{
  ...
  return (
    <div
      className="animate-fadeIn"
      style={{ maxWidth: 580, margin: "0 auto", padding: "0 16px 60px" }}
    >
      <div
        style={{
          display: "flex",
      ...
      >
        ...
        <span style={{ fontWeight: 800, fontSize: 13, color: RM_THEME.muted }}>
          {lang === "eg" ? `+${totalPts} نقطة` : `+${totalPts} pts`}
        </span>
      </div>
      <div
        style={{
      ...
      >
        ...
        >
          <span style={{ color: RM_THEME.muted, fontWeight: 700 }}>
            {lang === "eg" ? "📊 اهتمام العميل" : "📊 Client Interest"}
          </span>
          <span style={{ fontWeight: 900, color: interestColor }}>
            {interest}%
          </span>
        </div>
        <div style={{ ...styles.progressBar }}>
          <div
            style={{
              ...styles.progressFill,
              width: `${interest}%`,
              background: `linear-gradient(90deg, ${interestColor}, ${interestColor}88)`,
        ...
        {interest < 30 && (
          ...
          >
            ⚠️{" "}
            {lang === "eg"
              ? "أوشكت على خسارة العميل!"
              : "Losing the client — choose wisely!"}
          </p>
        )}
      </div>
      <div
      ...
      >
        ...
        >
          ...
          >
            {lang === "eg" ? "المشهد" : "Scene"}
          </span>
        </div>
        <p style={{ fontSize: 16, lineHeight: 1.7 }}>
          {lang === "eg" ? node.scene.eg : node.scene.en}
        </p>
      </div>
      <p
        style={{
      ...
      >
        {lang === "eg" ? "🤔 إيه اللي بتعمله؟" : "🤔 What do you do?"}
      </p>
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        {node.choices.map((choice, idx) => (
          <button
            ...
            style={{
              padding: "18px 20px",
              borderRadius: 18,
              border: `2px solid ${RM_THEME.border}`,
              background: "rgba(255,255,255,0.04)",
              cursor: "pointer",
              textAlign: "left",
              fontFamily: "inherit",
...
const CATEGORY_ACTIVITY_META = {
  knowledge: {
    ...
    difficulty: 1,
    duration: 4,
    tags: ["terminology", "recall"],
  },
  visual: {
    mode: "solo",
    difficulty: 2,
    duration: 5,
    tags: ["recognition", "classification"],
  },
  broker: {
    mode: "solo",
    difficulty: 2,
    duration: 4,
    tags: ["judgment", "market logic"],
  },
  psychology: {
    mode: "solo",
    difficulty: 3,
    duration: 5,
    tags: ["motives", "judgment"],
  },
  calls: {
    mode: "solo",
    difficulty: 3,
    duration: 5,
    tags: ["calls", "communication"],
  },
  professional: {
    mode: "solo",
    difficulty: 2,
    duration: 4,
    tags: ["professionalism", "habits"],
  },
  advanced: {
    mode: "coaching",
    difficulty: 4,
...
const ACTIVITY_META = {
  ...
  facilitator: {
    mode: "coaching",
    tags: ["facilitator", "roleplay"],
    duration: 6,
  },
  debrief: {
    mode: "coaching",
    tags: ["debrief", "coaching"],
    difficulty: 3,
    duration: 5,
  },
  ...
  clientmatch: {
    tags: ["qualification", "matching", "unit types"],
    difficulty: 2,
    duration: 7,
  },
  objblitz: {
    tags: ["objections", "abc", "arcade"],
    difficulty: 3,
    duration: 6,
  },
  propquest: {
    tags: ["sales process", "call flow", "story"],
    difficulty: 4,
    duration: 10,
  },
};
...
const getActivityMeta = (categoryId, activityId) => {
  const base = CATEGORY_ACTIVITY_META[categoryId] || {
    mode: "solo",
    difficulty: 2,
    duration: 5,
    tags: [],
...
const ActivityGameShell = ({ children, updateScore }) => {
  ...
  const wrappedUpdateScore = React.useCallback(
    (points, isCorrect) => {
      ...
      const boosted =
        isCorrect && points > 0 ? Math.round(points * newMulti) : points;
  ...
  if (phase === "countdown") {
    return (
      <div className="xc-game-countdown">
        <div className="xc-countdown-orb" key={countVal}>
          {countVal}
        </div>
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      <div className="xc-game-hud">
        ...
        <span
          className={`xc-hud-multi${multiplier > 1 ? " xc-hud-multi--active" : ""}`}
        >
          ×{multiplier}
        </span>
        {inStreak > 1 && <span className="xc-hud-streak">🔥×{inStreak}</span>}
        <span className="xc-hud-score">+{sessionScore} pts</span>
      </div>

      {/* ── Combo banner ── */}
      {multiLabel && <div className="xc-multi-banner">{multiLabel}</div>}
...
const App = () => {
  ...
  React.useEffect(() => {
    if (!document.getElementById("xcelias-ring-css")) {
      ...
      s.textContent =
        "@keyframes logoRingPulse{0%,100%{opacity:0.3;transform:scale(1)}50%{opacity:0.6;transform:scale(1.06)}}";
  ...
  const [currentUser, setCurrentUser] = useState(() =>
    xcRead(XC_KEYS.currentUser, null),
  );
  ...
  const handleLogout = async () => {
    ...
    try {
      localStorage.removeItem(APP_STORAGE.academyProgress);
      localStorage.removeItem(APP_STORAGE.globalScore);
      localStorage.removeItem(APP_STORAGE.globalStreak);
    } catch {}
  };
  ...
  useEffect(() => {
    ...
    const unsub = window.xcAuth.onAuthStateChanged((fbUser) => {
      ...
      if (!isOfflineAdmin && !isOfflineAccount) {
        ...
        try {
          localStorage.removeItem(XC_KEYS.currentUser);
        } catch {}
        setCurrentUser(null);
      }
    });
  ...
  const [globalScore, setGlobalScore] = useState(() => {
    try {
      const raw = parseInt(
        localStorage.getItem(APP_STORAGE.globalScore) || "0",
        10,
      );
  ...
  const [globalStreak, setGlobalStreak] = useState(() => {
    try {
      const raw = parseInt(
        localStorage.getItem(APP_STORAGE.globalStreak) || "0",
        10,
      );
  ...
  const [academyProgress, setAcademyProgress] = useState(() =>
    readJsonStorage(APP_STORAGE.academyProgress, {
      activityStats: {},
      recentSessions: [],
      lastPlayedId: null,
      claimedMissionKeys: [],
  ...
  const [tone, setTone] = useState(() => {
    try {
      return localStorage.getItem(APP_STORAGE.tone) || "en";
    } catch {
      return "en";
    }
  });
  const [fxIntensity, setFxIntensity] = useState(() => {
    try {
      const v = parseFloat(
        localStorage.getItem(APP_STORAGE.fxIntensity) || "0.95",
      );
  ...
  const [reduceMotion, setReduceMotion] = useState(() => {
    try {
      return localStorage.getItem(APP_STORAGE.reduceMotion) === "1";
    } catch {
      return false;
    }
  });
  ...
  const [projectorMode, setProjectorMode] = useState(() => {
    try {
      return localStorage.getItem(APP_STORAGE.projectorMode) === "1";
    } catch {
      return false;
    }
  });
  ...
  useEffect(() => {
    try {
      localStorage.setItem(APP_STORAGE.tone, tone);
    } catch {}
  }, [tone]);
  useEffect(() => {
    try {
      localStorage.setItem(APP_STORAGE.fxIntensity, String(fxIntensity));
    } catch {}
  }, [fxIntensity]);
  useEffect(() => {
    try {
      localStorage.setItem(APP_STORAGE.reduceMotion, reduceMotion ? "1" : "0");
    } catch {}
  }, [reduceMotion]);
  useEffect(() => {
    try {
      localStorage.setItem(
        APP_STORAGE.backgroundEnabled,
  ...
  useEffect(() => {
    try {
      localStorage.setItem(APP_STORAGE.globalScore, String(globalScore));
    } catch {}
  }, [globalScore]);
  useEffect(() => {
    try {
      localStorage.setItem(APP_STORAGE.globalStreak, String(globalStreak));
    } catch {}
  }, [globalStreak]);
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      const rank = getRedRank(globalScore);
      const activitiesPlayed = Object.keys(
        academyProgress.activityStats || {},
      ).length;
      XC.pushScore(
        currentUser.uid,
        currentUser.batchId,
  ...
  const rawCategories = [
    {
      ...
      activities: [
        {
          id: "rapidfire",
          name: s.activityNames.rapidfire,
          component: RapidFireMCQ,
        },
        {
          id: "truefalse",
          name: s.activityNames.truefalse,
          component: TrueFalseSpeedRun,
        },
        {
          id: "matching",
          name: s.activityNames.matching,
          component: DefinitionMatching,
        },
        { id: "oddone", name: s.activityNames.oddone, component: OddOneOut },
        { id: "blanks", name: s.activityNames.blanks, component: FillInBlanks },
        {
          id: "acronym",
          name: s.activityNames.acronym,
          component: AcronymDecoder,
        },
        {
          id: "hierarchy",
          name: s.activityNames.hierarchy,
          component: HierarchySorter,
        },
      ],
    },
    {
      ...
      activities: [
        {
          id: "accessories",
          name: s.activityNames.accessories,
          component: AccessoriesInspection,
        },
        {
          id: "unittype",
          name: s.activityNames.unittype,
          component: UnitTypeIdentifier,
        },
        {
          id: "finishing",
          name: s.activityNames.finishing,
          component: FinishingVisualizer,
        },
        {
          id: "commercial",
          name: s.activityNames.commercial,
          component: CommercialTycoon,
        },
      ],
    },
    {
      ...
      activities: [
        {
          id: "sortinghat",
          name: s.activityNames.sortinghat,
          component: SortingHat,
        },
        { id: "procon", name: s.activityNames.procon, component: ProConMatrix },
        {
          id: "market",
          name: s.activityNames.market,
          component: MarketAwarenessCheck,
        },
      ],
    },
    {
      ...
      activities: [
        {
          id: "motive",
          name: s.activityNames.motive,
          component: MotiveDetective,
        },
        {
          id: "needswants",
          name: s.activityNames.needswants,
          component: NeedsWantsSorter,
        },
        { id: "whychain", name: s.activityNames.whychain, component: WhyChain },
        {
          id: "brainheart",
          name: s.activityNames.brainheart,
          component: BrainVsHeart,
        },
      ],
    },
    {
      ...
      activities: [
        {
          id: "decoder",
          name: s.activityNames.decoder,
          component: CommunicationDecoder,
        },
        {
          id: "robot",
          name: s.activityNames.robot,
          component: RobotTalkBuzzer,
        },
        {
          id: "mirror",
          name: s.activityNames.mirror,
          component: MirroringDrill,
        },
        {
          id: "callflow",
          name: s.activityNames.callflow,
          component: CallFlowBuilder,
        },
        {
          id: "abc",
          name: s.activityNames.abc,
          component: ABCClosingChallenge,
        },
        {
          id: "mistake",
          name: s.activityNames.mistake,
          component: MistakeSniper,
        },
        {
          id: "qualifying",
          name: s.activityNames.qualifying,
          component: QualifyingQuest,
        },
      ],
    },
    {
      ...
      activities: [
        {
          id: "dresscode",
          name: s.activityNames.dresscode,
          component: DressCodePolice,
        },
        { id: "skills", name: s.activityNames.skills, component: SkillsRadar },
        {
          id: "impression",
          name: s.activityNames.impression,
          component: FirstImpressionTrial,
        },
      ],
    },
    {
      ...
      activities: [
        {
          id: "objectionduel",
          name: s.activityNames.objectionduel,
          component: ObjectionDuelArena,
        },
        {
          id: "objection",
          name: s.activityNames.objection,
          component: ObjectionDeflector,
        },
        { id: "triage", name: s.activityNames.triage, component: LeadTriage },
        {
          id: "form",
          name: s.activityNames.form,
          component: RequestFormBuilder,
        },
        {
          id: "coldcall",
          name: s.activityNames.coldcall,
          component: ColdCallSimulator,
        },
        {
          id: "21exp",
          name: s.activityNames["21exp"],
          component: TwentyOneExperiences,
        },
      ],
    },
    {
      ...
      activities: [
        {
          id: "teambattle",
          name: s.activityNames.teambattle,
          component: TeamBattleArena,
        },
        {
          id: "facilitator",
          name: s.activityNames.facilitator,
          component: FacilitatorDeck,
        },
        {
          id: "debrief",
          name: s.activityNames.debrief,
          component: CoachDebriefConsole,
        },
        {
          id: "consensus",
          name: s.activityNames.consensus,
          component: ConsensusClash,
        },
      ],
    },
    {
      ...
      activities: [
        {
          id: "reviewrescue",
          name: s.activityNames.reviewrescue,
          component: ReviewRescue,
        },
        {
          id: "academysprint",
          name: s.activityNames.academysprint,
          component: AcademySprint,
        },
        {
          id: "bingo",
          name: s.activityNames.bingo,
          component: RealEstateBingo,
        },
        {
          id: "crossword",
          name: s.activityNames.crossword,
          component: SalesmanCrossword,
        },
    ...
    },
    {
      ...
      activities: [
        {
          id: "clientmatch",
          name: s.activityNames.clientmatch,
          component: ClientMatch,
        },
        {
          id: "objblitz",
          name: s.activityNames.objblitz,
          component: ObjectionBlitz,
        },
        {
          id: "propquest",
          name: s.activityNames.propquest,
          component: PropertyQuest,
        },
      ],
    },
  ];
  ...
  const getActivityTrack = useCallback(
    (activityId) =>
      academyProgress.activityStats[activityId] || createEmptyActivityTrack(),
    [academyProgress],
  );
  ...
  const launchActivityById = useCallback(
    (activityId) => {
      const nextActivity = activityInsights.find(
        (activity) => activity.id === activityId && activity.unlock?.unlocked,
      );
  ...
  const updateScore = useCallback(
    (points, isCorrect) => {
      ...
      setGlobalStreak((prevStreak) => {
        ...
        if (
          isCorrect &&
          (nextStreak === 3 || nextStreak === 5 || nextStreak % 10 === 0)
        )
          fireConfetti(15);
        return nextStreak;
      });
      ...
      setAcademyProgress((prev) => {
        const currentTrack =
          prev.activityStats[currentActivity.id] || createEmptyActivityTrack();
        const nextTrack = {
        ...
        return {
          ...
          recentSessions: [sessionEntry, ...(prev.recentSessions || [])].slice(
            0,
            24,
          ),
  ...
  const rawActivityInsights = useMemo(
    () =>
      activityRegistry.map((activity) => {
        const track = getActivityTrack(activity.id);
        const mastery = computeMastery(track);
        const accuracy = track.attempts
          ? Math.round((track.correct / track.attempts) * 100)
          : 0;
        const reviewWeight = track.attempts
          ? track.incorrect * 14 +
            Math.max(0, 70 - mastery) +
            Math.min(track.attempts, 5)
          : 16;
        return {
          ...activity,
          track,
  ...
  const academyStatsBase = useMemo(() => {
    const playedActivities = rawActivityInsights.filter(
      (activity) => activity.track.attempts > 0,
    ).length;
    const masteredActivities = rawActivityInsights.filter(
      (activity) => activity.mastery >= 80,
    ).length;
    return {
      playedActivities,
      masteredActivities,
  ...
  const activityInsights = useMemo(
    () =>
      rawActivityInsights.map((activity) => ({
        ...activity,
        unlock: getActivityUnlockState(
          activity.id,
          academyStatsBase,
          globalScore,
          lang,
  ...
  const reviewQueue = useMemo(
    () =>
      [...unlockedActivityInsights]
        .filter(
          (activity) =>
            activity.track.attempts === 0 ||
            activity.mastery < 72 ||
            activity.track.incorrect > 0,
        )
  ...
  const todaySessions = useMemo(
    () =>
      (academyProgress.recentSessions || []).filter(
        (session) =>
          new Date(session.at).toISOString().slice(0, 10) === todayKey,
      ),
  ...
  const redOpsMissions = useMemo(() => {
    const uniqueActivitiesToday = new Set(
      todaySessions.map((session) => session.activityId),
    ).size;
    const pointsToday = todaySessions.reduce(
      (sum, session) => sum + session.points,
      0,
    );
    const reviewTouchCount = todaySessions.filter((session) =>
      reviewQueue.some((activity) => activity.id === session.activityId),
    ).length;
    ...
    return [
      {
        ...
        description:
          lang === "eg"
            ? "ابدأ نشاط واحد على الأقل النهارده."
            : "Start at least one activity today.",
      ...
      },
      {
        ...
        description:
          lang === "eg"
            ? "العب 3 أنشطة مختلفة في نفس اليوم."
            : "Play 3 different activities in one day.",
      ...
      },
      {
        ...
        description:
          lang === "eg" ? "اجمع 120 نقطة النهارده." : "Bank 120 points today.",
      ...
      },
      {
        ...
        description:
          lang === "eg"
            ? "ارجع لنشاط من قائمة المراجعة مرة واحدة."
            : "Touch one activity from the review queue.",
    ...
    reviewQueue,
    lang,
    academyProgress.claimedMissionKeys,
    todayKey,
  ]);

  const recommendedActivity = useMemo(() => {
    const weakPlayed = reviewQueue.find(
      (activity) => activity.track.attempts > 0,
    );
    const neverPlayed = reviewQueue.find(
      (activity) => activity.track.attempts === 0,
    );
    return (
      weakPlayed ||
  ...
  const resumeActivity = useMemo(
    () =>
      activityInsights.find(
        (activity) =>
          activity.id === academyProgress.lastPlayedId &&
  ...
  const categorySummaries = useMemo(
    () =>
      categories.map((category) => {
        const enriched = activityInsights.filter(
          (activity) => activity.categoryId === category.id,
        );
        const unlockedActivities = enriched.filter(
          (activity) => activity.unlock.unlocked,
        );
        const playedCount = unlockedActivities.filter(
          (activity) => activity.track.attempts > 0,
        ).length;
        const mastery = unlockedActivities.length
          ? Math.round(
              unlockedActivities.reduce(
                (sum, activity) => sum + activity.mastery,
                0,
        ...
        const accuracy = playedCount
          ...
          : 0;
        const suggested =
          [...unlockedActivities].sort((left, right) => {
            if (left.track.attempts === 0 && right.track.attempts > 0)
              return -1;
  ...
  const academyStats = useMemo(() => {
    const playedActivities = unlockedActivityInsights.filter(
      (activity) => activity.track.attempts > 0,
    ).length;
    const masteredActivities = unlockedActivityInsights.filter(
      (activity) => activity.mastery >= 80,
    ).length;
    return {
      playedActivities,
      masteredActivities,
      reviewCount: reviewQueue.filter(
        (activity) => activity.track.attempts > 0 && activity.mastery < 72,
      ).length,
  ...
  const lockedActivityTargets = useMemo(
    () =>
      [...activityInsights]
        ...
        .sort(
          (left, right) =>
            (right.unlock.completionRatio || 0) -
            (left.unlock.completionRatio || 0),
        )
        .slice(0, 4),
    [activityInsights],
  );
  ...
  useEffect(() => {
    ...
    const newlyUnlocked = activityInsights.find(
      (activity) =>
        activity.unlock.unlocked &&
        ACTIVITY_UNLOCK_RULES[activity.id] &&
        !seenUnlockIds.includes(activity.id),
    );
  ...
  const dismissUnlockNotice = useCallback(() => {
    ...
    setAcademyProgress((prev) => ({
      ...prev,
      seenUnlockIds: Array.from(
        new Set([...(prev.seenUnlockIds || []), unlockNotice.id]),
      ),
    }));
  ...
  const claimMissionReward = useCallback((mission) => {
    ...
    setAcademyProgress((prev) => ({
      ...prev,
      claimedMissionKeys: Array.from(
        new Set([...(prev.claimedMissionKeys || []), mission.claimKey]),
      ),
    }));
    setRewardNotice({
      id: mission.id,
  ...
  const weakestCategory = useMemo(
    () =>
      [...categorySummaries].sort(
        (left, right) => left.mastery - right.mastery,
      )[0] || null,
    [categorySummaries],
  );
  ...
  const coachingPriority = useMemo(
    () =>
      [...activityInsights]
        .filter(
          (activity) =>
            activity.mode === "coaching" ||
            activity.mode === "partner" ||
            activity.categoryId === "calls",
        )
        .sort((left, right) => {
  ...
  const renderActivity = () => {
    ...
    const ctx = {
      ...
      categorySummaries,
      academyStats,
      recentSessions: academyProgress.recentSessions || [],
      recommendedActivity,
      coachingPriority,
      weakestCategory,
      strongestCategory,
      redOpsMissions,
      lockedActivityTargets,
    };
  ...
  const renderCategoryActivities = () => {
    ...
    const categoryReviewCount = category.activities.filter(
      (activity) =>
        activity.unlock.unlocked &&
        activity.track.attempts > 0 &&
        activity.mastery < 72,
      ...
      <div className="animate-fadeIn">
        ...
        >
          ...
          >
            ...
            {category.suggested && (
              <button
                onClick={() => launchActivity(category.suggested)}
                style={styles.primaryBtn}
              >
                {lang === "eg"
                  ? "ابدأ النشاط الموصّى به"
            ...
            >
              ...
              <div>
                ...
                {!activity.unlock.unlocked && (
                  ...
                  >
                    {lang === "eg"
                      ? `الفتح: ${activity.unlock.requirementText}`
                      : `Unlock: ${activity.unlock.requirementText}`}
                  </p>
                )}
              </div>
              ...
              >
                ...
                <span style={{ color: RM_THEME.faint, fontSize: 12 }}>
                  {lang === "eg"
                    ? `آخر مرّة: ${formatLastPlayed(lang, activity.track.lastPlayedAt)}`
                    : `Last played: ${formatLastPlayed(lang, activity.track.lastPlayedAt)}`}
                </span>
              </div>
              ...
              <div style={{ marginTop: "auto" }}>
                ...
                >
                  <span>
                    {lang === "eg"
                      ? `دقة: ${activity.accuracy}%`
                      : `Accuracy: ${activity.accuracy}%`}
                  </span>
                  <span>
                    {lang === "eg"
                      ? `${activity.track.attempts} محاولة`
                      : `${activity.track.attempts} attempts`}
                  </span>
                </div>
              </div>
            </div>
  ...
  const coachLaunchActivity = academyProgress.recentSessions.length
    ? activityInsights.find(
        (activity) => activity.id === "debrief" && activity.unlock.unlocked,
      ) ||
      activityInsights.find(
        (activity) => activity.id === "facilitator" && activity.unlock.unlocked,
      ) ||
      null
    : activityInsights.find(
        (activity) => activity.id === "facilitator" && activity.unlock.unlocked,
      ) || null;
  const partnerLaunchActivity =
    activityInsights.find(
      (activity) => activity.id === "objectionduel" && activity.unlock.unlocked,
    ) || null;
  const classroomLaunchActivity =
    activityInsights.find(
      (activity) => activity.id === "teambattle" && activity.unlock.unlocked,
    ) || null;
  ...
  const renderDashboard = () => {
    ...
    const rankProgress = nextRank
      ? ((globalScore - currentRank.minScore) /
    ...
    const ringOffset =
      ringCircumference -
      (ringCircumference * Math.min(rankProgress, 100)) / 100;
    const cmdColors = {
      daily: {
        bg: "rgba(255,176,32,0.12)",
        icon: "rgba(255,176,32,0.85)",
        glow: "rgba(255,176,32,0.2)",
      },
      review: {
        bg: "rgba(80,250,123,0.12)",
        icon: "rgba(80,250,123,0.85)",
      ...
      <div className="animate-fadeIn xstagger">
        ...
        >
          <div
            style={{
              ...
              width: 280,
              height: 280,
              background: `radial-gradient(circle, ${currentRank.accent}22, transparent 70%)`,
              pointerEvents: "none",
            }}
          />
          <div
          ...
          >
            <div style={{ maxWidth: 680, flex: "1 1 380px" }}>
              ...
              >
                <span style={{ ...styles.badge, ...styles.badgeRed }}>
                  {lang === "eg" ? "أكاديمية الأداء" : "Performance Academy"}
                </span>
                <span style={{ ...styles.badge, ...styles.badgeBlue }}>
                  {lang === "eg"
                    ? `${activityInsights.length} نشاط`
                    : `${activityInsights.length} Activities`}
                </span>
                {projectorMode && (
                  <span style={{ ...styles.badge, ...styles.badgeGreen }}>
                    {lang === "eg" ? "وضع بروجكتور" : "Projector Ready"}
                  </span>
                )}
              </div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    />
                    <circle
                      className="xring-fill"
                      cx="60"
                      cy="60"
                      r={ringRadius}
                      fill="none"
                      stroke={currentRank.accent}
                      strokeWidth="6"
                ...
                <div>
                  ...
                  >
                    ...
                    {nextRank && (
                      <span style={{ fontSize: 12, color: RM_THEME.faint }}>
                        → {nextRank.minScore - globalScore}{" "}
                        {lang === "eg" ? "XP للترقية" : "XP to next"}
                      </span>
                    )}
                  </div>
                  {nextRank && (
                    <div
                      className="xxp-bar"
                      style={{ marginTop: 10, width: 200, maxWidth: "100%" }}
                    >
                      <div
                        className="xxp-fill"
            ...
            >
              <div
                className="xstat"
                style={{
                  "--xstat-accent": `linear-gradient(90deg, ${RM_THEME.red}, ${RM_THEME.red2})`,
                }}
              >
                <span
                  style={{
              ...
              <div
                className="xstat"
                style={{
                  "--xstat-accent": `linear-gradient(90deg, ${RM_THEME.amber}, #ff8c00)`,
                }}
              >
                <span
                  style={{
                ...
                >
                  ...
                  >
                    <path d="M12 23c-3.2-2.4-8-7.1-8-12.7C4 5.8 7.6 2 12 2s8 3.8 8 8.3c0 5.6-4.8 10.3-8 12.7z" />
                    <path
                      d="M12 18c-1.4-1.2-4-3.8-4-6.5C8 9.2 9.8 7 12 7s4 2.2 4 4.5c0 2.7-2.6 5.3-4 6.5z"
              ...
              <div
                className="xstat"
                style={{
                  "--xstat-accent": `linear-gradient(90deg, ${RM_THEME.green}, #2ecc71)`,
                }}
              >
                <span
                  style={{
        ...
        <div className="reveal" style={{ marginBottom: 24 }}>
          ...
          >
            {[
              {
                key: "daily",
                color: cmdColors.daily,
                svgPath:
                  "M12 3v1m0 16v1m-8-9H3m18 0h-1m-2.636-6.364l-.707.707M6.343 17.657l-.707.707m12.728 0l-.707-.707M6.343 6.343l-.707-.707M12 8a4 4 0 100 8 4 4 0 000-8z",
                title: lang === "eg" ? "تحدي النهارده" : "Daily Challenge",
                text: dailyChallenge
                  ? `${dailyChallenge.name} • ${dailyChallenge.categoryTitle}`
                  : lang === "eg"
                    ? "اختيار يومي تلقائي"
                    : "Fresh mixed challenge",
                action: dailyChallenge
                  ? () => launchActivity(dailyChallenge)
                  : null,
                actionLabel: lang === "eg" ? "ابدأ" : "Launch",
              },
              {
                key: "review",
                color: cmdColors.review,
                svgPath:
              ...
              },
              {
                ...
                text: resumeActivity
                  ...
                  : lang === "eg"
                    ? "مفيش نشاط سابق، ابدأ امتحان أو نشاط جديد"
                    : "No recent session yet",
                action: resumeActivity
                  ? () => launchActivity(resumeActivity)
                  : finalExamActivity
                    ? () => launchActivity(finalExamActivity)
                    : null,
                actionLabel: resumeActivity
                  ? lang === "eg"
                    ? "كمّل"
                    : "Resume"
                  : lang === "eg"
              ...
              {
                key: "classroom",
                color: cmdColors.classroom,
                svgPath:
                  "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10",
                title:
                  lang === "eg"
                    ? "تشغيل فصل بسرعة"
                    : "Facilitator Quick Launch",
                text:
                  lang === "eg"
                    ? "شغّل تيـم باتل أو كروت المُيسّر فورًا"
                    : "Launch Team Battle or Facilitator Deck",
        ...
        >
          ...
          >
            ...
            >
              ...
              <span style={{ ...styles.badge, ...styles.badgeBlue }}>
                {redOpsMissions.filter((m) => m.completed).length}/
                {redOpsMissions.length}
              </span>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {redOpsMissions.map((mission) => (
                <div
                  key={mission.id}
                  className={mission.claimable ? "xmission-claim" : ""}
                  style={{
                    padding: 14,
                    borderRadius: 16,
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        background: mission.completed
                          ? `linear-gradient(90deg, ${RM_THEME.green}, rgba(34,197,94,0.55))`
                          : undefined,
                      }}
                    />
                  </div>
          ...
          >
            ...
            >
              ...
              <span style={{ ...styles.badge, ...styles.badgeRed }}>
                {lockedActivityTargets.length}
              </span>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {lockedActivityTargets.map((activity) => {
                const unlockR = 18;
                const unlockC = 2 * Math.PI * unlockR;
                const unlockOff =
                  unlockC - (unlockC * activity.unlock.completionRatio) / 100;
                return (
                  <div
                    key={activity.id}
                    style={{
                    ...
                    >
                      ...
                      >
                        ...
                        <circle
                          ...
                          stroke={RM_THEME.red}
                          strokeWidth="3"
                          strokeDasharray={unlockC}
                          strokeDashoffset={unlockOff}
                          strokeLinecap="round"
                        />
                      </svg>
                      <span
                      ...
                      >
                        {activity.unlock.completionRatio}%
                      </span>
                    </div>
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        {activity.unlock.requirementText}
                      </div>
                    </div>
                  </div>
                );
              ...
              {lockedActivityTargets.length === 0 && (
                ...
                >
                  ...
                  {lang === "eg"
                    ? "كل الأنشطة المفتوحة اتفتحت. كمّل لعب وارفع الرتبة."
                    : "All unlocked. Keep pushing the rank ladder."}
                </div>
              )}
            </div>
          </div>
        ...
        <div
          ...
          style={{
            ...
            padding: 24,
            background:
              "linear-gradient(135deg, rgba(0,212,255,0.06), rgba(255,59,59,0.06))",
            border: `1px solid ${RM_THEME.border}`,
          }}
        >
          <div
          ...
          >
            <div style={{ flex: "1 1 420px" }}>
              ...
              <h3 style={{ marginBottom: 8, fontSize: 20 }}>
                {weakestCategory
                  ? lang === "eg"
                    ? `أضعف مسار: ${weakestCategory.title}`
                    : `Weakest lane: ${weakestCategory.title}`
                  : lang === "eg"
                    ? "ابدأ أول نشاط لبناء خط الأساس"
                    : "Start your first activity to build a baseline"}
              </h3>
              <p style={{ color: RM_THEME.muted, lineHeight: 1.6 }}>
                {weakestCategory
                  ...
                  : lang === "eg"
                    ? "ابدأ بتحدي اليوم، وبعدها هنديك توصيات أدق."
                    : "Start with the daily challenge for tailored recommendations."}
              </p>
            </div>
            <div
              style={{
            ...
            >
              ...
              >
                ...
                >
                  {lang === "eg" ? "كووتشينج أولويّة" : "Coaching Priority"}
                </span>
                <span style={{ fontSize: 18, fontWeight: 800, color: "#fff" }}>
                  {coachingPriority ? coachingPriority.name : "—"}
                </span>
              </div>
            </div>
          </div>
          ...
          >
            {weakestCategory?.suggested && (
              <button
                onClick={() => launchActivity(weakestCategory.suggested)}
                style={styles.primaryBtn}
              >
                <svg
                  width="16"
            ...
            {coachingPriority && (
              <button
                onClick={() => launchActivity(coachingPriority)}
                style={styles.secondaryBtn}
              >
                {lang === "eg"
                  ? "افتح تدريب الكووتشينج"
                  : "Open Coaching Drill"}
              </button>
            )}
          </div>
          ...
          >
            {[
              ...
              },
              {
                ...
                copy:
                  lang === "eg"
                    ? "ابدأ جلسة واحد لواحد."
                    : "Open a trainer-led deck or coaching simulation.",
                svgPath:
                  "M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M9 11a4 4 0 100-8 4 4 0 000 8zM23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75",
                color: "#ffb020",
                action: coachLaunchActivity
                  ? () => launchActivity(coachLaunchActivity)
                  : null,
                lockedText: coachLaunchActivity
                  ? ""
                  : lang === "eg"
                    ? "افتح شوية أنشطة الأول."
                    : "Play a few activities first.",
              },
              {
                id: "partner-launch",
                ...
                copy:
                  lang === "eg"
                    ? "تمارين رول-سواب واعتراضات."
                    : "Role-swap drills and objections.",
                svgPath:
                  "M16 21v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2M14 10l2 2 4-4M12 7a4 4 0 11-8 0 4 4 0 018 0z",
                color: "#50fa7b",
                action: partnerLaunchActivity
                  ? () => launchActivity(partnerLaunchActivity)
                  : null,
                lockedText: partnerLaunchActivity
                  ? ""
                  : lang === "eg"
                    ? "ارفع السكور لفتح البارتنر مود."
                    : "Raise score to unlock partner mode.",
              },
              {
                id: "classroom-launch",
                ...
                action: classroomLaunchActivity
                  ...
                  : null,
                lockedText: classroomLaunchActivity
                  ? ""
                  : lang === "eg"
                    ? "شغّل جولات فردية الأول."
                    : "Run solo rounds first.",
              },
            ].map((modeCard) => (
              <div
                key={modeCard.id}
                ...
                style={{
                  ...
                  flexDirection: "column",
                  gap: 12,
                  opacity: modeCard.action ? 1 : 0.6,
                  minHeight: 190,
                }}
              >
                <div
                  className="xlane-glow"
                  style={{
                    background: `radial-gradient(circle at 50% 0%, ${modeCard.color}15, transparent 70%)`,
                  }}
                />
                <div
                  className="xlane-icon"
                  style={{
                    width: 48,
                    height: 48,
                    borderRadius: 14,
                    background: `${modeCard.color}18`,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke={modeCard.color}
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  >
                    <path d={modeCard.svgPath} />
                  </svg>
                </div>
                ...
                <div style={{ marginTop: "auto" }}>
                  <button
                    onClick={modeCard.action}
                    disabled={!modeCard.action}
                    style={{
                      ...styles.secondaryBtn,
                      padding: "10px 18px",
                      fontSize: 13,
        ...
        <div className="reveal cv-auto" style={{ marginBottom: 24 }}>
          ...
          <div style={styles.grid4}>
            {categorySummaries.map((category) => {
              const laneR = 30;
              const laneC = 2 * Math.PI * laneR;
              const laneOff = laneC - (laneC * category.mastery) / 100;
              return (
                <div
                  key={category.id}
                ...
                >
                  <div
                    className="xlane-glow"
                    style={{
                      background: `radial-gradient(circle at 50% 0%, ${category.color}12, transparent 70%)`,
                    }}
                  />
                  <div
                    style={{
                    ...
                    >
                      ...
                      >
                        ...
                        <circle
                          ...
                          strokeWidth="4"
                          strokeDasharray={laneC}
                          strokeDashoffset={laneOff}
                          strokeLinecap="round"
                        />
                      </svg>
                      <span
                  ...
                  {category.suggested && (
                    ...
                    >
                      ...
                      {lang === "eg"
                        ? `موصى به: ${category.suggested.name}`
                        : `Next: ${category.suggested.name}`}
                    </div>
                  )}
                </div>
              );
        ...
        >
          ...
          >
            ...
            >
              ...
              <span style={{ ...styles.badge, ...styles.badgeGreen }}>
                {academyProgress.recentSessions.length}
              </span>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {(academyProgress.recentSessions || [])
                .slice(0, 6)
                .map((session) => (
                  <div
                    key={session.id}
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        style={{
                          color: session.isCorrect ? RM_THEME.green : "#f56565",
                          fontWeight: 800,
                          fontSize: 14,
                          display: "flex",
                          alignItems: "center",
                    ...
                    >
                      ...
                      {formatLastPlayed(lang, session.at)}
                    </div>
                  </div>
                ))}
              {academyProgress.recentSessions.length === 0 && (
                ...
                >
                  ...
                  {lang === "eg"
                    ? "ابدأ أي نشاط، وسجلّك هيظهر هنا."
                    : "Start any activity and your history will build up here."}
                </div>
              )}
            </div>
          </div>
        ...
        <div style={styles.container} className="rm-app-shell">
          ...
          <header style={styles.header}>
            <div style={styles.logo}>
              ...
              <div style={styles.logoIcon} className="xc-logo-icon">
                ...
                <div className="xc-orb-track xc-orb-track--1">
                  <span className="xc-orb xc-orb--1"></span>
                </div>
                <div className="xc-orb-track xc-orb-track--2">
                  <span className="xc-orb xc-orb--2"></span>
                </div>
                <div className="xc-orb-track xc-orb-track--3">
                  <span className="xc-orb xc-orb--3"></span>
                </div>
                <svg
                  viewBox="0 0 56 56"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="xc-logo-svg"
                  style={{
                    width: "28px",
                    height: "28px",
                    position: "relative",
            ...
            >
              {/* Leaderboard */}
              <button
                className="xc-header-btn xc-header-btn--trophy"
              ...
              {/* Room */}
              <button
                className="xc-header-btn xc-header-btn--room"
              ...
              {currentUser?.role === "admin" && (
                <button
                  className="xc-header-btn xc-header-btn--admin"
          ...
          >
            <p>
              🏆{" "}
              {lang === "eg"
                ? "منصة تدريب تفاعلية • سيناريوهات مالهاش آخر"
                : "Dynamic Training Platform • Infinite Scenarios Engine"}
            </p>
          ...
          <nav className="xc-bottom-nav">
            <button
              className={`xc-bnav-item${mobileTab === "home" ? " active" : ""}`}
              onClick={() => {
                setMobileTab("home");
                setCurrentActivity(null);
                setSelectedCategory(null);
            ...
            <button
              className={`xc-bnav-item${mobileTab === "games" ? " active" : ""}`}
              onClick={() => {
                setMobileTab("games");
            ...
            >
              ...
              <span className="xc-bnav-label">
                {lang === "eg" ? "ألعاب" : "Games"}
              </span>
            </button>
            <button
              className={`xc-bnav-item${mobileTab === "board" ? " active" : ""}`}
              onClick={() => {
                setMobileTab("board");
            ...
            <button
              className={`xc-bnav-item${mobileTab === "room" ? " active" : ""}`}
              onClick={() => {
                setMobileTab("room");
                setShowRoom(true);
              }}
            ...
            <button
              className={`xc-bnav-item${mobileTab === "profile" ? " active" : ""}`}
              onClick={() => {
            ...
            {currentUser?.role === "admin" && (
              <button
                className={`xc-bnav-item${mobileTab === "admin" ? " active" : ""}`}
                onClick={() => {
                  setMobileTab("admin");
                  setShowAdmin(true);
                }}
...
const xcDownloadJsonFile = (filename, data) =>
  xcDownloadTextFile(
    filename,
    JSON.stringify(data, null, 2),
    "application/json",
  );
const xcReadJsonFile = (file) =>
...
const XC = {
  ...
  signIn: async (username, password) => {
    ...
    if (XC.isOnline()) {
      try {
        const cred = await window.xcAuth.signInWithEmailAndPassword(
          XC.fbEmail(u),
          password,
        );
        const snap = await window.xcDB
        ...
        if (!profile) {
          ...
          profile = {
            username: u,
            displayName: isAdmin ? "Admin" : u,
            role: isAdmin ? "admin" : "trainee",
            batchId: isAdmin ? "admin" : "default",
            createdAt: Date.now(),
          };
          try {
            await window.xcDB.ref(`users/${cred.user.uid}`).set(profile);
          } catch {}
        }
    ...
    if (u === "admin") {
      ...
      if (hash !== adminSetup.passwordHash)
        throw new Error("Invalid username or password");
      const user = {
        uid: "admin_local",
        username: "admin",
  ...
  importOfflineBackup: (backup) => {
    ...
    const accounts = Array.isArray(backup.data.accounts)
  ...
  setupAdmin: async (password) => {
    ...
    if (XC.isOnline()) {
      try {
        const cred = await window.xcAuth.createUserWithEmailAndPassword(
          XC.fbEmail("admin"),
          password,
        );
        ...
        if (e.code === "auth/email-already-in-use")
          throw new Error(
            "Admin already set up. Sign in with your admin password.",
          );
        throw e;
      }
    }
  ...
  listAccounts: async (batchId = null) => {
    if (XC.isOnline()) {
      ...
      const all = Object.entries(users).map(([uid, profile]) => {
        const scoreData =
          profile?.batchId && leaderboard[profile.batchId]
            ? leaderboard[profile.batchId][uid]
            : null;
  ...
  createTrainee: async ({
    ...
    if (XC.isOnline()) {
      ...
      if (existing.find((a) => (a.username || "").toLowerCase() === u))
        throw new Error("Username already taken");
      if (
        existing.filter((a) => a.batchId === batchId && a.role !== "admin")
          .length >= XC_MAX_TRAINEES
      )
        throw new Error(`Maximum ${XC_MAX_TRAINEES} trainees per batch`);
    ...
    const accounts = xcRead(XC_KEYS.accounts, []);
    if (accounts.find((a) => a.username.toLowerCase() === u))
      throw new Error("Username already taken");
    if (accounts.filter((a) => a.batchId === batchId).length >= XC_MAX_TRAINEES)
      throw new Error(`Maximum ${XC_MAX_TRAINEES} trainees per batch`);
    const hash = await xcHash(password);
  ...
  deleteTrainee: async (uid, batchId) => {
    ...
    xcWrite(
      XC_KEYS.accounts,
      xcRead(XC_KEYS.accounts, []).filter((a) => a.uid !== uid),
    );
  },
  ...
  subscribeLeaderboard: (batchId, callback) => {
    ...
    const poll = () => {
      const accounts = xcRead(XC_KEYS.accounts, []);
      const filtered =
        batchId && batchId !== "admin"
          ? accounts.filter((a) => a.batchId === batchId)
  ...
  createRoom: async (adminUid, batchId, mode) => {
    ...
    if (XC.isOnline()) {
      await window.xcDB.ref(`rooms/${code}`).set(room);
      return room;
    }
  ...
  joinRoom: async (code, uid, displayName) => {
    if (XC.isOnline()) {
      ...
      await window.xcDB
        ...
        .set({ displayName, score: 0, joinedAt: Date.now() });
  ...
  updateRoomStatus: async (code, status) => {
    if (XC.isOnline())
      await window.xcDB.ref(`rooms/${code}/status`).set(status);
    const room = xcRead(`xcRoom_${code}`, null);
  ...
  updateRoomScore: async (code, uid, score) => {
    if (XC.isOnline())
      window.xcDB.ref(`rooms/${code}/participants/${uid}/score`).set(score);
  },
};
...
const XcLoginScreen = ({ onLogin }) => {
  ...
  const [adminStatus, setAdminStatus] = useState(() =>
    XC.isOnline() ? "checking" : XC.isAdminSetup() ? "ready" : "missing",
  );
    ...
    window.xcAuth
      ...
      .catch((err) => {
        ...
        if (err && err.code === "auth/operation-not-allowed") {
          setSetupError(
            "Enable Email/Password inside Firebase Authentication before continuing.",
          );
        }
  ...
  const handleLogin = async (e) => {
    ...
    setLoading(true);
    try {
      const user = await XC.signIn(username.trim(), password);
      onLogin(user);
    } catch (err) {
  ...
  const handleSetup = async (e) => {
    ...
    try {
      const user = await XC.setupAdmin(adminPw);
      onLogin(user);
    } catch (err) {
      const message = err.message || "Setup failed";
      if (
        message === "Admin already set up. Sign in with your admin password."
      ) {
  ...
  const handleImportBackup = async (e) => {
    ...
    try {
      ...
      const countLabel =
        result.traineeCount === 1
          ? "1 trainee"
          : `${result.traineeCount} trainees`;
      if (result.hasAdmin) {
        setShowSetup(false);
        setError(
          `Offline backup imported. Sign in with the admin password from the original device. ${countLabel} restored.`,
        );
      } else {
        setSetupError(
          "Backup imported, but it does not include an admin setup.",
        );
      }
    } catch (err) {
      ...
      <div className="xc-login-card">
        ...
        {adminStatus === "checking" ? (
          ...
          <form onSubmit={handleSetup} className="xc-login-form">
            ...
            <button
              type="submit"
              className="xc-login-btn xc-login-btn--primary"
              disabled={setupLoading}
            >
              {setupLoading ? (
                <span className="xc-login-loading">
                  <span />
                  <span />
                  <span />
                </span>
          ...
          <form onSubmit={handleLogin} className="xc-login-form">
            ...
            {noAdmin ? (
              <>
                <p className="xc-login-hint">
                  👋 No Firebase admin exists yet. Create it once on one device,
                  then sign in everywhere else.
                </p>
                <button
                  type="button"
                  className="xc-login-btn"
                  onClick={() => {
                    setShowSetup(true);
                    setError("");
                  }}
            ...
            <p className="xc-login-footer-hint">
              Contact your trainer if you need access
            </p>
            {!XC.isOnline() && (
              <p className="xc-login-footnote">
                Without Firebase, each device has its own local admin, trainees,
                scores, and rooms.
              </p>
            )}
          </form>
        ...
        {!XC.isOnline() && (
          <div className="xc-login-sync-note">
            ...
            <br />
            This device is using local storage only. To share the same admin and
            leaderboard across devices, either configure Firebase or import an
            offline backup from the original device.
          </div>
        )}
        <input
          ref={fileInputRef}
...
const XcLeaderboard = ({ currentUser, onClose, embedded = false }) => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    const unsub = XC.subscribeLeaderboard(batchId, (list) => {
      setEntries(list);
      setLoading(false);
    });
    return unsub;
  ...
  const inner = (
    <>
      <div className="xc-leaderboard__header">
        <div className="xc-leaderboard__title">
          <span>🏆</span>
          <span>Leaderboard</span>
        </div>
        {!embedded && (
          <button className="xc-modal-close" onClick={onClose}>
            ✕
          </button>
        )}
      </div>
        ...
        <div className="xc-leaderboard__list">
          {entries.map((entry, idx) => {
            ...
            return (
              <div
                key={entry.uid}
                className={`xc-lb-row${isMe ? " xc-lb-row--me" : ""}${idx < 3 ? " xc-lb-row--top" : ""}`}
              >
                <div className="xc-lb-rank">
                  <span
                    className={`xc-lb-rank-num${idx < 3 ? " xc-lb-rank-num--podium" : ""}`}
                  >
                    {getRankEmoji(idx)}
                  </span>
                </div>
                <div className="xc-lb-avatar">
                  {(entry.displayName || entry.username || "U")
                    .charAt(0)
                    .toUpperCase()}
                </div>
                <div className="xc-lb-info">
                  <span className="xc-lb-name">
                    {entry.displayName || entry.username}
                    {isMe && <span className="xc-lb-you"> (You)</span>}
                  </span>
                  <div className="xc-lb-meta">
                    <span
                      className="xc-lb-badge"
                      style={{ color: badge.color }}
                    >
                      {badge.label}
                    </span>
                    {(entry.activitiesPlayed || 0) > 0 && (
                      <span className="xc-lb-acts">
                        {entry.activitiesPlayed}{" "}
                        {entry.activitiesPlayed === 1
                          ? "activity"
                          : "activities"}
                      </span>
                    )}
                ...
                <div className="xc-lb-score-col">
                  <div className="xc-lb-score">
                    {(entry.totalScore || 0).toLocaleString()}
                  </div>
                  {(entry.streak || 0) > 0 && (
                    <div
                      className="xc-lb-streak"
                      style={{ color: getStreakColor(entry.streak) }}
                    >
                      🔥{entry.streak}
                    </div>
                  )}
      ...
      {!XC.isOnline() && (
        <div className="xc-leaderboard__offline-note">
          📡 Offline mode — scores shown for this device only.
          <br />
          Configure firebase-config.js for real-time sync.
        </div>
      )}
    </>
  );
  ...
  return (
    <div className="xc-modal-overlay" onClick={onClose}>
      <div className="xc-leaderboard" onClick={(e) => e.stopPropagation()}>
        {inner}
      </div>
    </div>
  );
...
const XcAdminPanel = ({ currentUser, onClose }) => {
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        setAccounts(accs);
        const firstBatch = accs.find(
          (a) => a.batchId && a.batchId !== "admin" && a.role !== "admin",
        );
        if (firstBatch) {
          setBatchId(firstBatch.batchId);
          setBatchName(firstBatch.batchName || firstBatch.batchId);
        }
      } catch {}
      setLoading(false);
    })();
  ...
  const currentBatch = accounts.filter(
    (a) => a.batchId === batchId && a.role !== "admin",
  );

  const handleAdd = async (e) => {
    e.preventDefault();
    if (!newName.trim() || !newUsername.trim()) {
      setAddError("Name and username are required");
      return;
    }
    setAddError("");
    setAddLoading(true);
    try {
      const trainee = await XC.createTrainee({
  ...
  const handleCreateRoom = async () => {
    ...
    try {
      setCreatedRoom(
        await XC.createRoom(currentUser.uid, batchId || "all", roomMode),
      );
    } catch (err) {
      alert(err.message);
    }
  ...
  const handleExportBackup = () => {
    ...
    xcDownloadJsonFile(
      `xcelias-offline-backup-${stamp}.json`,
      XC.exportOfflineBackup(),
    );
  };
  ...
  const displayAccounts = batchFilter
    ? accounts.filter((a) => a.batchId === batchFilter && a.role !== "admin")
    : currentBatch;
    ...
    <div className="xc-modal-overlay">
      <div className="xc-admin-panel" onClick={(e) => e.stopPropagation()}>
        <div className="xc-admin-header">
          <div className="xc-admin-title">
            <span className="xc-admin-badge">ADMIN</span>
        ...
        <div className="xc-admin-tabs">
          {[
            ...
            <button
              key={t.id}
              className={`xc-admin-tab${tab === t.id ? " active" : ""}`}
              onClick={() => setTab(t.id)}
            >
              {t.label}
              {t.count !== undefined && (
                <span className="xc-tab-count">{t.count}</span>
              )}
            </button>
          ))}
        </div>
        ...
        <div className="xc-admin-body">
          {tab === "accounts" && (
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div className="xc-admin-row">
                <div className="xc-admin-field">
                  ...
                  <input
                    ...
                    className="xc-admin-input"
                    placeholder="e.g., Batch 12 — March 2026"
                  />
                </div>
                <div
                  className="xc-admin-stat"
                  style={{
                    textAlign: "right",
                    justifyContent: "flex-end",
                    paddingBottom: 6,
                ...
                >
                  <span className="xc-admin-stat-num">
                    {currentBatch.length}
                  </span>
                  <span className="xc-admin-stat-label">
                    / {XC_MAX_TRAINEES}
                  </span>
                </div>
              </div>
              ...
              <div className="xc-admin-trainee-list">
                {loading ? (
                  <div className="xc-loading-center">
                    <div className="xc-loading-dots">
                      <span />
                      <span />
                      <span />
                  ...
                  <div className="xc-admin-empty">
                    <div style={{ fontSize: 36 }}>👥</div>
                    <p>
                      No trainees yet in this batch.
                      <br />
                      Add up to {XC_MAX_TRAINEES}.
                    </p>
                  </div>
                ) : (
                  displayAccounts.map((t) => (
                    <div key={t.uid} className="xc-admin-trainee-card">
                      <div className="xc-trainee-avatar">
                      ...
                      <div className="xc-trainee-info">
                        ...
                        <span className="xc-trainee-username">
                          @{t.username}
                        </span>
                        {t.role === "agent" && (
                          <span
                      ...
                      <div className="xc-trainee-score">
                        ⭐ {(t.totalScore || 0).toLocaleString()}
                      </div>
                      <button
                        className="xc-trainee-delete"
                        onClick={() => handleDelete(t.uid, t.batchId)}
                        title="Delete"
                      >
                        🗑
                      </button>
              ...
              {!XC.isOnline() && (
                <div className="xc-sync-box">
                  <div className="xc-sync-box__title">
                    Offline Sync Between Devices
                  </div>
                  <p className="xc-sync-box__text">
                    This app is still local-only. Export a backup from this
                    device, then import it on the other device so it gets the
                    same admin setup and trainee accounts.
                  </p>
                  <div className="xc-sync-box__actions">
                    <button
                      className="xc-admin-btn"
                  ...
                  <div className="xc-sync-box__hint">
                    For live multi-device sync, fill in firebase-config.js once
              ...
              {currentBatch.length < XC_MAX_TRAINEES &&
                (showAddForm ? (
                    ...
                    <div className="xc-admin-row">
                      ...
                      <div className="xc-admin-field">
                        ...
                        <div style={{ display: "flex", gap: 8 }}>
                          ...
                          <button
                            type="button"
                            className="xc-admin-gen-btn"
                            onClick={() => setNewPassword(xcGenPassword())}
                            title="Generate"
                          >
                            🔄
                          </button>
                    ...
                    <div className="xc-admin-field">
                      ...
                      >
                        <option value="trainee">
                          🎓 Trainee — Activities only
                        </option>
                        <option value="agent">
                          🏠 Agent — Activities + Website
                        </option>
                      </select>
                    </div>
                    {addError && (
                      <div className="xc-login-error">{addError}</div>
                    )}
                    <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                      <button
                        type="submit"
                        className="xc-admin-btn xc-admin-btn--primary"
                        disabled={addLoading}
                      >
                        {addLoading ? "⏳..." : "✓ Create Account"}
                      </button>
                      <button
                        type="button"
                        className="xc-admin-btn"
                  ...
                  <button
                    className="xc-admin-btn xc-admin-btn--add"
                    onClick={() => setShowAddForm(true)}
                  >
                    + Add Trainee ({XC_MAX_TRAINEES - currentBatch.length} slots
                    left)
                  </button>
                ))}
              ...
              {credentials.length > 0 && (
                <div className="xc-credentials-box">
                  <div className="xc-credentials-header">
                    ...
                    <button
                      className="xc-admin-btn xc-admin-btn--small"
                      onClick={() => {
          ...
          {tab === "rooms" && (
            <div className="xc-admin-room-create">
              <h3 className="xc-admin-section-title">
                ...
                {[
                  {
                    id: "solo_race",
                    label: "🏃 Solo Race",
                    desc: "Everyone plays independently, ranked by score",
                  },
                  {
                    id: "team_battle",
                    label: "⚔️ Team Battle",
                    desc: "Teams compete for highest combined score",
                  },
                ].map((m) => (
                  <div
                    key={m.id}
                    className={`xc-room-mode-card${roomMode === m.id ? " active" : ""}`}
              ...
              <button
                className="xc-admin-btn xc-admin-btn--primary xc-admin-btn--large"
              ...
              {createdRoom && (
                <div className="xc-room-created-card">
                  ...
                  <p className="xc-room-code-hint">
                    Share this code with trainees to join
                  </p>
                  <button
                    className="xc-admin-btn xc-admin-btn--danger"
                    onClick={async () => {
                      await XC.updateRoomStatus(createdRoom.code, "ended");
                      setCreatedRoom(null);
                    }}
                  >
                    End Session
...
const XcRoomPanel = ({ currentUser, onClose }) => {
  ...
  const [joinedRoom, setJoinedRoom] = useState(() =>
    xcRead(XC_KEYS.roomJoined, null),
  );
  const [roomData, setRoomData] = useState(null);

  useEffect(() => {
    if (!joinedRoom?.code) return;
    const unsub = XC.subscribeRoom(joinedRoom.code, (data) =>
      setRoomData(data),
    );
    return unsub;
  }, [joinedRoom]);
  ...
  if (joinedRoom && roomData) {
    const sorted = Object.values(roomData.participants || {}).sort(
      ...
      <div className="xc-modal-overlay" onClick={onClose}>
        <div className="xc-room-lobby" onClick={(e) => e.stopPropagation()}>
          <div className="xc-room-lobby-header">
            ...
            <div
              className={`xc-room-status xc-room-status--${roomData.status}`}
            >
          ...
          <div className="xc-room-participants">
            <div className="xc-room-section-title">
              {sorted.length} connected
            </div>
            {sorted.map((p, i) => (
              <div key={p.joinedAt || i} className="xc-room-participant">
                <span className="xc-room-p-rank">{i + 1}</span>
                <span className="xc-room-p-avatar">
          ...
          >
            <button className="xc-admin-btn" onClick={leave}>
              Leave Room
            </button>
          </div>
        </div>
      ...
      <div className="xc-room-join" onClick={(e) => e.stopPropagation()}>
        <div className="xc-room-join-header">
          ...
          <div>
            ...
            <div className="xc-room-join-hint">
              Enter the code shown by your trainer
            </div>
          </div>
          <button className="xc-modal-close" onClick={onClose}>
            ✕

...
export async function usersModal(ctx){
 ...
 openModal('Your RED team','Loading accounts and invitations...',empty('Loading team access','Verifying administrator access.'));
 try{
  ...
  openModal('Your RED team','Only invited team members can access this workspace.',`

...
export function tone(s){return {Active:'green','Stopped Attending':'red',Completed:'blue',Planning:'amber',Present:'green','Assessment Day':'blue',Absent:'red','Tour Day':'purple','Off Day':'neutral',Aced:'green',Excellent:'blue','Very Good':'purple',Good:'amber','Needs Improvement':'orange',Failed:'red',Complete:'green','In Progress':'blue','Not Started':'neutral',Unrecorded:'neutral'}[s]||'neutral';}

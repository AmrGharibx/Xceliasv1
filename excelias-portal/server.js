...
app.use((req, res, next) => {
  ...
  res.setHeader(
    ...
    [
      "default-src 'self'",
      "script-src 'self' https://www.gstatic.com https://*.firebasedatabase.app https://cdn.tailwindcss.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://unpkg.com https://api.mapbox.com",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://unpkg.com https://cdn.jsdelivr.net https://api.mapbox.com",
      "font-src 'self' https://fonts.gstatic.com",
      "connect-src 'self' https://*.googleapis.com https://*.firebasedatabase.app wss://*.firebasedatabase.app https://overpass-api.de https://server.arcgisonline.com https://cdn.jsdelivr.net https://*.mapbox.com",
      "img-src 'self' data: blob: https://*.basemaps.cartocdn.com https://server.arcgisonline.com https://*.mapbox.com",
      "worker-src 'self' blob: https://cdn.jsdelivr.net https://api.mapbox.com",

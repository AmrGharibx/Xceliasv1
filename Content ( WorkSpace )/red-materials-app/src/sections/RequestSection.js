  ...
  return (
    ...
    >
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
              ...
              return (
                <button
                  ...
                  className={`rounded-[24px] border p-4 text-left transition ${
                    isActive ? 'border-[var(--line)] bg-[rgba(181,35,50,0.16)]' : 'border-white/10 bg-black/20 hover:bg-white/[0.05]'
                  }`}
                >
        ...
        <Panel className="xl:sticky xl:top-32 xl:h-fit bg-[linear-gradient(180deg,rgba(181,35,50,0.12),rgba(255,255,255,0.03))]">

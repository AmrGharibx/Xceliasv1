              ...
              return (
                <button
                  ...
                  className={`rounded-[24px] border px-4 py-4 text-left transition ${
                    isActive ? 'border-[var(--line)] bg-[rgba(181,35,50,0.16)]' : 'border-white/10 bg-white/[0.03] hover:bg-white/[0.05]'
                  }`}
                >
        ...
        <div className="space-y-6">
          <Panel>
            <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
              ...
              <div className="rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(181,35,50,0.16),rgba(0,0,0,0.06))] p-5">
                    ...
                    {type.subtypes.length ? (
                      <div className="mt-5 flex flex-wrap gap-2">
                        {type.subtypes.map((subtype) => (
                          <span key={subtype} className="rounded-full border border-[var(--line)] bg-[rgba(181,35,50,0.16)] px-3 py-1 text-xs uppercase tracking-[0.2em] text-[var(--accent-soft)]">
                            {subtype}
                          </span>
                        ))}
                      </div>

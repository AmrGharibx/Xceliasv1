...
const MasterySection = ({ onOpenSource }) => (
  ...
  >
    <div className="space-y-6">
      <Panel className="bg-[linear-gradient(180deg,rgba(181,35,50,0.16),rgba(255,255,255,0.03))]">
      ...
      <Panel className="bg-[linear-gradient(180deg,rgba(198,147,84,0.12),rgba(255,255,255,0.03))]">
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
          ...
          <div className="rounded-[28px] border border-[var(--line)] bg-[rgba(181,35,50,0.14)] p-5">

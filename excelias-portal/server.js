...
app.use((req, res, next) => {
  ...
  res.setHeader(
    ...
    [
      ...
      "connect-src 'self' https://*.googleapis.com https://*.firebasedatabase.app wss://*.firebasedatabase.app https://overpass-api.de https://overpass.openstreetmap.ru https://overpass.private.coffee https://overpass.kumi.systems https://maps.mail.ru https://server.arcgisonline.com https://cdn.jsdelivr.net",

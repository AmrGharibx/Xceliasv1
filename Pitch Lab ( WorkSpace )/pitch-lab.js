...
function applyLang() {
  ...
  document.getElementById('chat-input').placeholder = lang === 'ar' ? 'اكتب ردّك...' : 'Type your response...';
}
...
const SCENARIOS = [
  {
    ...
    client:     { en: 'Ahmed, 35 — Senior Structural Engineer', ar: 'أحمد، 35 — مهندس إنشائي' },
    profile:    { en: 'Ahmed is precise and analytical. He questions every claim with "prove it." He wants hard numbers: price per sqm, maintenance fees, payment plan breakdown, finishing specs. He has been burned by vague promises before and will push back on anything that sounds like marketing fluff.', ar: 'أحمد دقيق وتحليلي. يشكّك في كل ادّعاء. يريد أرقاماً حقيقية: سعر المتر، عمولات الصيانة، جداول السداد، مواصفات التشطيب. سبق أن وقع ضحية وعود غامضة ولن يتسامح مع الكلام التسويقي الفارغ.' },
    objective:  { en: 'Build credibility with data. Qualify his needs. Secure a site visit commitment.', ar: 'ابنِ مصداقيتك بالأرقام. تعرّف على احتياجاته. احصل على تعهّد بزيارة الموقع.' },
    tips:       [
      ...
      { en: 'Ask what data matters to him most', ar: 'اسأل عن أهم البيانات بالنسبة له' },
    ],
...
The scenario ends naturally if the agent manages to get you to agree to a site visit.`;
  ...
  },
  {
    ...
    client:     { en: 'Khaled, 42 — Serial Real Estate Investor', ar: 'خالد، 42 — مستثمر عقاري متسلسل' },
    profile:    { en: 'Khaled owns 7 units across Cairo and New Cairo. He only cares about ROI, rental yield, and resale potential. He talks fast, interrupts, and will end the call if you waste his time. He knows the market better than most agents.', ar: 'خالد يملك 7 وحدات في القاهرة والقاهرة الجديدة. يهتم فقط بالعائد والإيجار وإمكانية إعادة البيع. يتكلم بسرعة، يقاطع، وسيُنهي المكالمة إذا ضيّعت وقته.' },
    objective:  { en: 'Position the unit as a yield opportunity. Provide rental return estimates. Get him to agree to review a financial sheet.', ar: 'قدّم الوحدة كفرصة استثمارية. أعطِ تقديرات للعائد الإيجاري. اجعله يوافق على مراجعة جدول مالي.' },
    tips:       [
      { en: 'Get to the numbers in < 30 seconds', ar: 'وصل للأرقام في أقل من 30 ثانية' },
...
Budget: Up to 5M EGP for a strong-yield unit. Will hang up if agent can't give numbers in the first minute.`;
  ...
  },
  {
    ...
    client:     { en: 'Omar & Sara, married couple — first home buyers', ar: 'عمر وسارة، زوجان — مشترون لأول مرة' },
    profile:    { en: 'Omar wants a compound with amenities. Sara wants proximity to schools. They constantly interrupt each other. Omar likes big spaces. Sara wants a lower budget. This is their fifth agent call this week. They cannot agree on anything.', ar: 'عمر يريد كمبوند بمرافق. سارة تريد القرب من المدارس. يقاطعان بعضهما باستمرار. عمر يحب المساحات الكبيرة. سارة تريد ميزانية أقل. هذه مكالمتهم الخامسة مع وكيل هذا الأسبوع.' },
    objective:  { en: 'Find common ground between their priorities. Ask structured discovery questions. Get them to agree on ONE non-negotiable requirement.', ar: 'جد أرضية مشتركة بين أولوياتهما. اطرح أسئلة اكتشافية منظّمة. اجعلهما يتفقان على متطلب واحد غير قابل للتفاوض.' },
    tips:       [
...
They disagree gently but persistently. They are polite but can't make decisions together. Agent wins if they agree on ONE priority.`;
  ...
  },
  {
    ...
    client:     { en: 'Mohamed, 29 — First-time buyer, budget-conscious', ar: 'محمد، 29 — مشترٍ لأول مرة، حريص على الميزانية' },
    profile:    { en: 'Mohamed opens every call with "طب ده غالي أوي". He will negotiate every line item. He heard from a friend there are better prices somewhere else. He is not actually that price-sensitive — he is testing the agent\'s conviction. If you cave immediately he loses respect.', ar: 'محمد يفتتح كل مكالمة بـ"طب ده غالي أوي". سيتفاوض على كل بند. سمع من صديق أن هناك أسعاراً أفضل في مكان آخر. في الحقيقة ليس حساساً للسعر كثيراً — يختبر قناعة الوكيل. إذا استجبت فوراً سيفقد الاحترام.' },
    objective:  { en: 'Hold your value. Justify price with comparables. Re-frame cost as value. Get him to engage with the unit details.', ar: 'حافظ على قيمتك. برّر السعر بمقارنات. أعد صياغة التكلفة كقيمة. اجعله يتعامل مع تفاصيل الوحدة.' },
    tips:       [
      { en: "Don't discount too fast", ar: 'لا تخفّض السعر بسرعة' },
      { en: 'Anchor to value, not price', ar: 'ارتكز على القيمة لا السعر' },
      { en: 'Ask: "What budget were you thinking?"', ar: 'اسأل: "ما الميزانية التي كنت تفكر فيها؟"' },
    ],
    systemPrompt: function (a) {
...
Actual budget: 2.8M EGP for a 2BR in a decent compound. Warms up if agent is confident and justifies price well — do not warm up too fast.`;
  ...
  },
  {
    ...
    client:     { en: 'Nour, 31 — Software developer, introverted', ar: 'نور، 31 — مطوّرة برمجيات، انطوائية' },
    profile:    { en: 'Nour gives one-word answers. "Yes." "Maybe." "I don\'t know." She was referred by a friend. She is genuinely interested but terrible at phone conversations. Long silences. You have to ask very targeted open questions or she shuts down entirely.', ar: 'نور تجيب بكلمة واحدة. "آه." "ممكن." "مش عارفة." تمّت إحالتها من صديقة. مهتمة فعلاً لكنها سيئة في المحادثات الهاتفية. صمت طويل. تحتاج لأسئلة مفتوحة محدّدة وإلا ستغلق تماماً.' },
    objective:  { en: 'Ask open-ended questions that cannot be answered with one word. Uncover 3 qualifying facts: budget, timeline, area preference.', ar: 'اطرح أسئلة مفتوحة لا يمكن الإجابة عليها بكلمة. اكتشف 3 حقائق تأهيلية: الميزانية، الإطار الزمني، تفضيل المنطقة.' },
    tips:       [
...
Actually interested in a 2BR in New Cairo for ~2.2M EGP by end of year. Agent wins if they extract 3 key facts.`;
  ...
  },
  {
    ...
    client:     { en: 'Hassan, 52 — Business owner, always "thinking about it"', ar: 'حسن، 52 — صاحب عمل، دائماً "يفكّر في الأمر"' },
    profile:    { en: 'Hassan has been "about to buy" for 3 years. He is warm and friendly. He loves chatting. He asks for brochures, says "send me the details" and then never follows up. He has no real urgency and no deadline. He needs a reason to decide NOW.', ar: 'حسن "على وشك الشراء" منذ 3 سنوات. دافئ وودود. يحب الدردشة. يطلب بروشورات ويقول "ابعتلي التفاصيل" ثم لا يتابع أبداً. لا يحس بأي إلحاح ولا موعد نهائي. يحتاج سبباً للقرار الآن.' },
    objective:  { en: 'Create urgency without lying. Uncover a real deadline or motivation. Redirect from chat to a concrete next step.', ar: 'اصنع إلحاحاً دون كذب. اكتشف دافعاً أو موعداً حقيقياً. انتقل من الدردشة إلى خطوة ملموسة تالية.' },
    tips:       [
      { en: 'Ask about his pain point, not just the property', ar: 'اسأل عن نقطة ألمه لا العقار فحسب' },
      { en: 'Use limited availability honestly', ar: 'استخدم محدودية التوافر بصدق' },
      { en: 'Always close on a specific date', ar: 'دائماً أغلق على تاريخ محدّد' },
    ],
    systemPrompt: function (a) {
...
Warms up and starts engaging seriously ONLY if agent uncovers the emotional motivation (daughter). Budget is 4M EGP.`;
  ...
  },
  {
    ...
    client:     { en: 'Asmaa, 27 — HR specialist, filled a form she barely remembers', ar: 'أسماء، 27 — متخصصة موارد بشرية، ملأت نموذجاً لا تتذكره تقريباً' },
    profile:    { en: 'Asmaa filled a Facebook lead form 2 months ago and has no recollection of it. She is polite but confused. She is busy. She was not actually looking to buy — she probably clicked an ad by mistake. She is the hardest lead to convert but a great practice for re-qualification.', ar: 'أسماء ملأت نموذج ليد على فيسبوك منذ شهرين ولا تتذكره. مؤدّبة لكن محتارة. مشغولة. لم تكن تبحث عن شراء فعلاً — ربما ضغطت على إعلان بالخطأ. أصعب العملاء تحويلاً لكنها رائعة للتدرّب على إعادة التأهيل.' },
    objective:  { en: 'Re-warm her without pressure. Re-qualify interest from scratch. Plant a seed. Do not push for a close on first contact.', ar: 'أعد تدفئتها بلا ضغط. أعد تأهيل الاهتمام من الصفر. ازرع بذرة. لا تدفع نحو الإغلاق في الاتصال الأول.' },
    tips:       [
      { en: 'Lead with curiosity, not a pitch', ar: 'ابدأ بالفضول لا بعرض تجاري' },
      { en: 'Give her an easy out — she\'ll respect it', ar: 'أعطها مخرجاً سهلاً — ستحترمك على ذلك' },
      { en: 'Ask one low-commitment question', ar: 'اطرح سؤالاً واحداً لا يستلزم التزاماً كبيراً' },
    ],
    systemPrompt: function (a) {
...
If agent pushes hard → ends call politely. If agent is human and not pushy → starts opening up about eventually wanting a small studio. Budget: 1.8-2M EGP.`;
  ...
  },
  {
    ...
    client:     { en: 'Tarek, 38 — IT Manager, relocating in 30 days', ar: 'طارق، 38 — مدير تقنية معلومات، ينتقل خلال 30 يوماً' },
    profile:    { en: 'Tarek is relocating from Alexandria to Cairo for a new job in 30 days. He needs to close within this week. He is decisive and pre-approved for a mortgage. He needs you to show him only relevant options and not waste his time. He will close today if you give him what he needs.', ar: 'طارق ينتقل من الإسكندرية للقاهرة لوظيفة جديدة خلال 30 يوماً. يحتاج إلى الإغلاق هذا الأسبوع. حاسم وحصل على موافقة مسبقة للرهن. يريد منك فقط الخيارات المناسبة. سيغلق اليوم إذا أعطيته ما يحتاجه.' },
    objective:  { en: 'Ask focused qualification questions. Present 2-3 options that fit. Close for a same-day or next-morning site visit.', ar: 'اطرح أسئلة تأهيل مركّزة. قدّم 2-3 خيارات مناسبة. أغلق على زيارة موقع نفس اليوم أو صباح الغد.' },
    tips:       [
      { en: 'Match his urgency — be direct', ar: 'وازِن إلحاحه — كن مباشراً' },
      { en: 'Propose 2 options, not 10', ar: 'قدّم خيارين لا عشرة' },
      { en: 'Confirm logistics: time, transport', ar: 'أكّد اللوجستيات: الوقت والمواصلات' },
    ],
    systemPrompt: function (a) {
...
function renderScenarios() {
  ...
  grid.innerHTML = SCENARIOS.map((s) => {
    ...
    const desc    = escHtml(s.profile[lang] ? (s.profile[lang] || '').slice(0, 100) + '…' : (s.profile.en || '').slice(0, 100) + '…');
    const diff    = escHtml(s.difficulty);
    const diffLabel = lang === 'ar'
      ? ({ easy: 'سهل', medium: 'متوسط', hard: 'صعب' }[s.difficulty] || s.difficulty)
      : s.difficulty.charAt(0).toUpperCase() + s.difficulty.slice(1);
    return `<div class="scenario-card" data-id="${escHtml(s.id)}" role="button" tabindex="0" aria-label="${name}">
  ...
  grid.querySelectorAll('.scenario-card').forEach((card) => {
    ...
    card.addEventListener('keydown', (e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); openBriefing(card.dataset.id); } });
  });
}
...
function openBriefing(id) {
  ...
  $('briefing-profile').textContent = scenario.profile[lang] || scenario.profile.en;
  $('briefing-objective').textContent = scenario.objective[lang] || scenario.objective.en;

  const tipsEl = $('briefing-tips');
  tipsEl.innerHTML = (scenario.tips || []).map((tip) =>
...
function startCall() {
  ...
  if (input) { input.value = ''; input.focus(); autoResize(input); }

  $('call-hint').textContent = lang === 'ar'
...
function appendBubble(role, text) {
  const chatArea = $('chat-area');
  if (!chatArea) return;
  const cls = role === 'client' ? 'bubble-client' : role === 'agent' ? 'bubble-agent' : 'bubble-system';
...
async function sendMessage() {
  ...
  try {
    const sysPrompt = currentScenario.systemPrompt(lang === 'ar' ? 'Egyptian Arabic' : 'English');
    ...
    removeTypingIndicator();
    appendSystem(lang === 'ar' ? 'حدث خطأ في الاتصال. يرجى المحاولة مرة أخرى.' : 'Connection error. Please try again.');
...
async function endCall() {
  ...
  if (callTranscript.length < 2) {
    appendSystem(lang === 'ar' ? 'أجرِ بعض التبادلات أولاً!' : 'Have at least a few exchanges first!');
    setSendDisabled(false);
    clearInterval(callTimerHandle);
    callTimerHandle = setInterval(tickCallTimer, 1000);
    return;
  ...
  showLoading(lang === 'ar' ? 'جاري تحليل المكالمة...' : 'Analysing your call...');
  ...
  try {
    ...
    const debriefPrompt = buildDebriefPrompt(currentScenario, transcriptText, lang);
    const rawJson = await callGemini(null, [{ role: 'user', content: debriefPrompt }]);
    ...
    const total = Object.values(debrief.scores || {}).reduce((a, b) => a + (b || 0), 0);
    saveHistoryEntry({
    ...
    hideLoading();
    appendSystem(lang === 'ar' ? 'تعذّر تحليل المكالمة. يرجى المحاولة مرة أخرى.' : 'Could not generate debrief. Try again.');
    setSendDisabled(false);
    clearInterval(callTimerHandle);
    callTimerHandle = setInterval(tickCallTimer, 1000);
...
function buildFallbackDebrief() {
  return {
    scores: { rapport: 10, qualification: 10, objection_handling: 10, closing_attempt: 10, communication: 10 },
    coaching: [
...
function showDebrief(debrief) {
  ...
  $('debrief-scenario-badge').textContent = currentScenario.name[lang] || currentScenario.name.en;
  $('debrief-total').textContent = String(Math.round(total));

  // Score bars
  const scoresEl = $('debrief-scores');
  scoresEl.innerHTML = Object.entries(SCORE_LABELS).map(([key, labels]) => {
  ...
  coachingEl.innerHTML = `<p class="coaching-title">${escHtml(lang === 'ar' ? 'ملاحظات المدرّب' : 'Trainer Notes')}</p>` +

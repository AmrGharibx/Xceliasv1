            ...
            <div className="rounded-[28px] border border-white/10 bg-black/20 p-3">
              <ResponsiveContainer width="100%" height={360}>
                <RadarChart data={ARSENAL_SKILLS}>
                  ...
                  <Radar dataKey="value" stroke="#b52332" fill="#b52332" fillOpacity={0.32} strokeWidth={2} />
                  <Tooltip
                    contentStyle={{
      ...
      <Panel>
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5">
          {ARSENAL_ACCESSORIES.map((item, index) => {
            ...
            return (
              <div key={item} className={`rounded-[24px] border p-4 ${index < 7 ? 'border-[var(--line)] bg-[rgba(181,35,50,0.14)]' : 'border-white/10 bg-black/20'}`}>
